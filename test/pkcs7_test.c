...
static int pkcs7_verify_test(void) {
    ...
    "UE"
    "AwwPY3J5cHRvZ3JhcGh5IENBMB4XDTE3MDEwMTEyMDEw\nMFoXDTM4MTIzMTA4MzAwMFowJzEL"
    "MA"
    "kGA1UEBhMCVVMxGDAWBgNVBAMMD2NyeXB0\nb2dyYXBoeSBDQTBZMBMGByqGSM49AgEGCCqGSM"
    "49"
    "AwEHA0IABBj/z7v5Obj13cPu\nwECLBnUGq0/"
    "N2CxSJE4f4BBGZ7VfFblivTvPDG++Gve0oQ+0uctuhrNQ+WxRv8GC\n",
    "177F+QWjEzARMA8GA1UdEwEB/"
    "wQFMAMBAf8wCgYIKoZIzj0EAwIDSQAwRgIhANES\n742XWm64tkGnz8DnpG6u2lHkZFQr3oaVv"
    "Pc"
    "emvlbAiEA0WGGzmYx5C9UvfXIK7NE\nziT4pQtyESE0uRVKXw4nMqkxggGBMIIBfQIBATAtMCc"
    "xC"
    "zAJBgNVBAYTAlVTMRgw\nFgYDVQQDDA9jcnlwdG9ncmFwaHkgQ0ECAgMJMA0GCWCGSAFlAwQCA"
    "QU"
    "AoIHkMBgG\nCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTIxMDUyMDE"
    "4"
    ...
    ret =
    TEST_ptr(msg_bio = BIO_new_mem_buf(signed_data, strlen(signed_data))) &&
