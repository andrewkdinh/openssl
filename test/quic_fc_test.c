...
static OSSL_TIME fake_now(void *arg) { return cur_time; }
...
/* RX, Partial retire */
RX_OP_RX(0, 60, 0) RX_OP_CHECK_SWM(60) RX_OP_RETIRE(0, 20, 50 * OSSL_TIME_MS, 0)
RX_OP_CHECK_RWM(20) RX_OP_CHECK_SWM(60) RX_OP_CHECK_CWM(INIT_WINDOW_SIZE)
RX_OP_CHECK_CHANGED(0, 0) RX_OP_CHECK_ERROR(0, 0)

/* Fully retired */
RX_OP_RETIRE(0, 41, 0, 1) RX_OP_RETIRE(0, 40, 0, 0) RX_OP_CHECK_SWM(60)
RX_OP_CHECK_RWM(60) RX_OP_CHECK_CWM(INIT_WINDOW_SIZE) RX_OP_CHECK_CHANGED(0, 0)
...
RX_OP_CHECK_CHANGED(1, 1) RX_OP_CHECK_CHANGED(0, 0) RX_OP_CHECK_ERROR(0, 0)
...
RX_OP_RX(0, 10, 0) RX_OP_CHECK_CWM_CONN(INIT_WINDOW_SIZE)
RX_OP_CHECK_CWM_STREAM(0, INIT_S_WINDOW_SIZE)
RX_OP_CHECK_CWM_STREAM(1, INIT_S_WINDOW_SIZE) RX_OP_CHECK_SWM_CONN(10)
RX_OP_CHECK_SWM_STREAM(0, 10) RX_OP_CHECK_SWM_STREAM(1, 0)
RX_OP_CHECK_RWM_CONN(0) RX_OP_CHECK_RWM_STREAM(0, 0)
RX_OP_CHECK_RWM_STREAM(1, 0)

RX_OP_RX(1, 42, 0)
RX_OP_RX(1, 42, 0) /* monotonic; equal or lower values ignored */
RX_OP_RX(1, 35, 0) RX_OP_CHECK_CWM_CONN(INIT_WINDOW_SIZE)
RX_OP_CHECK_CWM_STREAM(0, INIT_S_WINDOW_SIZE)
RX_OP_CHECK_CWM_STREAM(1, INIT_S_WINDOW_SIZE) RX_OP_CHECK_SWM_CONN(52)
RX_OP_CHECK_SWM_STREAM(0, 10) RX_OP_CHECK_SWM_STREAM(1, 42)
RX_OP_CHECK_RWM_CONN(0) RX_OP_CHECK_RWM_STREAM(0, 0)
RX_OP_CHECK_RWM_STREAM(1, 0)

RX_OP_RETIRE(0, 10, 50 * OSSL_TIME_MS, 0) RX_OP_CHECK_RWM_CONN(10)
RX_OP_CHECK_RWM_STREAM(0, 10) RX_OP_CHECK_CWM_CONN(INIT_WINDOW_SIZE)
RX_OP_CHECK_CWM_STREAM(0, INIT_S_WINDOW_SIZE)
...
RX_OP_CHECK_SWM_STREAM(0, INIT_S_WINDOW_SIZE) RX_OP_CHECK_SWM_STREAM(1, 42)
...
RX_OP_CHECK_RWM_STREAM(0, INIT_S_WINDOW_SIZE) RX_OP_CHECK_RWM_STREAM(1, 42)
