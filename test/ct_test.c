...
static int execute_cert_test(CT_TEST_FIXTURE *fixture) {
  ...
  if (fixture->certificate_file != NULL) {
    ...
    if (!TEST_ptr(cert =
                  load_pem_cert(fixture->certs_dir, fixture->certificate_file)))
      goto end;
    ...
    if (fixture->issuer_file != NULL) {
      if (!TEST_ptr(issuer =
                    load_pem_cert(fixture->certs_dir, fixture->issuer_file)))
        goto end;
    ...
    if (fixture->expected_sct_count > 0) {
      ...
      if (fixture->sct_text_file &&
          !compare_extension_printout(sct_extension, expected_sct_text))
        goto end;
