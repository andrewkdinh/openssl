...
static SSL_CTX *create_ctx(const char *cert_path, const char *key_path) {
     ...
     *
     * The requisite files "chain.pem" and "pkey.pem" can be generated by
     * running "make chain" in this directory.  If the server will be executed
     * from some other directory, move or copy the files there.
     */
