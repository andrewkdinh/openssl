...
static const struct {
    ...
    int sum_err, sub_err, mul_err, div_err, mod_err, div_round_up_err;
                        ...
                        /*  +  -  *  /  %  /r   */
    {3, 1, 0, 0, 0, 0, 0, 0},         {1, 3, 0, 1, 0, 0, 0, 0},
    {UINT_MAX, 1, 1, 0, 0, 0, 0, 0},  {UINT_MAX, 2, 1, 0, 1, 0, 0, 0},
    {UINT_MAX, 16, 1, 0, 1, 0, 0, 0}, {UINT_MAX - 13, 16, 1, 0, 1, 0, 0, 0},
    {1, UINT_MAX, 1, 1, 0, 0, 0, 0},  {2, UINT_MAX, 1, 1, 1, 0, 0, 0},
...
static const struct {
    ...
    {3, 1, 2, 0},        {1, 3, 2, 0},        {UINT_MAX, UINT_MAX, UINT_MAX, 0},
    {UINT_MAX, 2, 4, 0}, {8, UINT_MAX, 4, 1}, {UINT_MAX, 8, 4, 1},
    {3, 4, 0, 1},
};
