...
static const struct tls13groupselection_test_st tls13groupselection_tests[] = {
    ...
    {"secp384r1:secp521r1:X25519:prime256v1:X448", /* test 0 */
     "X25519:secp521r1:secp384r1:prime256v1:X448", CLIENT_PREFERENCE, "secp384r1", SH},
    {"secp521r1:secp384r1:X25519:prime256v1:X448", /* test 1 */
     "X25519:secp521r1:secp384r1:prime256v1:X448", SERVER_PREFERENCE, "secp521r1", SH},
    ...
    {"secp521r1:secp384r1:*X25519/*prime256v1:X448", /* test 4 */
     "secp521r1:*prime256v1:X25519:X448", CLIENT_PREFERENCE, "x25519", SH},
    {"secp521r1:secp384r1:*X25519/*prime256v1:X448", /* test 5 */
     "secp521r1:*prime256v1:X25519:X448", SERVER_PREFERENCE, "secp256r1", SH},
    ...
    {"secp521r1:secp384r1:*X25519:prime256v1:*X448", /* test 6 */
     "secp384r1:secp521r1:prime256v1/X25519:X448", CLIENT_PREFERENCE, "secp521r1", HRR},
    {"secp521r1:secp384r1:*X25519:prime256v1:*X448", /* test 7 */
     "secp384r1:secp521r1:prime256v1/X25519:X448", SERVER_PREFERENCE, "secp384r1", HRR},
    ...
    {"*X25519:?unknown_group_123:prime256v1:*X448", /* test 10 */
     "secp521r1:secp384r1/X448:?unknown_group_456:?X25519", CLIENT_PREFERENCE, "x25519", SH},
    {"*X25519:prime256v1:*X448:?*unknown_group_789", /* test 11 */
     "secp521r1:secp384r1/?X448:?unknown_group_456:X25519", SERVER_PREFERENCE, "x448", SH},
    ...
    {NULL, /* test 13 */
     ...
     "x25519", SH
         ...
         */
    {"*X25519:*X448", /* test 14 */
     "secp521r1:X25519:prime256v1:-X25519:secp384r1/X448", CLIENT_PREFERENCE, "x448", SH},
    {"*X25519:*X448", /* test 15 */
     "secp521r1:X25519:prime256v1:-X25519:secp384r1/X448", SERVER_PREFERENCE, "x448", SH},
    {"*X25519:prime256v1:*X448", /* test 16 */
     "X25519:prime256v1/X448:-X25519", CLIENT_PREFERENCE, "secp256r1", HRR},
    {"*X25519:prime256v1:*X448", /* test 17 */
     "X25519:prime256v1/X448:-X25519", SERVER_PREFERENCE, "secp256r1", HRR},
        /*
         * (I) Check handling of the "DEFAULT" 'pseudo group name'
         */
    {"*X25519:DEFAULT:-prime256v1:-X448", /* test 18 */
     "DEFAULT:-X25519:-?X25519MLKEM768", CLIENT_PREFERENCE, "secp384r1", HRR},
    {"*X25519:DEFAULT:-prime256v1:-X448", /* test 19 */
     "DEFAULT:-X25519:-?X25519MLKEM768", SERVER_PREFERENCE, "secp384r1", HRR},
        /*
         * (J) Deduplication check
         */
    {"secp521r1:X25519:prime256v1/X25519:prime256v1/X448", /* test 20 */
     "secp521r1:X25519:prime256v1/X25519:prime256v1/X448", CLIENT_PREFERENCE, "secp521r1", SH},
    {"secp521r1:X25519:prime256v1/X25519:prime256v1/X448", /* test 21 */
     "secp521r1:X25519:prime256v1/X25519:prime256v1/X448", SERVER_PREFERENCE, "secp521r1", SH},
        /*
    ...
    {"X25519:secp256r1:X448:secp521r1:-X448:-secp256r1:-X25519:-secp521r1", "", CLIENT_PREFERENCE, NEGOTIATION_FAILURE},
    {"secp384r1:secp521r1:X25519", /* test 39 */
     "prime256v1:X448", CLIENT_PREFERENCE, NEGOTIATION_FAILURE},
    {"secp521r1:secp384r1:X25519", /* test 40 */
     "prime256v1:X448", SERVER_PREFERENCE, NEGOTIATION_FAILURE},
        /*
         * These are allowed
    ...
    {"secp521r1 / prime256v1:X25519 / prime256v1/X448", /* test 42 */
     "secp521r1 / prime256v1:X25519 / prime256v1/X448", SERVER_PREFERENCE, "secp521r1", SH},
};

static void server_response_check_cb(int write_p, int version, int content_type, const void *buf, size_t len, SSL *ssl,
                                     void *arg)
{
    ...
    const uint8_t magic_HRR_random[32] = {0xCF, 0x21, 0xAD, 0x74, 0xE5, 0x9A, 0x61, 0x11, 0xBE, 0x1D, 0x8C,
...
static int test_invalidsyntax(const struct tls13groupselection_test_st *current_test_vector, int ssl_or_ctx)
{
    int ok = 0;
    SSL_CTX *client_ctx = NULL, *server_ctx = NULL;
    SSL *clientssl = NULL, *serverssl = NULL;

    if (!TEST_ptr(current_test_vector->client_groups) || !TEST_size_t_ne(strlen(current_test_vector->client_groups), 0))
        goto end;

    /* Creation of the contexts */
    TEST_true_or_end(create_ssl_ctx_pair(NULL, TLS_server_method(), TLS_client_method(), TLS1_VERSION, 0, &server_ctx,
                                         &client_ctx, cert, privkey));

    /* Customization of the contexts */
    if (ssl_or_ctx == WORK_ON_CONTEXT)
        TEST_false_or_end(SSL_CTX_set1_groups_list(client_ctx, current_test_vector->client_groups));
    /* Creation of the SSL objects */
    TEST_true_or_end(create_ssl_objects(server_ctx, client_ctx, &serverssl, &clientssl, NULL, NULL));
...
static int test_groupnegotiation(const struct tls13groupselection_test_st *current_test_vector, int ssl_or_ctx,
                                 TEST_TYPE test_type)
{
    int ok = 0;
    ...
    if (ssl_or_ctx == WORK_ON_CONTEXT) {
        if (current_test_vector->client_groups != NULL) {
            TEST_true_or_end(SSL_CTX_set1_groups_list(client_ctx, current_test_vector->client_groups));
        }
        if (current_test_vector->server_groups != NULL) {
            TEST_true_or_end(SSL_CTX_set1_groups_list(server_ctx, current_test_vector->server_groups));
        }
    ...
    /* Creation of the SSL objects */
    if (!TEST_true(create_ssl_objects(server_ctx, client_ctx, &serverssl, &clientssl, NULL, NULL)))
        goto end;
...
static int tls13groupselection_test(int i)
{
    ...
    if (strncmp(tls13groupselection_tests[i].expected_group, SYNTAX_FAILURE, sizeof(SYNTAX_FAILURE)) == 0)
        test_type = TEST_SYNTAX_FAILURE;
    else if (strncmp(tls13groupselection_tests[i].expected_group, NEGOTIATION_FAILURE, sizeof(NEGOTIATION_FAILURE))
             == 0)
        test_type = TEST_NEGOTIATION_FAILURE;

    if (test_type == TEST_SYNTAX_FAILURE)
        res = test_invalidsyntax(&tls13groupselection_tests[i], WORK_ON_SSL_OBJECT);
    else
        res = test_groupnegotiation(&tls13groupselection_tests[i], WORK_ON_SSL_OBJECT, test_type);
    ...
    if (test_type == TEST_SYNTAX_FAILURE)
        res = test_invalidsyntax(&tls13groupselection_tests[i], WORK_ON_CONTEXT);
    else
        res = test_groupnegotiation(&tls13groupselection_tests[i], WORK_ON_CONTEXT, test_type);
