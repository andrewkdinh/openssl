...
int test_get_libctx(OSSL_LIB_CTX **libctx, OSSL_PROVIDER **default_null_prov,
                    const char *config_file, OSSL_PROVIDER **provider,
...
/*
 * Helper functions to detect specific versions of the FIPS provider being in
 * use. Because of FIPS rules, code changes after a module has been validated
 * are difficult and because we provide a hard guarantee of ABI and behavioural
