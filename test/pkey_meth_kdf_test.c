...
static int test_kdf_tls1_prf(int index) {
    ...
    if (index == 0) {
        ...
        if (EVP_PKEY_CTX_add1_tls1_prf_seed(pctx, (unsigned char *)"se", 2) <=
            0) {
            TEST_error("EVP_PKEY_CTX_add1_tls1_prf_seed");
            goto err;
        }
        if (EVP_PKEY_CTX_add1_tls1_prf_seed(pctx, (unsigned char *)"ed", 2) <=
            0) {
            TEST_error("EVP_PKEY_CTX_add1_tls1_prf_seed");
            goto err;
        }
...
static int test_kdf_hkdf(int index) {
    ...
    if (index == 0) {
        ...
        if (EVP_PKEY_CTX_add1_hkdf_info(pctx, (const unsigned char *)"lab",
                                        3) <= 0) {
            TEST_error("EVP_PKEY_CTX_add1_hkdf_info");
            goto err;
        }
