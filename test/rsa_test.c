...
static int test_rsa_oaep(int idx) {
    ...
    for (n = -1; n < clen; ++n) {
        num =
        RSA_private_decrypt(n, ctext_ex, ptext, key, RSA_PKCS1_OAEP_PADDING);
        if (!TEST_int_le(num, 0))
            goto err;
    }
...
static RSA *load_key(int priv) {
    ...
    };
    static const unsigned char e[] = {0x01, 0x00, 0x01};
    static const unsigned char d[] = {
    };
...
static int test_rsa_saos(void) {
    ...
    /* Maximum length allowed: The 3 relates to the octet byte 0x04 followed by
     * a 2 byte length */
    ...
    };
    /* The signature generated by RSA_private_encrypt of in[inlen] */
    static const unsigned char no_octet_sig[256] = {
    };
