...
ASN1_SEQUENCE(ASN1_LONG_DATA)
        ...
        ASN1_SEQUENCE(ASN1_UINT32_DATA)
            ...
            ASN1_SEQUENCE(ASN1_INT64_DATA)
                ...
                ASN1_SEQUENCE(ASN1_UINT64_DATA)
                    ...
                    {
                        const unsigned char *p = t_invalid_zero;
                        ASN1_UINT64_DATA *dectst = d2i_ASN1_UINT64_DATA(
                            NULL, &p, sizeof(t_invalid_zero));
                    ...
                    static int test_gentime(void)
                    {
                        ...
                        const unsigned char der[] = {
                            0x18, 0x0d, 0x31, 0x36, 0x31, 0x32, 0x30, 0x38,
                            0x31, 0x39, 0x33, 0x34, 0x30, 0x30, 0x5a,
                        };
                    ...
                    static int test_utctime(void)
                    {
                        ...
                        const unsigned char der[] = {
                            0x17, 0x0b, 0x30, 0x32, 0x30, 0x35, 0x31,
                            0x30, 0x34, 0x37, 0x30, 0x30, 0x5a,
                        };
                        const unsigned char *p;
                        int der_len, rc = 1;
     ...
     */
                        ...
                        static int test_invalid_template(void)
                        {
                            ...
                            INVALIDTEMPLATE *tmp = d2i_INVALIDTEMPLATE(
                                NULL, &p, sizeof(t_invalid_template));
                        ...
                        {
                            static unsigned char cn_der[] = {0x06, 0x03, 0x55,
                                                             0x04, 0x06};
                            ...
                            if (!TEST_ptr(obj = ASN1_OBJECT_create(
                                              NID_undef, cn_der, sizeof(cn_der),
                                              "C", "countryName")))
                                goto err;
                            /* reuse obj - this should not leak sn and ln */
                            if (!TEST_ptr(
                                    d2i_ASN1_OBJECT(&obj, &p, sizeof(oid_der))))
                                goto err;
                            ret = 1;
err:
