...
static const char alpn_prots[] = "|12345678901234567890123456789012345678901234"
                                 "56789012345678901234567890123456789"
                                 "|12345678901234567890123456789012345678901234"
                                 "56789012345678901234567890123456789";
#else
static const char alpn_prots[] = "O12345678901234567890123456789012345678901234"
                                 "56789012345678901234567890123456789"
                                 "O12345678901234567890123456789012345678901234"
                                 "56789012345678901234567890123456789";
#endif
    ...
    case TEST_PADDING_NOT_NEEDED:
        ...
        if (currtest == TEST_ADD_PADDING) {
            if (!TEST_false(SSL_CTX_set_alpn_protos(
                ctx, (unsigned char *)alpn_prots, sizeof(alpn_prots) - 1)))
                goto end;
            /*
