...
static int test_http_method(int do_get, int do_txt, int suggested_status) {
    ...
    ? OSSL_HTTP_get(real_server ? REAL_SERVER_URL : path, NULL /* proxy */,
                    ...
                    !do_txt /* expect_asn1 */, OSSL_HTTP_DEFAULT_MAX_RESP_LEN,
                    0 /* timeout */)
    : OSSL_HTTP_transfer(
      ...
      content_type, !do_txt /* expect_asn1 */, OSSL_HTTP_DEFAULT_MAX_RESP_LEN,
...
static int test_http_keep_alive(char version, int keep_alive, int kept_alive) {
    ...
    for (res = 1, i = 1; res && i <= 2; i++) {
        ...
        NULL /* proxy */, NULL /* no_proxy */, wbio, rbio,
        NULL /* bio_update_fn */, NULL, 0 /* buf_size */, NULL /* headers */,
        NULL /* content_type */, NULL /* req => GET */, content_type,
        0 /* ASN.1 not expected */, 0 /* max_resp_len */, 0 /* timeout */,
        keep_alive);
...
static int test_http_resp_hdr_limit(size_t limit) {
    ...
    if (!TEST_true(OSSL_HTTP_REQ_CTX_set_request_line(rctx, 0 /* GET */, NULL,
                                                      NULL, RPATH)))
        goto err;
