...
static int dummy_decoder_decode(void *ctx, OSSL_CORE_BIO *cin, int selection, OSSL_CALLBACK *object_cb,
...
static const OSSL_DISPATCH dummy_decoder_functions[] = {
    {OSSL_FUNC_DECODER_DECODE, (void (*)(void))dummy_decoder_decode}, OSSL_DISPATCH_END};

static const OSSL_ALGORITHM dummy_decoders[] = {{"DUMMY", "provider=dummy,input=pem", dummy_decoder_functions},
                                                {NULL, NULL, NULL}};

static int dummy_encoder_encode(void *ctx, OSSL_CORE_BIO *out, const void *obj_raw, const OSSL_PARAM obj_abstract[],
...
static const OSSL_DISPATCH dummy_encoder_functions[] = {
    {OSSL_FUNC_DECODER_DECODE, (void (*)(void))dummy_encoder_encode}, OSSL_DISPATCH_END};

static const OSSL_ALGORITHM dummy_encoders[] = {{"DUMMY", "provider=dummy,output=pem", dummy_encoder_functions},
                                                {NULL, NULL, NULL}};
...
static int dummy_store_load(void *loaderctx, OSSL_CALLBACK *object_cb, void *object_cbarg,
...
static const OSSL_DISPATCH dummy_store_functions[] = {{OSSL_FUNC_STORE_OPEN, (void (*)(void))dummy_store_open},
...
static const OSSL_ALGORITHM dummy_store[] = {{"DUMMY", "provider=dummy", dummy_store_functions}, {NULL, NULL, NULL}};
...
static int dummy_rand_instantiate(void *vdrbg, unsigned int strength, int prediction_resistance,
...
static int dummy_rand_generate(void *vctx, unsigned char *out, size_t outlen, unsigned int strength,
...
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {OSSL_PARAM_size_t(OSSL_RAND_PARAM_MAX_REQUEST, NULL),
                                                           OSSL_PARAM_END};
...
static const OSSL_DISPATCH dummy_rand_functions[] = {
    ...
    {OSSL_FUNC_RAND_GETTABLE_CTX_PARAMS, (void (*)(void))dummy_rand_gettable_ctx_params},
...
static const OSSL_ALGORITHM dummy_rand[] = {{"DUMMY", "provider=dummy", dummy_rand_functions}, {NULL, NULL, NULL}};
...
static const OSSL_DISPATCH dummy_dispatch_table[] = {{OSSL_FUNC_PROVIDER_QUERY_OPERATION, (void (*)(void))dummy_query},
                                                     {OSSL_FUNC_PROVIDER_TEARDOWN, (void (*)(void))OSSL_LIB_CTX_free},
                                                     OSSL_DISPATCH_END};

static int dummy_provider_init(const OSSL_CORE_HANDLE *handle, const OSSL_DISPATCH *in, const OSSL_DISPATCH **out,
                               void **provctx)
{
...
static int fetch_test(int tst)
{
    ...
    case 2:
        ...
        break;
    case 3:
        if (!TEST_true(RAND_set_DRBG_type(libctx, "DUMMY", query ? "provider=dummy" : NULL, NULL, NULL))
