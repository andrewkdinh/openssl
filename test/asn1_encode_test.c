    ...
    ASN1_SEQUENCE(ASN1_INT32_DATA)
        ...
        ASN1_SEQUENCE(ASN1_UINT32_DATA)
            = {ASN1_SIMPLE(ASN1_UINT32_DATA, success, ASN1_BOOLEAN),
               ...
               ASN1_EXP_OPT_EMBED(ASN1_UINT32_DATA,
                                  test_zuint32,
                                  ZUINT32,
            ...
            ASN1_SEQUENCE(ASN1_INT64_DATA)
                = {ASN1_SIMPLE(ASN1_INT64_DATA, success, ASN1_BOOLEAN),
                   ...
                   ASN1_EXP_OPT_EMBED(ASN1_INT64_DATA,
                                      test_zint64,
                                      ZINT64,
                ...
                ASN1_SEQUENCE(ASN1_UINT64_DATA)
                    = {ASN1_SIMPLE(ASN1_UINT64_DATA, success, ASN1_BOOLEAN),
                       ...
                       ASN1_EXP_OPT_EMBED(ASN1_UINT64_DATA,
                                          test_zuint64,
                                          ZUINT64,
                     ...
                     */
                    static int do_decode(unsigned char      *bytes,
                                         long                nbytes,
                                                ...
                                                const TEST_PACKAGE     *package)
                    {
                        ...
                        ret = do_decode(encoding, (long)encoding_length, expected, expected_size, package);
...
#define DATA_BUF_SIZE 256
                    ...
                    static int test_intern(const TEST_PACKAGE *package)
                    {
                        ...
                        for (i = 0; i < nelems; i++) {
                            ...
                            switch (do_enc_dec(expected, (long)package->encdec_data_elem_size, package)) {
                            case -1:
                                if (expected->success) {
