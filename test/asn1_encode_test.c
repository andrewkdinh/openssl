...
static unsigned char t_9bytes_1[] = {0x01, 0xff, 0xff, 0xff, 0xff,
                                     0xff, 0xff, 0xff, 0xff};
static unsigned char t_8bytes_1[] = {0x00, 0x80, 0x00, 0x00, 0x00,
                                     0x00, 0x00, 0x00, 0x00};
static unsigned char t_8bytes_2[] = {0x7f, 0xff, 0xff, 0xff,
                                     0xff, 0xff, 0xff, 0xff};
static unsigned char t_8bytes_3_pad[] = {0x00, 0x7f, 0xff, 0xff, 0xff,
                                         0xff, 0xff, 0xff, 0xff};
static unsigned char t_8bytes_4_neg[] = {0x80, 0x00, 0x00, 0x00,
                                         0x00, 0x00, 0x00, 0x00};
static unsigned char t_8bytes_5_negpad[] = {0xff, 0x80, 0x00, 0x00, 0x00,
                                            0x00, 0x00, 0x00, 0x00};
...
ASN1_SEQUENCE(ASN1_LONG_DATA)
    = {ASN1_SIMPLE(ASN1_LONG_DATA, success, ASN1_BOOLEAN),
       ...
       ASN1_EXP_OPT(ASN1_LONG_DATA, test_zlong, ZLONG,
                    0)} static_ASN1_SEQUENCE_END(ASN1_LONG_DATA)

        IMPLEMENT_STATIC_ASN1_ENCODE_FUNCTIONS(
            ASN1_LONG_DATA) IMPLEMENT_STATIC_ASN1_ALLOC_FUNCTIONS(ASN1_LONG_DATA)
            ...
            static ASN1_LONG_DATA long_expected_32bit[] = {
                ...
                CUSTOM_EXPECTED_SUCCESS(INT32_MAX - 1,
                                        INT32_MAX - 1), /* t_4bytes_2 */
                CUSTOM_EXPECTED_FAILURE, /* t_4bytes_3_pad (illegal padding) */
                CUSTOM_EXPECTED_SUCCESS(INT32_MIN,
                                        INT32_MIN), /* t_4bytes_4_neg */
    ...
    static ASN1_LONG_DATA long_expected_64bit[] = {
        ...
        CUSTOM_EXPECTED_SUCCESS((long)0x1ffffffff,
                                (long)0x1ffffffff), /* t_5bytes_1 */
        CUSTOM_EXPECTED_SUCCESS((long)0x80000000,
                                (long)0x80000000), /* t_4bytes_1 */
    ...
    ASN1_SEQUENCE(ASN1_INT32_DATA)
        = {ASN1_SIMPLE(ASN1_INT32_DATA, success, ASN1_BOOLEAN),
           ...
           ASN1_EXP_OPT_EMBED(ASN1_INT32_DATA, test_zint32, ZINT32,
                              0)} static_ASN1_SEQUENCE_END(ASN1_INT32_DATA)
            ...
            IMPLEMENT_STATIC_ASN1_ENCODE_FUNCTIONS(ASN1_INT32_DATA)
                IMPLEMENT_STATIC_ASN1_ALLOC_FUNCTIONS(ASN1_INT32_DATA)
                    ...
                    static ASN1_INT32_DATA int32_expected[] = {
                        ...
                        CUSTOM_EXPECTED_SUCCESS(ASN1_LONG_UNDEF,
                                                ASN1_LONG_UNDEF), /* t_zero */
                        CUSTOM_EXPECTED_SUCCESS(1, 1), /* t_one */
                        CUSTOM_EXPECTED_SUCCESS(-1, -1), /* t_one_neg */
                        CUSTOM_EXPECTED_SUCCESS(-256, -256), /* t_minus_256 */
                        CUSTOM_EXPECTED_FAILURE, /* t_9bytes_1 */
        ...
        ASN1_SEQUENCE(ASN1_UINT32_DATA)
                ...
                IMPLEMENT_STATIC_ASN1_ENCODE_FUNCTIONS(ASN1_UINT32_DATA)
                    IMPLEMENT_STATIC_ASN1_ALLOC_FUNCTIONS(ASN1_UINT32_DATA)
                        ...
                        static ASN1_UINT32_DATA uint32_expected[] = {
                            CUSTOM_EXPECTED_SUCCESS(0, 0), /* t_zero */
                            CUSTOM_EXPECTED_SUCCESS(
                                ASN1_LONG_UNDEF, ASN1_LONG_UNDEF), /* t_zero */
                            CUSTOM_EXPECTED_SUCCESS(1, 1), /* t_one */
                            ...
                            CUSTOM_EXPECTED_FAILURE, /* t_5bytes_1 */
                            CUSTOM_EXPECTED_SUCCESS(
                                0x80000000, 0x80000000), /* t_4bytes_1 */
                            CUSTOM_EXPECTED_SUCCESS(
                                INT32_MAX - 1, INT32_MAX - 1), /* t_4bytes_2 */
                            CUSTOM_EXPECTED_FAILURE, /* t_4bytes_3_pad (illegal padding) */
            ...
            static TEST_PACKAGE uint32_test_package = {
                ASN1_ITEM_ref(ASN1_UINT32_DATA),
                "UINT32",
                0,
                uint32_expected,
            ...
            ASN1_SEQUENCE(ASN1_INT64_DATA)
                = {ASN1_SIMPLE(ASN1_INT64_DATA, success, ASN1_BOOLEAN),
                   ...
                   ASN1_EXP_OPT_EMBED(
                       ASN1_INT64_DATA, test_zint64, ZINT64,
                    ...
                    IMPLEMENT_STATIC_ASN1_ENCODE_FUNCTIONS(ASN1_INT64_DATA)
                        IMPLEMENT_STATIC_ASN1_ALLOC_FUNCTIONS(ASN1_INT64_DATA)
                            ...
                            static ASN1_INT64_DATA int64_expected[] = {
                                ...
                                CUSTOM_EXPECTED_SUCCESS(1, 1), /* t_one */
                                CUSTOM_EXPECTED_SUCCESS(-1, -1), /* t_one_neg */
                                CUSTOM_EXPECTED_SUCCESS(-256,
                                                        -256), /* t_minus_256 */
                                CUSTOM_EXPECTED_FAILURE, /* t_9bytes_1 */
                                CUSTOM_EXPECTED_FAILURE, /* t_8bytes_1 (too large positive) */
                                CUSTOM_EXPECTED_SUCCESS(
                                    INT64_MAX, INT64_MAX), /* t_8bytes_2 */
                                CUSTOM_EXPECTED_FAILURE, /* t_8bytes_3_pad (illegal padding) */
                                CUSTOM_EXPECTED_SUCCESS(
                                    INT64_MIN, INT64_MIN), /* t_8bytes_4_neg */
                                CUSTOM_EXPECTED_FAILURE, /* t_8bytes_5_negpad (illegal padding) */
                                CUSTOM_EXPECTED_SUCCESS(
                                    0x1ffffffffULL,
                                    0x1ffffffffULL), /* t_5bytes_1 */
                                CUSTOM_EXPECTED_SUCCESS(
                                    0x80000000, 0x80000000), /* t_4bytes_1 */
                                CUSTOM_EXPECTED_SUCCESS(
                                    INT32_MAX - 1,
                                ...
                                CUSTOM_EXPECTED_FAILURE, /* t_4bytes_3_pad (illegal padding) */
                                CUSTOM_EXPECTED_SUCCESS(
                                    INT32_MIN, INT32_MIN), /* t_4bytes_4_neg */
                                CUSTOM_EXPECTED_FAILURE, /* t_4bytes_5_negpad (illegal padding) */
                };
                ...
                ASN1_SEQUENCE(ASN1_UINT64_DATA)
                    = {ASN1_SIMPLE(ASN1_UINT64_DATA, success, ASN1_BOOLEAN),
                       ...
                       ASN1_EXP_OPT_EMBED(
                           ASN1_UINT64_DATA, test_zuint64, ZUINT64,
                    ...
                    static TEST_PACKAGE uint64_test_package = {
                        ASN1_ITEM_ref(ASN1_UINT64_DATA),
                        "UINT64",
                        0,
                        uint64_expected,
 ...
 */
                    static int do_encode(
                        EXPECTED * input, const unsigned char *expected,
                        size_t expected_len, const TEST_PACKAGE *package)
                    {
                    ...
                    static size_t der_encode_length(size_t len,
                                                    unsigned char **pp)
                    {
                        size_t lenbytes;
                    ...
                    static size_t make_custom_der(
                        const TEST_CUSTOM_DATA *custom_data,
                        unsigned char **encoding, int explicit_default)
                    {
                        size_t firstbytes, secondbytes = 0,
                                           secondbytesinner = 0, seqbytes;
                        const unsigned char t_true[] = {V_ASN1_BOOLEAN, 0x01,
                                                        0xff};
     ...
     */
                        firstbytes = 1
                            + der_encode_length(custom_data->nbytes1, NULL)
                            + custom_data->nbytes1;
         ...
         */
                            secondbytesinner = 1
                                + der_encode_length(custom_data->nbytes2, NULL)
                                + custom_data->nbytes2;
                            secondbytes = 1
                                + der_encode_length(secondbytesinner, NULL)
                                + secondbytesinner;
                        }
     ...
     */
                        seqbytes =
                            1
                            + der_encode_length(
                                sizeof(t_true) + firstbytes + secondbytes, NULL)
                        ...
                        *p++ = 0x30;
                        der_encode_length(
                            sizeof(t_true) + firstbytes + secondbytes, &p);

                        /* ASN1_BOOLEAN TRUE */
                        memcpy(p, t_true,
                               sizeof(t_true)); /* Marks decoding success */
                        p += sizeof(t_true);
     ...
     */
                        size_t encoding_length =
                            make_custom_der(custom_data, &encoding, 1);
                        int ret;

                        if (encoding_length == 0)
                            return -1;

                        ret = do_decode(encoding, encoding_length, expected,
                                        expected_size, package);
                    ...
                    static int do_encode_custom(
                        EXPECTED * input, const TEST_CUSTOM_DATA *custom_data,
                        const TEST_PACKAGE *package)
                    {
                        unsigned char *expected = NULL;
                        size_t expected_length =
                            make_custom_der(custom_data, &expected, 0);
                        int ret;

                        if (expected_length == 0)
                            return -1;

                        ret = do_encode(input, expected, expected_length,
                                        package);
...
#define DATA_BUF_SIZE 256
                    ...
                    static int test_intern(const TEST_PACKAGE *package)
                    {
                        ...
                        for (i = 0; i < nelems; i++) {
                            size_t pos =
                                i * package->encode_expectations_elem_size;
                            EXPECTED *expected = (EXPECTED *)&(
                                (unsigned char *)
                                    package->encode_expectations)[pos];

                            switch (do_encode_custom(
                                expected, &test_custom_data[i], package)) {
                            case -1:
                                if (expected->success) {
                                    TEST_error(
                            ...
                            switch (do_decode_custom(
                                &test_custom_data[i], expected,
                                package->encode_expectations_elem_size,
                                package)) {
                            case -1:
                                if (expected->success) {
                        ...
                        /* Do enc_dec checks */
                        nelems = package->encdec_data_size
                            / package->encdec_data_elem_size;
                        for (i = 0; i < nelems; i++) {
                            size_t pos = i * package->encdec_data_elem_size;
                            EXPECTED *expected = (EXPECTED *)&(
                                (unsigned char *)package->encdec_data)[pos];

                            switch (do_enc_dec(expected,
                                               package->encdec_data_elem_size,
                                               package)) {
                            case -1:
                                if (expected->success) {
     ...
     */
                                ASN1_IMP(
                                    INVALIDTEMPLATE, invalidDirString,
                                    DIRECTORYSTRING,
