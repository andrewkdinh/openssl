...
static int test_dsa_param_keygen(int tstid) {
   ...
   */
  static const BIGNUM *bn[] = {&ossl_bignum_dh2048_256_p,
  ...
  if (!TEST_ptr(pkey_parm = EVP_PKEY_new()) || !TEST_ptr(dsa = DSA_new()) ||
      !TEST_ptr(p = BN_dup(bn[pind])) || !TEST_ptr(q = BN_dup(bn[qind])) ||
      !TEST_ptr(g = BN_dup(bn[gind])) || !TEST_true(DSA_set0_pqg(dsa, p, q, g)))
    goto err;
  p = q = g = NULL;
  ...
  if (!TEST_ptr(gen_ctx =
                EVP_PKEY_CTX_new_from_pkey(libctx, pkey_parm, NULL)) ||
...
static int do_dh_param_keygen(int tstid, const BIGNUM **bn) {
  ...
  if (!TEST_ptr(pkey_parm = EVP_PKEY_new()) || !TEST_ptr(dh = DH_new()) ||
      !TEST_ptr(p = BN_dup(bn[pind])) || !TEST_ptr(q = BN_dup(bn[qind])) ||
      !TEST_ptr(g = BN_dup(bn[gind])) || !TEST_true(DH_set0_pqg(dh, p, q, g)))
    goto err;
  p = q = g = NULL;
...
static int test_dh_safeprime_param_keygen(int tstid) {
  static const BIGNUM *bn[] = {&ossl_bignum_ffdhe2048_p,
                               &ossl_bignum_ffdhe2048_q, &ossl_bignum_const_2};
...
static int dhx_cert_load(void) {
  ...
  0x30, 0x82, 0x03, 0xff, 0x30, 0x82, 0x02, 0xe7, 0xa0, 0x03, 0x02, 0x01, 0x02,
  0x02, 0x09, 0x00, 0xdb, 0xf5, 0x4d, 0x22, 0xa0, 0x7a, 0x67, 0xa6, 0x30, 0x0d,
  ...
  };
...
static int test_cipher_reinit(int test_id) {
  ...
  0x0d, 0x0e, 0x0f, 0x01, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09,
  0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x02, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06,
  0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x03, 0x01, 0x02, 0x03,
  ...
  if (ccm == 0) {
    if (diff) {
      ...
      if (!TEST_mem_eq(out1, out1_len, out2, out2_len) ||
          (!siv && !no_null_key &&
           !TEST_mem_eq(out1, out1_len, out3, out3_len)))
        goto err;
    }
  }
  ret = 1;
...
static int test_cipher_reinit_partialupdate(int test_id) {
  ...
  0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0xba, 0xbe, 0xba,
  0xbe, 0x00, 0x00, 0xba, 0xbe, 0x01, 0x01, 0x02, 0x03, 0x04, 0x05,
...
static int rsa_keygen(int bits, EVP_PKEY **pub, EVP_PKEY **priv) {
  ...
  if (!TEST_ptr(*priv = EVP_PKEY_Q_keygen(libctx, NULL, "RSA", (size_t)bits)) ||
      !TEST_ptr(ectx = OSSL_ENCODER_CTX_new_for_pkey(
                *priv, EVP_PKEY_PUBLIC_KEY, "DER", "type-specific", NULL)) ||
...
static int kem_rsa_gen_recover(void) {
  ...
  ret =
  TEST_true(rsa_keygen(bits, &pub, &priv)) &&
  ...
  TEST_int_eq(EVP_PKEY_encapsulate(dctx, NULL, &ctlen, NULL, &secretlen), 1) &&
  TEST_int_eq(ctlen, secretlen) && TEST_int_eq(ctlen, bits / 8) &&
  TEST_int_eq(EVP_PKEY_encapsulate(dctx, ct, &ctlen, secret, &secretlen), 1) &&
  ...
  if (fips_provider_version_match(libctx, ">=3.4.0")) {
    ctlen = 1;
    if (!TEST_int_eq(EVP_PKEY_encapsulate(dctx, ct, &ctlen, secret, &secretlen),
                     0))
      ret = 0;
    unwraplen = 1;
    if (!TEST_int_eq(EVP_PKEY_decapsulate(rctx, unwrap, &unwraplen, ct, ctlen),
                     0))
      ret = 0;
  }
...
static int test_cipher_tdes_randkey(void) {
  ...
  ret =
  TEST_ptr(aes_cipher = EVP_CIPHER_fetch(libctx, "AES-256-CBC", NULL)) &&
...
static int kem_rsa_params(void) {
  ...
  ret =
  TEST_true(rsa_keygen(2048, &pub, &priv)) &&
  ...
  TEST_int_eq(EVP_PKEY_decapsulate(pubctx, secret, &secretlen, ct, sizeof(ct)),
              0) &&
  ...
  (is_fips_lt_3_5 ||
   (TEST_int_eq(EVP_PKEY_encapsulate(pubctx, NULL, &ctlen, NULL, &secretlen),
                1) &&
    TEST_true(ctlen <= sizeof(ct)) && TEST_true(secretlen <= sizeof(secret)) &&
    TEST_int_eq(EVP_PKEY_encapsulate(pubctx, ct, &ctlen, secret, &secretlen),
                1)))
  ...
  TEST_int_eq(EVP_PKEY_decapsulate(privctx, NULL, &secretlen, ct, sizeof(ct)),
              1) &&
  ...
  TEST_int_eq(
  EVP_PKEY_decapsulate(privctx, secret, &secretlen, NULL, sizeof(ct)), 0) &&
...
static void string_free(char *m) { OPENSSL_free(m); }
