...
static int test_kdf_tls1_prf(void)
{
    ...
    static const unsigned char expected[sizeof(out)] =
        {0x8e, 0x4d, 0x93, 0x25, 0x30, 0xd7, 0x65, 0xa0, 0xaa, 0xe9, 0x74, 0xc3, 0x04, 0x73, 0x5e, 0xcc};
...
static int do_kdf_hkdf_gettables(int extract_only, int has_digest)
{
    ...
    if (!TEST_ptr(
            params =
                construct_hkdf_params(has_digest ? "sha256" : NULL, "secret", 6, "salt", extract_only ? NULL : "label"))
...
static int test_kdf_pbkdf1(void)
{
    ...
    params = construct_pbkdf1_params("passwordPASSWORDpassword",
                                     "sha256",
...
static int test_kdf_pbkdf2(void)
{
    ...
    params                                    = construct_pbkdf2_params("passwordPASSWORDpassword",
                                     "sha256",
                                     "saltSALTsaltSALTsaltSALTsaltSALTsalt",
                                     &iterations,
                                     &mode);
...
static int test_kdf_x963(void)
{
    ...
    static unsigned char shared[] =
        {0xe3, 0xb5, 0xb4, 0xc1, 0xb0, 0xd5, 0xcf, 0x1d, 0x2b, 0x3a, 0x2f, 0x99, 0x37, 0x89, 0x5d, 0x31};
    static const unsigned char expected[sizeof(out)] = {
...
static OSSL_PARAM *
construct_kbkdf_params(char *digest, char *mac, unsigned char *key, size_t keylen, char *salt, char *info, int *r)
{
...
static int test_kdf_ss_hmac(void)
{
    ...
    static unsigned char salt[] =
        {0x36, 0x38, 0x27, 0x1c, 0xcd, 0x68, 0xa2, 0x5d, 0xc2, 0x4e, 0xcd, 0xdd, 0x39, 0xef, 0x3f, 0x89};
    static const unsigned char expected[sizeof(out)] =
        {0x44, 0xf6, 0x76, 0xe8, 0x5c, 0x1b, 0x1a, 0x8b, 0xbc, 0x3d, 0x31, 0x92, 0x18, 0x63, 0x1c, 0xa3};
...
static int test_kdf_krb5kdf(void)
{
    ...
    static const unsigned char expected[sizeof(out)] =
        {0x34, 0x28, 0x0A, 0x38, 0x2B, 0xC9, 0x27, 0x69, 0xB2, 0xDA, 0x2F, 0x9E, 0xF0, 0x66, 0x85, 0x4B};
...
static int test_kbkdf_mac_change(void)
{
    ...
    static const unsigned char       output[] =
        {0x6c, 0x03, 0x76, 0x52, 0x99, 0x06, 0x74, 0xa0, 0x78, 0x44, 0x73, 0x2d, 0x0a, 0xd9, 0x85, 0xf9};
