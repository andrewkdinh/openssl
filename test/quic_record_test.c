...
static const struct rx_test_op rx_script_1[] = {
    RX_OP_SET_SCID_LEN(2) RX_OP_SET_INIT_LARGEST_PN(0)
        RX_OP_SET_RX_DCID(empty_conn_id)
            RX_OP_PROVIDE_SECRET_INITIAL(rx_script_1_dcid) RX_OP_INJECT_CHECK(1)
        ...
        RX_OP_CHECK_NO_PKT()
            RX_OP_PROVIDE_SECRET_INITIAL(rx_script_6_c2s_init_dcid)
                RX_OP_CHECK_PKT_N(6a) RX_OP_CHECK_NO_PKT() RX_OP_PROVIDE_SECRET(
                    ...
                    rx_script_6_handshake_secret) RX_OP_CHECK_PKT_N(6b)
                    RX_OP_CHECK_NO_PKT() RX_OP_PROVIDE_SECRET(
                        QUIC_ENC_LEVEL_1RTT, QRL_SUITE_AES256GCM,
                        rx_script_6_1rtt_secret) RX_OP_CHECK_PKT_N(6c)
                        RX_OP_CHECK_NO_PKT()
...
static const struct rx_test_op rx_script_7[] = {
    ...
    RX_OP_SET_SCID_LEN(0) RX_OP_SET_RX_DCID(empty_conn_id) RX_OP_INJECT_N(7)
        RX_OP_CHECK_NO_PKT()
            RX_OP_PROVIDE_SECRET_INITIAL(rx_script_7_c2s_init_dcid)
                RX_OP_CHECK_PKT_N(7a) RX_OP_CHECK_NO_PKT() RX_OP_PROVIDE_SECRET(
                    QUIC_ENC_LEVEL_HANDSHAKE, QRL_SUITE_CHACHA20POLY1305,
                    rx_script_7_handshake_secret) RX_OP_CHECK_PKT_N(7b)
                    RX_OP_CHECK_NO_PKT() RX_OP_PROVIDE_SECRET(
...
static int rx_run_script(const struct rx_test_op *script)
{
    ...
    for (; op->op != RX_TEST_OP_END; ++op) switch (op->op) {
...
static const unsigned char
    pkt_hdr_test_1_expected[] = {0xc1, /* Long|Fixed, Type=Initial, PN Len=2 */
...
static const unsigned char
    pkt_hdr_test_2_expected[] = {0xc1, /* Long|Fixed, Type=Initial, PN Len=2 */
                                 0x00, 0x00, 0x00, 0x01, /* Version */
                                 0x00, /* DCID Length */
                                 0x08, 0xf0, 0x67, 0xa5, 0x50, 0x2a,
                                 0x42, 0x62, 0xb5, /* SCID Length, SCID */
...
static const unsigned char
    pkt_hdr_test_3_expected[] = {0xc1, /* Long|Fixed, Type=Initial, PN Len=2 */
                                 0x00, 0x00, 0x00, 0x01, /* Version */
                                 0x03, /* DCID Length */
                                 0x70, 0x71, 0x72, /* DCID */
                                 0x08, 0xf0, 0x67, 0xa5, 0x50, 0x2a,
...
static const unsigned char
    pkt_hdr_test_17_expected[] = {0xcd, /* Long|Fixed, Type=Initial, PN Len=2 */
                                  0x00, 0x00, 0x00, 0x01, /* Version */
                                  0x00, /* DCID Length */
                                  0x08, 0xf0, 0x67, 0xa5, 0x50, 0x2a,
                                  0x42, 0x62, 0xb5, /* SCID Length, SCID */
...
static const unsigned char
    pkt_hdr_test_18_expected[] = {0xd8, /* Long|Fixed, Type=0-RTT, PN Len=1 */
                                  0x00, 0x00, 0x00, 0x01, /* Version */
                                  0x03, /* DCID Length */
                                  0x70, 0x71, 0x72, /* DCID */
                                  0x08, 0xf0, 0x67, 0xa5, 0x50, 0x2a,
...
static int tx_run_script(const struct tx_test_op *script)
{
    ...
    for (; op->op != TX_TEST_OP_END; ++op) switch (op->op) {
