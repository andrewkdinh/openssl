...
static int test_srtm(void)
{
    ...
    if (!TEST_true(ossl_quic_srtm_add(srtm, ptrs + 0, 0, &token_1))
        ...
        || !TEST_ptr_eq(opaque, ptrs + 1) || !TEST_uint64_t_eq(seq_num, 0)
        || !TEST_true(
        ...
        || !TEST_ptr_eq(opaque, ptrs + 0) || !TEST_uint64_t_eq(seq_num, 2)
        || !TEST_true(
        ...
        || !TEST_ptr_eq(opaque, ptrs + 0) || !TEST_uint64_t_eq(seq_num, 0)
        || !TEST_false(
