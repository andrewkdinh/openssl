...
static const unsigned char private_constant[XOR_KEY_SIZE] = {
    0xd3, 0x6b, 0x54, 0xec, 0x5b, 0xac, 0x89, 0x96, 0x8c, 0x2c, 0x66, 0xa5, 0x67, 0x0d, 0xe3, 0xdd,
    0x43, 0x69, 0xbc, 0x83, 0x3d, 0x60, 0xc7, 0xb8, 0x2b, 0x1c, 0x5a, 0xfd, 0xb5, 0xcd, 0xd0, 0xf8};
 ...
 */
static OSSL_FUNC_keymgmt_new_fn *xor_prov_get_keymgmt_new(const OSSL_DISPATCH *fns)
{
...
static OSSL_FUNC_keymgmt_free_fn *xor_prov_get_keymgmt_free(const OSSL_DISPATCH *fns)
{
    /* Pilfer the keymgmt dispatch table */
    for (; fns->function_id != 0; fns++)
...
static OSSL_FUNC_keymgmt_import_fn *xor_prov_get_keymgmt_import(const OSSL_DISPATCH *fns)
{
    /* Pilfer the keymgmt dispatch table */
    for (; fns->function_id != 0; fns++)
...
static OSSL_FUNC_keymgmt_export_fn *xor_prov_get_keymgmt_export(const OSSL_DISPATCH *fns)
{
    /* Pilfer the keymgmt dispatch table */
    for (; fns->function_id != 0; fns++)
...
static void *xor_prov_import_key(const OSSL_DISPATCH *fns, void *provctx, int selection, const OSSL_PARAM params[])
{
...
static const OSSL_PARAM xor_group_params[] = {
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_GROUP_NAME, XORGROUP_NAME, sizeof(XORGROUP_NAME)),
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_GROUP_NAME_INTERNAL, XORGROUP_NAME_INTERNAL,
    ...
    OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_GROUP_SECURITY_BITS, &xor_group.secbits),
...
static const OSSL_PARAM xor_kemgroup_params[] = {
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_GROUP_NAME, XORKEMGROUP_NAME, sizeof(XORKEMGROUP_NAME)),
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_GROUP_NAME_INTERNAL, XORKEMGROUP_NAME_INTERNAL,
                           sizeof(XORKEMGROUP_NAME_INTERNAL)),
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_GROUP_ALG, ALGORITHM, sizeof(ALGORITHM)),
    OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_GROUP_ID, &xor_kemgroup.group_id),
    OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_GROUP_SECURITY_BITS, &xor_kemgroup.secbits),
...
static const OSSL_PARAM xor_sig_nohash_params[] = {
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_SIGALG_IANA_NAME, XORSIGALG_NAME, sizeof(XORSIGALG_NAME)),
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_SIGALG_NAME, XORSIGALG_NAME, sizeof(XORSIGALG_NAME)),
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_SIGALG_OID, XORSIGALG_OID, sizeof(XORSIGALG_OID)),
    OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_SIGALG_CODE_POINT, &xor_sigalg.code_point),
    OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_SIGALG_SECURITY_BITS, &xor_sigalg.secbits),
    OSSL_PARAM_int(OSSL_CAPABILITY_TLS_SIGALG_MIN_TLS, &xor_sigalg.mintls),
    OSSL_PARAM_int(OSSL_CAPABILITY_TLS_SIGALG_MAX_TLS, &xor_sigalg.maxtls),
    OSSL_PARAM_END};

static const OSSL_PARAM xor_sig_hash_params[] = {
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_SIGALG_IANA_NAME, XORSIGALG_HASH_NAME, sizeof(XORSIGALG_HASH_NAME)),
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_SIGALG_NAME, XORSIGALG_HASH_NAME, sizeof(XORSIGALG_HASH_NAME)),
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_SIGALG_HASH_NAME, XORSIGALG_HASH, sizeof(XORSIGALG_HASH)),
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_SIGALG_OID, XORSIGALG_HASH_OID, sizeof(XORSIGALG_HASH_OID)),
    OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_SIGALG_CODE_POINT, &xor_sigalg_hash.code_point),
    OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_SIGALG_SECURITY_BITS, &xor_sigalg_hash.secbits),
    OSSL_PARAM_int(OSSL_CAPABILITY_TLS_SIGALG_MIN_TLS, &xor_sigalg_hash.mintls),
    OSSL_PARAM_int(OSSL_CAPABILITY_TLS_SIGALG_MAX_TLS, &xor_sigalg_hash.maxtls),
    OSSL_PARAM_END};

static const OSSL_PARAM xor_sig_12_params[] = {
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_SIGALG_IANA_NAME, XORSIGALG12_NAME, sizeof(XORSIGALG12_NAME)),
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_SIGALG_NAME, XORSIGALG12_NAME, sizeof(XORSIGALG12_NAME)),
    OSSL_PARAM_utf8_string(OSSL_CAPABILITY_TLS_SIGALG_OID, XORSIGALG12_OID, sizeof(XORSIGALG12_OID)),
    OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_SIGALG_CODE_POINT, &xor_sigalg12.code_point),
    OSSL_PARAM_uint(OSSL_CAPABILITY_TLS_SIGALG_SECURITY_BITS, &xor_sigalg12.secbits),
    OSSL_PARAM_int(OSSL_CAPABILITY_TLS_SIGALG_MIN_TLS, &xor_sigalg12.mintls),
    OSSL_PARAM_int(OSSL_CAPABILITY_TLS_SIGALG_MAX_TLS, &xor_sigalg12.maxtls),
    OSSL_PARAM_END};
...
static int tls_prov_get_capabilities(void *provctx, const char *capability, OSSL_CALLBACK *cb, void *arg)
{
    ...
    if (strcmp(capability, "TLS-GROUP") == 0) {
        ...
        OPENSSL_assert(xor_group.group_id >= 65024 && xor_group.group_id < 65279 - NUM_DUMMY_GROUPS);
...
static const OSSL_DISPATCH xor_keyexch_functions[] = {{OSSL_FUNC_KEYEXCH_NEWCTX, (void (*)(void))xor_newkemkexctx},
...
static int xor_encapsulate(void *vpxorctx, unsigned char *ct, size_t *ctlen, unsigned char *ss, size_t *sslen)
{
    /*
    ...
    *ctlen = XOR_KEY_SIZE;
    ...
    if (derivectx == NULL || !xor_init(derivectx, ourkey, NULL) || !xor_set_peer(derivectx, pxorctx->key)
...
static int xor_decapsulate(void *vpxorctx, unsigned char *ss, size_t *sslen, const unsigned char *ct, size_t ctlen)
{
    /*
     * We are building this around a KEX:
     *
    ...
    /* Derive ss via KEX */
    derivectx = xor_newkemkexctx(pxorctx->provctx);
    if (derivectx == NULL || !xor_init(derivectx, pxorctx->key, NULL) || !xor_set_peer(derivectx, peerkey)
        || !xor_derive(derivectx, ss, sslen, XOR_KEY_SIZE))
        goto end;
...
static const OSSL_DISPATCH xor_kem_functions[] = {{OSSL_FUNC_KEM_NEWCTX, (void (*)(void))xor_newkemkexctx},
...
static const OSSL_PARAM xor_params[] = {
    OSSL_PARAM_int(OSSL_PKEY_PARAM_BITS, NULL), OSSL_PARAM_int(OSSL_PKEY_PARAM_SECURITY_BITS, NULL),
...
static int xor_set_params(void *vkey, const OSSL_PARAM params[])
{
    ...
    if (p != NULL) {
        if (p->data_type != OSSL_PARAM_OCTET_STRING || p->data_size != XOR_KEY_SIZE)
            return 0;
...
static int xor_gen_set_params(void *genctx, const OSSL_PARAM params[])
{
    ...
    if (p != NULL) {
        if (p->data_type != OSSL_PARAM_UTF8_STRING
            || (strcmp(p->data, XORGROUP_NAME_INTERNAL) != 0 && strcmp(p->data, XORKEMGROUP_NAME_INTERNAL) != 0))
            return 0;
    }
...
static int xor_export(void *vkey, int select, OSSL_CALLBACK *param_cb, void *cbarg)
{
    ...
    *p++ = OSSL_PARAM_construct_octet_string(OSSL_PKEY_PARAM_PRIV_KEY, key->privkey, sizeof(key->privkey));
...
static const OSSL_PARAM xor_key_types[] = {OSSL_PARAM_BN(OSSL_PKEY_PARAM_PUB_KEY, NULL, 0),
                                           OSSL_PARAM_BN(OSSL_PKEY_PARAM_PRIV_KEY, NULL, 0), OSSL_PARAM_END};
...
static const OSSL_DISPATCH xor_keymgmt_functions[] = {
    ...
    {OSSL_FUNC_KEYMGMT_GEN_SETTABLE_PARAMS, (void (*)(void))xor_gen_settable_params},
...
static XORKEY *xor_key_op(const X509_ALGOR *palg, const unsigned char *p, int plen, xor_key_op_t op,
...
static XORKEY *xor_key_from_x509pubkey(const X509_PUBKEY *xpk, OSSL_LIB_CTX *libctx, const char *propq)
{
...
static XORKEY *xor_key_from_pkcs8(const PKCS8_PRIV_KEY_INFO *p8inf, OSSL_LIB_CTX *libctx, const char *propq)
{
    XORKEY *xork = NULL;
    const unsigned char *p;
    int plen;
    ...
    xork = xor_key_op(palg, p, plen, KEY_OP_PRIVATE, libctx, propq);
...
static const OSSL_ALGORITHM tls_prov_keymgmt[] = {
    ...
    {XORSIGALG_NAME, "provider=tls-provider,fips=yes", xor_xorhmacsig_keymgmt_functions},
    {XORSIGALG_HASH_NAME, "provider=tls-provider,fips=yes", xor_xorhmacsha2sig_keymgmt_functions},
    {NULL, NULL, NULL}};
...
typedef int key_to_der_fn(BIO *out, const void *key, int key_nid, const char *pemname, key_to_paramstring_fn *p2s,
...
static PKCS8_PRIV_KEY_INFO *key_to_p8info(const void *key, int key_nid, void *params, int params_type, i2d_of_void *k2d)
{
    ...
    if ((p8info = PKCS8_PRIV_KEY_INFO_new()) == NULL || (derlen = k2d(key, &der)) <= 0
        || !PKCS8_pkey_set0(p8info, OBJ_nid2obj(key_nid), 0, V_ASN1_UNDEF, NULL, der, derlen)) {
        ERR_raise(ERR_LIB_USER, ERR_R_MALLOC_FAILURE);
...
static X509_SIG *key_to_encp8(const void *key, int key_nid, void *params, int params_type, i2d_of_void *k2d,
...
static X509_PUBKEY *xorx_key_to_pubkey(const void *key, int key_nid, void *params, int params_type, i2d_of_void k2d)
{
    /* der, derlen store the key DER output and its length */
    unsigned char *der = NULL;
    int derlen;
    ...
    if ((xpk = X509_PUBKEY_new()) == NULL || (derlen = k2d(key, &der)) <= 0
        || !X509_PUBKEY_set0_param(xpk, OBJ_nid2obj(key_nid), V_ASN1_UNDEF, NULL, der, derlen)) {
        ERR_raise(ERR_LIB_USER, ERR_R_MALLOC_FAILURE);
...
static int key_to_epki_der_priv_bio(BIO *out, const void *key, int key_nid, ossl_unused const char *pemname,
                                    key_to_paramstring_fn *p2s, i2d_of_void *k2d, struct key2any_ctx_st *ctx)
{
    int ret = 0;
    void *str = NULL;
...
static int key_to_epki_pem_priv_bio(BIO *out, const void *key, int key_nid, ossl_unused const char *pemname,
                                    key_to_paramstring_fn *p2s, i2d_of_void *k2d, struct key2any_ctx_st *ctx)
{
    int ret = 0;
    void *str = NULL;
...
static int key_to_pki_der_priv_bio(BIO *out, const void *key, int key_nid, ossl_unused const char *pemname,
                                   key_to_paramstring_fn *p2s, i2d_of_void *k2d, struct key2any_ctx_st *ctx)
{
    int ret = 0;
    void *str = NULL;
...
static int key_to_pki_pem_priv_bio(BIO *out, const void *key, int key_nid, ossl_unused const char *pemname,
                                   key_to_paramstring_fn *p2s, i2d_of_void *k2d, struct key2any_ctx_st *ctx)
{
    int ret = 0;
    void *str = NULL;
...
static int key_to_spki_der_pub_bio(BIO *out, const void *key, int key_nid, ossl_unused const char *pemname,
                                   key_to_paramstring_fn *p2s, i2d_of_void *k2d, struct key2any_ctx_st *ctx)
{
    int ret = 0;
    X509_PUBKEY *xpk = NULL;
...
static int key_to_spki_pem_pub_bio(BIO *out, const void *key, int key_nid, ossl_unused const char *pemname,
                                   key_to_paramstring_fn *p2s, i2d_of_void *k2d, struct key2any_ctx_st *ctx)
{
    int ret = 0;
    X509_PUBKEY *xpk = NULL;
...
static int prepare_xorx_params(const void *xorxkey, int nid, int save, void **pstr, int *pstrtype)
{
...
static int key2any_encode(struct key2any_ctx_st *ctx, OSSL_CORE_BIO *cout, const void *key, const char *typestr,
                          const char *pemname, key_to_der_fn *writer, OSSL_PASSPHRASE_CALLBACK *pwcb, void *pwcbarg,
                          key_to_paramstring_fn *key2paramstring, i2d_of_void *key2der)
{
    int ret = 0;
 ...
 */
    ...
    ENCODER_w_structure(XORSIGALG_HASH_NAME, xorhmacsha2sig, der, PrivateKeyInfo),
    ENCODER_w_structure(XORSIGALG_HASH_NAME, xorhmacsha2sig, pem, PrivateKeyInfo),
    ENCODER_w_structure(XORSIGALG_HASH_NAME, xorhmacsha2sig, der, EncryptedPrivateKeyInfo),
    ENCODER_w_structure(XORSIGALG_HASH_NAME, xorhmacsha2sig, pem, EncryptedPrivateKeyInfo),
    ENCODER_w_structure(XORSIGALG_HASH_NAME, xorhmacsha2sig, der, SubjectPublicKeyInfo),
    ENCODER_w_structure(XORSIGALG_HASH_NAME, xorhmacsha2sig, pem, SubjectPublicKeyInfo),
...
ASN1_SEQUENCE(X509_PUBKEY_INTERNAL)
    = {ASN1_SIMPLE(X509_PUBKEY, algor, X509_ALGOR),
       ASN1_SIMPLE(X509_PUBKEY, public_key, ASN1_BIT_STRING)} static_ASN1_SEQUENCE_END_name(X509_PUBKEY,
        ...
        * xorx_d2i_X509_PUBKEY_INTERNAL(const unsigned char **pp, long len, OSSL_LIB_CTX *libctx)
    {
        ...
        if (xpub == NULL)
            return NULL;
        return (X509_PUBKEY *)ASN1_item_d2i_ex((ASN1_VALUE **)&xpub, pp, len, ASN1_ITEM_rptr(X509_PUBKEY_INTERNAL),
                                               libctx, NULL);
    }
 ...
 */
    ...
    static int xor_read_der(PROV_XOR_CTX * provctx, OSSL_CORE_BIO * cin, unsigned char **data, long *len)
    {
        BUF_MEM *mem = NULL;
    ...
    static void *xor_der2key_decode_p8(const unsigned char **input_der, long input_der_len, struct der2key_ctx_st *ctx,
                                       key_from_pkcs8_t *key_from_pkcs8)
    {
        ...
        if ((p8inf = d2i_PKCS8_PRIV_KEY_INFO(NULL, input_der, input_der_len)) != NULL
            && PKCS8_pkey_get0(NULL, NULL, NULL, &alg, p8inf) && OBJ_obj2nid(alg->algorithm) == ctx->desc->evp_type)
    ...
    static XORKEY *xor_d2i_PUBKEY(XORKEY * *a, const unsigned char **pp, long length)
    {
        XORKEY *key = NULL;
        X509_PUBKEY *xpk;
...
/* ---------------------------------------------------------------------- */
    ...
    static struct der2key_ctx_st *der2key_newctx(void *provctx, struct keytype_desc_st *desc, const char *tls_name)
    {
    ...
    static int xor_der2key_decode(void *vctx, OSSL_CORE_BIO *cin, int selection, OSSL_CALLBACK *data_cb,
...
next:
     ...
     */
        ...
        if (key != NULL) {
            ...
            params[1] =
                OSSL_PARAM_construct_utf8_string(OSSL_OBJECT_PARAM_DATA_TYPE, (char *)ctx->desc->keytype_name, 0);
    ...
    static int der2key_export_object(void *vctx, const void *reference, size_t reference_sz, OSSL_CALLBACK *export_cb,
                                     void *export_cbarg)
    {
        struct der2key_ctx_st *ctx = vctx;
...
/* ---------------------------------------------------------------------- */
    ...
    static void *xorx_d2i_PKCS8(void **key, const unsigned char **der, long der_len, struct der2key_ctx_st *ctx)
    {
        return xor_der2key_decode_p8(der, der_len, ctx, (key_from_pkcs8_t *)xor_key_from_pkcs8);
    }
 ...
 */
    ...
    static int xor_sig_setup_md(PROV_XORSIG_CTX * ctx, const char *mdname, const char *mdprops)
    {
        EVP_MD *md;
        ...
        if ((md == NULL) || (EVP_MD_nid(md) == NID_undef)) {
            if (md == NULL)
                ERR_raise_data(ERR_LIB_USER, XORPROV_R_INVALID_DIGEST, "%s could not be fetched", mdname);
            EVP_MD_free(md);
            return 0;
        }
    ...
    static int xor_sig_signverify_init(void *vpxor_sigctx, void *vxorsig, int operation)
    {
    ...
    static int xor_sig_sign_init(void *vpxor_sigctx, void *vxorsig, const OSSL_PARAM params[])
    {
        return xor_sig_signverify_init(vpxor_sigctx, vxorsig, EVP_PKEY_OP_SIGN);
    }

    static int xor_sig_verify_init(void *vpxor_sigctx, void *vxorsig, const OSSL_PARAM params[])
    {
        return xor_sig_signverify_init(vpxor_sigctx, vxorsig, EVP_PKEY_OP_VERIFY);
    }

    static int xor_sig_sign(void *vpxor_sigctx, unsigned char *sig, size_t *siglen, size_t sigsize,
     ...
     */
        if (!EVP_Q_mac(pxor_sigctx->libctx, "HMAC", NULL, "sha1", NULL, xorkey->privkey, XOR_KEY_SIZE, tbs, tbslen,
...
endsign:
    ...
    static int xor_sig_verify(void *vpxor_sigctx, const unsigned char *sig, size_t siglen, const unsigned char *tbs,
                              size_t tbslen)
    {
        PROV_XORSIG_CTX *pxor_sigctx = (PROV_XORSIG_CTX *)vpxor_sigctx;
        XORKEY *xorkey = pxor_sigctx->sig;
    ...
    static int xor_sig_digest_signverify_init(void *vpxor_sigctx, const char *mdname, void *vxorsig, int operation)
    {
        PROV_XORSIG_CTX *pxor_sigctx = (PROV_XORSIG_CTX *)vpxor_sigctx;
...
error:
    ...
    static int xor_sig_digest_sign_init(void *vpxor_sigctx, const char *mdname, void *vxorsig,
                                        const OSSL_PARAM params[])
    {
        return xor_sig_digest_signverify_init(vpxor_sigctx, mdname, vxorsig, EVP_PKEY_OP_SIGN);
    }

    static int xor_sig_digest_verify_init(void *vpxor_sigctx, const char *mdname, void *vxorsig,
                                          const OSSL_PARAM params[])
    {
        return xor_sig_digest_signverify_init(vpxor_sigctx, mdname, vxorsig, EVP_PKEY_OP_VERIFY);
    }

    int xor_sig_digest_signverify_update(void *vpxor_sigctx, const unsigned char *data, size_t datalen)
    {
        PROV_XORSIG_CTX *pxor_sigctx = (PROV_XORSIG_CTX *)vpxor_sigctx;
    ...
    int xor_sig_digest_sign_final(void *vpxor_sigctx, unsigned char *sig, size_t *siglen, size_t sigsize)
    {
        PROV_XORSIG_CTX *pxor_sigctx = (PROV_XORSIG_CTX *)vpxor_sigctx;
    ...
    int xor_sig_digest_verify_final(void *vpxor_sigctx, const unsigned char *sig, size_t siglen)
    {
        PROV_XORSIG_CTX *pxor_sigctx = (PROV_XORSIG_CTX *)vpxor_sigctx;
        unsigned char digest[EVP_MAX_MD_SIZE];
        unsigned int dlen = 0;
...
err:
    ...
    static int xor_sig_get_ctx_params(void *vpxor_sigctx, OSSL_PARAM *params)
    {
        ...
        if (p != NULL && !OSSL_PARAM_set_octet_string(p, pxor_sigctx->aid, pxor_sigctx->aid_len))
            return 0;
    ...
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        ...
        OSSL_PARAM_utf8_string(OSSL_SIGNATURE_PARAM_DIGEST, NULL, 0), OSSL_PARAM_END};
    ...
    static const OSSL_PARAM known_settable_ctx_params[] = {
        ...
        OSSL_PARAM_utf8_string(OSSL_SIGNATURE_PARAM_PROPERTIES, NULL, 0), OSSL_PARAM_END};

    static const OSSL_PARAM *xor_sig_settable_ctx_params(ossl_unused void *vpsm2ctx, ossl_unused void *provctx)
    {
    ...
    static const OSSL_DISPATCH xor_signature_functions[] = {
        ...
        {OSSL_FUNC_SIGNATURE_DIGEST_SIGN_INIT, (void (*)(void))xor_sig_digest_sign_init},
        {OSSL_FUNC_SIGNATURE_DIGEST_SIGN_UPDATE, (void (*)(void))xor_sig_digest_signverify_update},
        {OSSL_FUNC_SIGNATURE_DIGEST_SIGN_FINAL, (void (*)(void))xor_sig_digest_sign_final},
        {OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_INIT, (void (*)(void))xor_sig_digest_verify_init},
        {OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_UPDATE, (void (*)(void))xor_sig_digest_signverify_update},
        {OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_FINAL, (void (*)(void))xor_sig_digest_verify_final},
        ...
        {OSSL_FUNC_SIGNATURE_GETTABLE_CTX_PARAMS, (void (*)(void))xor_sig_gettable_ctx_params},
        ...
        {OSSL_FUNC_SIGNATURE_GET_CTX_MD_PARAMS, (void (*)(void))xor_sig_get_ctx_md_params},
        {OSSL_FUNC_SIGNATURE_GETTABLE_CTX_MD_PARAMS, (void (*)(void))xor_sig_gettable_ctx_md_params},
        {OSSL_FUNC_SIGNATURE_SET_CTX_MD_PARAMS, (void (*)(void))xor_sig_set_ctx_md_params},
        {OSSL_FUNC_SIGNATURE_SETTABLE_CTX_MD_PARAMS, (void (*)(void))xor_sig_settable_ctx_md_params},
        OSSL_DISPATCH_END};
    ...
    static const OSSL_ALGORITHM *tls_prov_query(void *provctx, int operation_id, int *no_cache)
    {
        *no_cache = 0;
        switch (operation_id) {
