...
static int prompt_info(X509_REQ             *req,
                       ...
                       const char           *attr_sect,
                       int                   attribs,
                       unsigned long         chtype);
static int
auto_info(X509_REQ *req, STACK_OF(CONF_VALUE) *sk, STACK_OF(CONF_VALUE) *attr, int attribs, unsigned long chtype);
...
static int           add_DN_object(X509_NAME    *n,
                                   ...
                                   unsigned long chtype,
                                   int           mval);
static int           build_data(char       *text,
                                const char *def,
                                char       *value,
                                int         n_min,
                                int         n_max,
...
static int
auto_info(X509_REQ *req, STACK_OF(CONF_VALUE) *dn_sk, STACK_OF(CONF_VALUE) *attr_sk, int attribs, unsigned long chtype)
{
