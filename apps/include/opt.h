...
#define OPT_V_ENUM                                                             \
  ...
  OPT_V_CHECK_SS_SIG, OPT_V_TRUSTED_FIRST, OPT_V_SUITEB_128_ONLY,              \
  OPT_V_SUITEB_128, OPT_V_SUITEB_192, OPT_V_PARTIAL_CHAIN,                     \
 ...
 */
#define OPT_X_ENUM                                                             \
  OPT_X__FIRST = 1000, OPT_X_KEY, OPT_X_CERT, OPT_X_CHAIN, OPT_X_CHAIN_BUILD,  \
...
#define OPT_S_ENUM                                                             \
  ...
  OPT_S_PREFER_NO_DHE_KEX, OPT_S_PRIORITIZE_CHACHA, OPT_S_STRICT,              \
  OPT_S_SIGALGS, OPT_S_CLIENTSIGALGS, OPT_S_GROUPS, OPT_S_CURVES,              \
  OPT_S_NAMEDCURVE, OPT_S_CIPHER, OPT_S_CIPHERSUITES, OPT_S_RECORD_PADDING,    \
  OPT_S_DEBUGBROKE, OPT_S_COMP, OPT_S_MINPROTO, OPT_S_MAXPROTO,                \
  OPT_S_NO_RENEGOTIATION, OPT_S_NO_MIDDLEBOX, OPT_S_NO_ETM, OPT_S_NO_EMS,      \
  OPT_S_NO_TX_CERT_COMP, OPT_S_NO_RX_CERT_COMP, OPT_S__LAST
...
#define OPT_S_OPTIONS                                                          \
  ...
  {"prefer_no_dhe_kex", OPT_S_PREFER_NO_DHE_KEX, '-',                          \
   "In TLSv1.3 prefer non-(ec)dhe over (ec)dhe-based key exchange on "         \
   "resumption"},                                                              \
...
#define OPT_FMT_ANY                                                            \
  (OPT_FMT_PEM | OPT_FMT_DER | OPT_FMT_B64 | OPT_FMT_PKCS12 | OPT_FMT_SMIME |  \
   OPT_FMT_ENGINE | OPT_FMT_MSBLOB | OPT_FMT_NSS | OPT_FMT_TEXT |              \
