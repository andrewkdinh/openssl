        ...
        __struct {
            ...
            __union {
                __struct { /* 16-bit byte count variant        */
                    ...
                    __union {
                        unsigned int
                        iosb$l_dev_depend; /* 32-bit device dependent info */
                ...
                __struct { /* 32-bit byte count variant        */
                    unsigned int
                    iosb$l_bcnt; /* 32-bit byte count (unaligned) */
                    unsigned short int
                    iosb$w_dev_depend_high; /* 16-bit device dependent info */
                }
                iosb$r_bcnt_32;
            }
            iosb$r_devdepend;
...
#define iosb$w_bcnt                                                            \
    iosb$r_io_get.iosb$r_io_64.iosb$r_devdepend.iosb$r_bcnt_16.iosb$w_bcnt
#define iosb$r_l                                                               \
    iosb$r_io_get.iosb$r_io_64.iosb$r_devdepend.iosb$r_bcnt_16.iosb$r_l
#define iosb$l_dev_depend iosb$r_l.iosb$l_dev_depend
#define iosb$l_pid iosb$r_l.iosb$l_pid
#define iosb$l_bcnt                                                            \
    iosb$r_io_get.iosb$r_io_64.iosb$r_devdepend.iosb$r_bcnt_32.iosb$l_bcnt
#define iosb$w_dev_depend_high                                                 \
    iosb$r_io_get.iosb$r_io_64.iosb$r_devdepend.iosb$r_bcnt_32                 \
    .iosb$w_dev_depend_high
#define iosb$l_getxxi_status                                                   \
    iosb$r_io_get.iosb$r_get_64.iosb$r_l_status.iosb$l_getxxi_status
#define iosb$l_reg_status                                                      \
    iosb$r_io_get.iosb$r_get_64.iosb$r_l_status.iosb$l_reg_status
...
int TerminalSocket(int FunctionCode, int *ReturnSocket) {
    ...
    */
    ...
    case TERM_SOCK_CREATE:
        ...
        */
        status =
        sys$qio(EFN$C_ENF, TerminalDeviceChan, IO$_READVBLK,
                &TerminalDeviceIosb, TerminalDeviceAst, 0, TerminalDeviceBuff,
...
/*                                                                            */
/*----------------------------------------------------------------------------*/
static int CreateSocketPair(int SocketFamily, int SocketType,
                            int SocketProtocol, int *SocketPair) {
    ...
    */
    BIO_snprintf(AscTimeBuff, sizeof(AscTimeBuff), "0 0:0:%02d.00",
                 SOCKET_PAIR_TIMEOUT_VALUE);
    ...
    */
    status = sys$qio(EFN$C_ENF, TcpAcceptChan, IO$_ACCESS | IO$M_ACCEPT, &iosb,
                     0, 0, 0, 0, 0, &TcpDeviceChan, 0, 0);
    if (!(status & 1)) {
...
static int TerminalDeviceAst(int astparm) {
    ...
    */
    status =
    sys$qio(EFN$C_ENF, TerminalDeviceChan, IO$_READVBLK, &TerminalDeviceIosb,
            TerminalDeviceAst, 0, TerminalDeviceBuff,
            sizeof(TerminalDeviceBuff) - 1, 0, 0, 0, 0);
...
static void LogMessage(char *msg, ...) {
    ...
    */
    BIO_snprintf(MsgBuff, sizeof(MsgBuff),
                 "%02d-%s-%04d %02d:%02d:%02d [%08X] %s\n", LocTime->tm_mday,
                 Month[LocTime->tm_mon], (LocTime->tm_year + 1900),
