                   ...
                   void                 *arg)
{
    ...
    if (SSL_select_next_proto((unsigned char **)out, outlen, alpn_ctx->data, (unsigned int)alpn_ctx->len, in, inlen)
...
static long int
count_reads_callback(BIO *bio, int cmd, const char *argp, size_t len, int argi, long argl, int ret, size_t *processed)
{
...
# endif
    ...
    if (context != NULL && !SSL_set_session_id_context(con, context, (unsigned int)strlen((char *)context))) {
        BIO_printf(bio_err, "Error setting session id context\n");
        ret = -1;
        goto err;
    }
...
# endif
    ...
    if (keymatexportlabel != NULL) {
        ...
        if (SSL_export_keying_material(con,
                                       exportedkeymat,
                                       keymatexportlen,
                                       keymatexportlabel,
