...
#define DER_AID_V_sha1Identifier                                               \
  DER_P_SEQUENCE | DER_F_CONSTRUCTED, DER_OID_SZ_id_sha1 + DER_SZ_NULL,        \
  DER_OID_V_id_sha1, DER_V_NULL
...
#define DER_AID_V_sha224Identifier                                             \
  DER_P_SEQUENCE | DER_F_CONSTRUCTED, DER_OID_SZ_id_sha224 + DER_SZ_NULL,      \
  DER_OID_V_id_sha224, DER_V_NULL
...
#define DER_AID_V_sha256Identifier                                             \
  DER_P_SEQUENCE | DER_F_CONSTRUCTED, DER_OID_SZ_id_sha256 + DER_SZ_NULL,      \
  DER_OID_V_id_sha256, DER_V_NULL
...
#define DER_AID_V_sha384Identifier                                             \
  DER_P_SEQUENCE | DER_F_CONSTRUCTED, DER_OID_SZ_id_sha384 + DER_SZ_NULL,      \
  DER_OID_V_id_sha384, DER_V_NULL
...
#define DER_AID_V_sha512Identifier                                             \
  DER_P_SEQUENCE | DER_F_CONSTRUCTED, DER_OID_SZ_id_sha512 + DER_SZ_NULL,      \
  DER_OID_V_id_sha512, DER_V_NULL
...
#define DER_AID_V_sha512_224Identifier                                         \
  DER_P_SEQUENCE | DER_F_CONSTRUCTED, DER_OID_SZ_id_sha512_224 + DER_SZ_NULL,  \
  DER_OID_V_id_sha512_224, DER_V_NULL
...
#define DER_AID_SZ_sha512_224Identifier                                        \
  sizeof(ossl_der_aid_sha512_224Identifier)

#define DER_AID_V_sha512_256Identifier                                         \
  DER_P_SEQUENCE | DER_F_CONSTRUCTED, DER_OID_SZ_id_sha512_256 + DER_SZ_NULL,  \
  DER_OID_V_id_sha512_256, DER_V_NULL
...
#define DER_AID_SZ_sha512_256Identifier                                        \
  sizeof(ossl_der_aid_sha512_256Identifier)
...
#define DER_AID_V_mgf1SHA224Identifier                                         \
  DER_P_SEQUENCE | DER_F_CONSTRUCTED,                                          \
  DER_OID_SZ_id_mgf1 + DER_AID_SZ_sha224Identifier, DER_OID_V_id_mgf1,         \
  DER_AID_V_sha224Identifier
...
#define DER_AID_V_mgf1SHA256Identifier                                         \
  DER_P_SEQUENCE | DER_F_CONSTRUCTED,                                          \
  DER_OID_SZ_id_mgf1 + DER_AID_SZ_sha256Identifier, DER_OID_V_id_mgf1,         \
  DER_AID_V_sha256Identifier
...
#define DER_AID_V_mgf1SHA512Identifier                                         \
  DER_P_SEQUENCE | DER_F_CONSTRUCTED,                                          \
  DER_OID_SZ_id_mgf1 + DER_AID_SZ_sha512Identifier, DER_OID_V_id_mgf1,         \
  DER_AID_V_sha512Identifier
...
#define DER_AID_V_mgf1SHA512_224Identifier                                     \
  DER_P_SEQUENCE | DER_F_CONSTRUCTED,                                          \
  DER_OID_SZ_id_mgf1 + DER_AID_SZ_sha512_224Identifier, DER_OID_V_id_mgf1,     \
  DER_AID_V_sha512_224Identifier
static const unsigned char der_aid_mgf1SHA512_224Identifier[] = {
DER_AID_V_mgf1SHA512_224Identifier};
#define DER_AID_SZ_mgf1SHA512_224Identifier                                    \
  sizeof(der_aid_mgf1SHA512_224Identifier)

#define DER_AID_V_mgf1SHA512_256Identifier                                     \
  DER_P_SEQUENCE | DER_F_CONSTRUCTED,                                          \
  DER_OID_SZ_id_mgf1 + DER_AID_SZ_sha512_256Identifier, DER_OID_V_id_mgf1,     \
  DER_AID_V_sha512_256Identifier
static const unsigned char der_aid_mgf1SHA512_256Identifier[] = {
DER_AID_V_mgf1SHA512_256Identifier};
#define DER_AID_SZ_mgf1SHA512_256Identifier                                    \
  sizeof(der_aid_mgf1SHA512_256Identifier)
...
int ossl_DER_w_RSASSA_PSS_params(WPACKET *pkt, int tag,
  ...
  return ossl_DER_w_begin_sequence(pkt, tag) &&
         ...
         (saltlen == default_saltlen ||
          ossl_DER_w_uint32(pkt, 2, (uint32_t)saltlen)) &&
...
int ossl_DER_w_algorithmIdentifier_RSA_PSS(WPACKET *pkt, int tag, int rsa_type,
                                           const RSA_PSS_PARAMS_30 *pss) {
