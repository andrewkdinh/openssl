...
static const OSSL_ALGORITHM_CAPABLE fips_ciphers[] = {
    ...
    ALGC(PROV_NAMES_AES_192_CBC_HMAC_SHA512_ETM,
         ...
         ossl_cipher_capable_aes_cbc_hmac_sha512_etm),
    ALGC(PROV_NAMES_AES_256_CBC_HMAC_SHA512_ETM,
...
# endif
    ...
    {PROV_NAMES_SLH_DSA_SHA2_128S,
                          FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_128s_signature_functions,
                          PROV_DESCS_SLH_DSA_SHA2_128S},
    {PROV_NAMES_SLH_DSA_SHA2_128F,
                          FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_128f_signature_functions,
                          PROV_DESCS_SLH_DSA_SHA2_128F},
    {PROV_NAMES_SLH_DSA_SHA2_192S,
                          FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_192s_signature_functions,
                          PROV_DESCS_SLH_DSA_SHA2_192S},
    {PROV_NAMES_SLH_DSA_SHA2_192F,
                          FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_192f_signature_functions,
                          PROV_DESCS_SLH_DSA_SHA2_192F},
    {PROV_NAMES_SLH_DSA_SHA2_256S,
                          FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_256s_signature_functions,
                          PROV_DESCS_SLH_DSA_SHA2_256S},
    {PROV_NAMES_SLH_DSA_SHA2_256F,
                          FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_256f_signature_functions,
                          PROV_DESCS_SLH_DSA_SHA2_256F},
    {PROV_NAMES_SLH_DSA_SHAKE_128S,
                          FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_128s_signature_functions,
                          PROV_DESCS_SLH_DSA_SHAKE_128S},
    {PROV_NAMES_SLH_DSA_SHAKE_128F,
                          FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_128f_signature_functions,
                          PROV_DESCS_SLH_DSA_SHAKE_128F},
    {PROV_NAMES_SLH_DSA_SHAKE_192S,
                          FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_192s_signature_functions,
                          PROV_DESCS_SLH_DSA_SHAKE_192S},
    {PROV_NAMES_SLH_DSA_SHAKE_192F,
                          FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_192f_signature_functions,
                          PROV_DESCS_SLH_DSA_SHAKE_192F},
    {PROV_NAMES_SLH_DSA_SHAKE_256S,
                          FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_256s_signature_functions,
                          PROV_DESCS_SLH_DSA_SHAKE_256S},
    {PROV_NAMES_SLH_DSA_SHAKE_256F,
                          FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_256f_signature_functions,
...
# if !defined(OPENSSL_NO_EC)
    {PROV_NAMES_SecP256r1MLKEM768,
                         FIPS_DEFAULT_PROPERTIES, ossl_mlx_p256_kem_kmgmt_functions,
                         PROV_DESCS_SecP256r1MLKEM768},
    {PROV_NAMES_SecP384r1MLKEM1024,
                         FIPS_DEFAULT_PROPERTIES, ossl_mlx_p384_kem_kmgmt_functions,
                         PROV_DESCS_SecP384r1MLKEM1024},
# endif
#endif
#ifndef OPENSSL_NO_SLH_DSA
    {PROV_NAMES_SLH_DSA_SHA2_128S,
                         FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_128s_keymgmt_functions,
                         PROV_DESCS_SLH_DSA_SHA2_128S},
    {PROV_NAMES_SLH_DSA_SHA2_128F,
                         FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_128f_keymgmt_functions,
                         PROV_DESCS_SLH_DSA_SHA2_128F},
    {PROV_NAMES_SLH_DSA_SHA2_192S,
                         FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_192s_keymgmt_functions,
                         PROV_DESCS_SLH_DSA_SHA2_192S},
    {PROV_NAMES_SLH_DSA_SHA2_192F,
                         FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_192f_keymgmt_functions,
                         PROV_DESCS_SLH_DSA_SHA2_192F},
    {PROV_NAMES_SLH_DSA_SHA2_256S,
                         FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_256s_keymgmt_functions,
                         PROV_DESCS_SLH_DSA_SHA2_256S},
    {PROV_NAMES_SLH_DSA_SHA2_256F,
                         FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_256f_keymgmt_functions,
                         PROV_DESCS_SLH_DSA_SHA2_256F},
    {PROV_NAMES_SLH_DSA_SHAKE_128S,
                         FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_128s_keymgmt_functions,
                         PROV_DESCS_SLH_DSA_SHAKE_128S},
    {PROV_NAMES_SLH_DSA_SHAKE_128F,
                         FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_128f_keymgmt_functions,
                         PROV_DESCS_SLH_DSA_SHAKE_128F},
    {PROV_NAMES_SLH_DSA_SHAKE_192S,
                         FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_192s_keymgmt_functions,
                         PROV_DESCS_SLH_DSA_SHAKE_192S},
    {PROV_NAMES_SLH_DSA_SHAKE_192F,
                         FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_192f_keymgmt_functions,
                         PROV_DESCS_SLH_DSA_SHAKE_192F},
    {PROV_NAMES_SLH_DSA_SHAKE_256S,
                         FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_256s_keymgmt_functions,
                         PROV_DESCS_SLH_DSA_SHAKE_256S},
    {PROV_NAMES_SLH_DSA_SHAKE_256F,
                         FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_256f_keymgmt_functions,
                         PROV_DESCS_SLH_DSA_SHAKE_256F},
#endif  /* OPENSSL_NO_SLH_DSA */
    {NULL, NULL, NULL}
};
