...
static int fips_random_bytes(ossl_unused void *vprov, int which, void *buf,
...
{
    OSSL_PARAM *p;
    FIPS_GLOBAL *fgbl = ossl_lib_ctx_get_data(
        ossl_prov_ctx_get0_libctx(provctx), OSSL_LIB_CTX_FIPS_PROV_INDEX);
...
static const OSSL_ALGORITHM fips_macs_internal[] = {
    ...
    {PROV_NAMES_KMAC_128, FIPS_DEFAULT_PROPERTIES,
     ossl_kmac128_internal_functions},
    {PROV_NAMES_KMAC_256, FIPS_DEFAULT_PROPERTIES,
...
static const OSSL_ALGORITHM fips_rands[] = {
    {PROV_NAMES_CRNG_TEST, FIPS_UNAPPROVED_PROPERTIES,
    ...
    {PROV_NAMES_HMAC_DRBG, FIPS_DEFAULT_PROPERTIES,
...
# ifndef OPENSSL_NO_ECX
    {PROV_NAMES_X25519, FIPS_UNAPPROVED_PROPERTIES,
...
static const OSSL_ALGORITHM fips_signature[] = {
    ...
    {PROV_NAMES_DSA_SHA1, FIPS_DEFAULT_PROPERTIES,
     ossl_dsa_sha1_signature_functions},
    {PROV_NAMES_DSA_SHA224, FIPS_DEFAULT_PROPERTIES,
     ossl_dsa_sha224_signature_functions},
    {PROV_NAMES_DSA_SHA256, FIPS_DEFAULT_PROPERTIES,
     ossl_dsa_sha256_signature_functions},
    {PROV_NAMES_DSA_SHA384, FIPS_DEFAULT_PROPERTIES,
     ossl_dsa_sha384_signature_functions},
    {PROV_NAMES_DSA_SHA512, FIPS_DEFAULT_PROPERTIES,
     ossl_dsa_sha512_signature_functions},
    {PROV_NAMES_DSA_SHA3_224, FIPS_DEFAULT_PROPERTIES,
     ossl_dsa_sha3_224_signature_functions},
    {PROV_NAMES_DSA_SHA3_256, FIPS_DEFAULT_PROPERTIES,
     ossl_dsa_sha3_256_signature_functions},
    {PROV_NAMES_DSA_SHA3_384, FIPS_DEFAULT_PROPERTIES,
     ossl_dsa_sha3_384_signature_functions},
    {PROV_NAMES_DSA_SHA3_512, FIPS_DEFAULT_PROPERTIES,
...
# endif
    ...
    {PROV_NAMES_ECDSA_SHA1, FIPS_DEFAULT_PROPERTIES,
     ossl_ecdsa_sha1_signature_functions},
    {PROV_NAMES_ECDSA_SHA224, FIPS_DEFAULT_PROPERTIES,
     ossl_ecdsa_sha224_signature_functions},
    {PROV_NAMES_ECDSA_SHA256, FIPS_DEFAULT_PROPERTIES,
     ossl_ecdsa_sha256_signature_functions},
    {PROV_NAMES_ECDSA_SHA384, FIPS_DEFAULT_PROPERTIES,
     ossl_ecdsa_sha384_signature_functions},
    {PROV_NAMES_ECDSA_SHA512, FIPS_DEFAULT_PROPERTIES,
     ossl_ecdsa_sha512_signature_functions},
    {PROV_NAMES_ECDSA_SHA3_224, FIPS_DEFAULT_PROPERTIES,
     ossl_ecdsa_sha3_224_signature_functions},
    {PROV_NAMES_ECDSA_SHA3_256, FIPS_DEFAULT_PROPERTIES,
     ossl_ecdsa_sha3_256_signature_functions},
    {PROV_NAMES_ECDSA_SHA3_384, FIPS_DEFAULT_PROPERTIES,
     ossl_ecdsa_sha3_384_signature_functions},
    {PROV_NAMES_ECDSA_SHA3_512, FIPS_DEFAULT_PROPERTIES,
     ossl_ecdsa_sha3_512_signature_functions},
#endif
#ifndef OPENSSL_NO_ML_DSA
    {PROV_NAMES_ML_DSA_44, FIPS_DEFAULT_PROPERTIES,
     ossl_ml_dsa_44_signature_functions},
    {PROV_NAMES_ML_DSA_65, FIPS_DEFAULT_PROPERTIES,
     ossl_ml_dsa_65_signature_functions},
    {PROV_NAMES_ML_DSA_87, FIPS_DEFAULT_PROPERTIES,
    ...
    {PROV_NAMES_SLH_DSA_SHAKE_128S, FIPS_DEFAULT_PROPERTIES,
     ossl_slh_dsa_shake_128s_signature_functions,
     PROV_DESCS_SLH_DSA_SHAKE_128S},
    {PROV_NAMES_SLH_DSA_SHAKE_128F, FIPS_DEFAULT_PROPERTIES,
     ossl_slh_dsa_shake_128f_signature_functions,
...
# if !defined(OPENSSL_NO_EC)
    {"SecP256r1MLKEM768", FIPS_DEFAULT_PROPERTIES,
     ossl_mlx_kem_asym_kem_functions},
...
static const OSSL_ALGORITHM fips_keymgmt[] = {
    ...
    {PROV_NAMES_RSA, FIPS_DEFAULT_PROPERTIES, ossl_rsa_keymgmt_functions,
     PROV_DESCS_RSA},
    {PROV_NAMES_RSA_PSS, FIPS_DEFAULT_PROPERTIES, ossl_rsapss_keymgmt_functions,
     PROV_DESCS_RSA_PSS},
#ifndef OPENSSL_NO_EC
...
# ifndef OPENSSL_NO_ECX
    {PROV_NAMES_X25519, FIPS_UNAPPROVED_PROPERTIES,
     ossl_x25519_keymgmt_functions, PROV_DESCS_X25519},
    {PROV_NAMES_X448, FIPS_UNAPPROVED_PROPERTIES, ossl_x448_keymgmt_functions,
     PROV_DESCS_X448},
    {PROV_NAMES_ED25519, FIPS_DEFAULT_PROPERTIES,
     ossl_ed25519_keymgmt_functions, PROV_DESCS_ED25519},
...
# endif
    ...
    {PROV_NAMES_ML_DSA_65, FIPS_DEFAULT_PROPERTIES,
     ossl_ml_dsa_65_keymgmt_functions, PROV_DESCS_ML_DSA_65},
    {PROV_NAMES_ML_DSA_87, FIPS_DEFAULT_PROPERTIES,
     ossl_ml_dsa_87_keymgmt_functions, PROV_DESCS_ML_DSA_87},
    ...
    {PROV_NAMES_HMAC, FIPS_DEFAULT_PROPERTIES,
     ossl_mac_legacy_keymgmt_functions, PROV_DESCS_HMAC_SIGN},
#ifndef OPENSSL_NO_CMAC
    {PROV_NAMES_CMAC, FIPS_DEFAULT_PROPERTIES,
...
# if !defined(OPENSSL_NO_ECX)
    {PROV_NAMES_X25519MLKEM768, FIPS_DEFAULT_PROPERTIES,
     ossl_mlx_x25519_kem_kmgmt_functions, PROV_DESCS_X25519MLKEM768},
    {PROV_NAMES_X448MLKEM1024, FIPS_DEFAULT_PROPERTIES,
     ossl_mlx_x448_kem_kmgmt_functions, PROV_DESCS_X448MLKEM1024},
# endif
# if !defined(OPENSSL_NO_EC)
    {PROV_NAMES_SecP256r1MLKEM768, FIPS_DEFAULT_PROPERTIES,
     ossl_mlx_p256_kem_kmgmt_functions, PROV_DESCS_SecP256r1MLKEM768},
    {PROV_NAMES_SecP384r1MLKEM1024, FIPS_DEFAULT_PROPERTIES,
     ossl_mlx_p384_kem_kmgmt_functions, PROV_DESCS_SecP384r1MLKEM1024},
# endif
#endif
#ifndef OPENSSL_NO_SLH_DSA
    {PROV_NAMES_SLH_DSA_SHA2_128S, FIPS_DEFAULT_PROPERTIES,
...
fips_query_internal(void *provctx, int operation_id, int *no_cache)
{
