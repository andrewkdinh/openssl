...
static int fips_random_bytes(ossl_unused void *vprov, int which, void *buf, size_t n, unsigned int strength)
{
    OSSL_LIB_CTX *libctx;
...
{
    OSSL_PARAM *p;
    FIPS_GLOBAL *fgbl = ossl_lib_ctx_get_data(ossl_prov_ctx_get0_libctx(provctx), OSSL_LIB_CTX_FIPS_PROV_INDEX);
...
static const OSSL_ALGORITHM fips_digests[] = {
    ...
    {PROV_NAMES_SHA2_512_224, FIPS_DEFAULT_PROPERTIES, ossl_sha512_224_functions},
    ...
    {PROV_NAMES_KECCAK_KMAC_256, FIPS_DEFAULT_PROPERTIES, ossl_keccak_kmac_256_functions},
    {NULL, NULL, NULL}};
...
static const OSSL_ALGORITHM fips_signature[] = {
    ...
    {PROV_NAMES_RSA_SHA1, FIPS_DEFAULT_PROPERTIES, ossl_rsa_sha1_signature_functions},
    {PROV_NAMES_RSA_SHA224, FIPS_DEFAULT_PROPERTIES, ossl_rsa_sha224_signature_functions},
    {PROV_NAMES_RSA_SHA256, FIPS_DEFAULT_PROPERTIES, ossl_rsa_sha256_signature_functions},
    {PROV_NAMES_RSA_SHA384, FIPS_DEFAULT_PROPERTIES, ossl_rsa_sha384_signature_functions},
    {PROV_NAMES_RSA_SHA512, FIPS_DEFAULT_PROPERTIES, ossl_rsa_sha512_signature_functions},
    {PROV_NAMES_RSA_SHA512_224, FIPS_DEFAULT_PROPERTIES, ossl_rsa_sha512_224_signature_functions},
    {PROV_NAMES_RSA_SHA512_256, FIPS_DEFAULT_PROPERTIES, ossl_rsa_sha512_256_signature_functions},
    {PROV_NAMES_RSA_SHA3_224, FIPS_DEFAULT_PROPERTIES, ossl_rsa_sha3_224_signature_functions},
    {PROV_NAMES_RSA_SHA3_256, FIPS_DEFAULT_PROPERTIES, ossl_rsa_sha3_256_signature_functions},
    {PROV_NAMES_RSA_SHA3_384, FIPS_DEFAULT_PROPERTIES, ossl_rsa_sha3_384_signature_functions},
    {PROV_NAMES_RSA_SHA3_512, FIPS_DEFAULT_PROPERTIES, ossl_rsa_sha3_512_signature_functions},
#ifndef OPENSSL_NO_EC
# ifndef OPENSSL_NO_ECX
    {PROV_NAMES_ED25519, FIPS_DEFAULT_PROPERTIES, ossl_ed25519_signature_functions},
    {PROV_NAMES_ED25519ph, FIPS_DEFAULT_PROPERTIES, ossl_ed25519ph_signature_functions},
    {PROV_NAMES_ED25519ctx, FIPS_DEFAULT_PROPERTIES, ossl_ed25519ctx_signature_functions},
    {PROV_NAMES_ED448, FIPS_DEFAULT_PROPERTIES, ossl_ed448_signature_functions},
    {PROV_NAMES_ED448ph, FIPS_DEFAULT_PROPERTIES, ossl_ed448ph_signature_functions},
# endif
    ...
    {PROV_NAMES_SLH_DSA_SHA2_128S, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_128s_signature_functions,
     PROV_DESCS_SLH_DSA_SHA2_128S},
    {PROV_NAMES_SLH_DSA_SHA2_128F, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_128f_signature_functions,
     PROV_DESCS_SLH_DSA_SHA2_128F},
    {PROV_NAMES_SLH_DSA_SHA2_192S, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_192s_signature_functions,
     PROV_DESCS_SLH_DSA_SHA2_192S},
    {PROV_NAMES_SLH_DSA_SHA2_192F, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_192f_signature_functions,
     PROV_DESCS_SLH_DSA_SHA2_192F},
    {PROV_NAMES_SLH_DSA_SHA2_256S, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_256s_signature_functions,
    ...
    {PROV_NAMES_SLH_DSA_SHAKE_128S, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_128s_signature_functions,
     PROV_DESCS_SLH_DSA_SHAKE_128S},
    {PROV_NAMES_SLH_DSA_SHAKE_128F, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_128f_signature_functions,
     PROV_DESCS_SLH_DSA_SHAKE_128F},
    {PROV_NAMES_SLH_DSA_SHAKE_192S, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_192s_signature_functions,
     PROV_DESCS_SLH_DSA_SHAKE_192S},
    {PROV_NAMES_SLH_DSA_SHAKE_192F, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_192f_signature_functions,
     PROV_DESCS_SLH_DSA_SHAKE_192F},
    {PROV_NAMES_SLH_DSA_SHAKE_256S, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_256s_signature_functions,
     PROV_DESCS_SLH_DSA_SHAKE_256S},
    {PROV_NAMES_SLH_DSA_SHAKE_256F, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_256f_signature_functions,
     PROV_DESCS_SLH_DSA_SHAKE_256F},
#endif /* OPENSSL_NO_SLH_DSA */
    {NULL, NULL, NULL}};

static const OSSL_ALGORITHM fips_asym_cipher[] = {
    {PROV_NAMES_RSA, FIPS_DEFAULT_PROPERTIES, ossl_rsa_asym_cipher_functions}, {NULL, NULL, NULL}};
...
# ifndef OPENSSL_NO_ECX
    {PROV_NAMES_X25519, FIPS_UNAPPROVED_PROPERTIES, ossl_x25519_keymgmt_functions, PROV_DESCS_X25519},
    {PROV_NAMES_X448, FIPS_UNAPPROVED_PROPERTIES, ossl_x448_keymgmt_functions, PROV_DESCS_X448},
...
#endif
#ifndef OPENSSL_NO_ML_DSA
    {PROV_NAMES_ML_DSA_44, FIPS_DEFAULT_PROPERTIES, ossl_ml_dsa_44_keymgmt_functions, PROV_DESCS_ML_DSA_44},
    {PROV_NAMES_ML_DSA_65, FIPS_DEFAULT_PROPERTIES, ossl_ml_dsa_65_keymgmt_functions, PROV_DESCS_ML_DSA_65},
    {PROV_NAMES_ML_DSA_87, FIPS_DEFAULT_PROPERTIES, ossl_ml_dsa_87_keymgmt_functions, PROV_DESCS_ML_DSA_87},
...
#endif
#ifndef OPENSSL_NO_ML_KEM
    {PROV_NAMES_ML_KEM_512, FIPS_DEFAULT_PROPERTIES, ossl_ml_kem_512_keymgmt_functions, PROV_DESCS_ML_KEM_512},
    {PROV_NAMES_ML_KEM_768, FIPS_DEFAULT_PROPERTIES, ossl_ml_kem_768_keymgmt_functions, PROV_DESCS_ML_KEM_768},
    {PROV_NAMES_ML_KEM_1024, FIPS_DEFAULT_PROPERTIES, ossl_ml_kem_1024_keymgmt_functions, PROV_DESCS_ML_KEM_1024},
# if !defined(OPENSSL_NO_ECX)
    {PROV_NAMES_X25519MLKEM768, FIPS_DEFAULT_PROPERTIES, ossl_mlx_x25519_kem_kmgmt_functions,
     PROV_DESCS_X25519MLKEM768},
    {PROV_NAMES_X448MLKEM1024, FIPS_DEFAULT_PROPERTIES, ossl_mlx_x448_kem_kmgmt_functions, PROV_DESCS_X448MLKEM1024},
# endif
# if !defined(OPENSSL_NO_EC)
...
#endif
#ifndef OPENSSL_NO_SLH_DSA
    {PROV_NAMES_SLH_DSA_SHA2_128S, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_128s_keymgmt_functions,
     PROV_DESCS_SLH_DSA_SHA2_128S},
    {PROV_NAMES_SLH_DSA_SHA2_128F, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_128f_keymgmt_functions,
     PROV_DESCS_SLH_DSA_SHA2_128F},
    {PROV_NAMES_SLH_DSA_SHA2_192S, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_192s_keymgmt_functions,
     PROV_DESCS_SLH_DSA_SHA2_192S},
    {PROV_NAMES_SLH_DSA_SHA2_192F, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_192f_keymgmt_functions,
     PROV_DESCS_SLH_DSA_SHA2_192F},
    {PROV_NAMES_SLH_DSA_SHA2_256S, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_256s_keymgmt_functions,
     PROV_DESCS_SLH_DSA_SHA2_256S},
    {PROV_NAMES_SLH_DSA_SHA2_256F, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_sha2_256f_keymgmt_functions,
     PROV_DESCS_SLH_DSA_SHA2_256F},
    {PROV_NAMES_SLH_DSA_SHAKE_128S, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_128s_keymgmt_functions,
     PROV_DESCS_SLH_DSA_SHAKE_128S},
    {PROV_NAMES_SLH_DSA_SHAKE_128F, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_128f_keymgmt_functions,
     PROV_DESCS_SLH_DSA_SHAKE_128F},
    {PROV_NAMES_SLH_DSA_SHAKE_192S, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_192s_keymgmt_functions,
     PROV_DESCS_SLH_DSA_SHAKE_192S},
    {PROV_NAMES_SLH_DSA_SHAKE_192F, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_192f_keymgmt_functions,
     PROV_DESCS_SLH_DSA_SHAKE_192F},
    {PROV_NAMES_SLH_DSA_SHAKE_256S, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_256s_keymgmt_functions,
     PROV_DESCS_SLH_DSA_SHAKE_256S},
    {PROV_NAMES_SLH_DSA_SHAKE_256F, FIPS_DEFAULT_PROPERTIES, ossl_slh_dsa_shake_256f_keymgmt_functions,
     PROV_DESCS_SLH_DSA_SHAKE_256F},
#endif /* OPENSSL_NO_SLH_DSA */
    {NULL, NULL, NULL}};
...
static const OSSL_ALGORITHM *fips_query_internal(void *provctx, int operation_id, int *no_cache)
{
...
#endif
int OSSL_provider_init_int(const OSSL_CORE_HANDLE *handle, const OSSL_DISPATCH *in, const OSSL_DISPATCH **out,
                           void **provctx)
{
    FIPS_GLOBAL *fgbl;
...
int ossl_fips_intern_provider_init(const OSSL_CORE_HANDLE *handle, const OSSL_DISPATCH *in, const OSSL_DISPATCH **out,
                                   void **provctx)
{
