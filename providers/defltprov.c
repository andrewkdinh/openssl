...
static const OSSL_ALGORITHM deflt_signature[] = {
    ...
    {PROV_NAMES_DSA_SHA1, "provider=default",
     ossl_dsa_sha1_signature_functions},
    {PROV_NAMES_DSA_SHA224, "provider=default",
     ossl_dsa_sha224_signature_functions},
    {PROV_NAMES_DSA_SHA256, "provider=default",
     ossl_dsa_sha256_signature_functions},
    {PROV_NAMES_DSA_SHA384, "provider=default",
     ossl_dsa_sha384_signature_functions},
    {PROV_NAMES_DSA_SHA512, "provider=default",
     ossl_dsa_sha512_signature_functions},
    {PROV_NAMES_DSA_SHA3_224, "provider=default",
     ossl_dsa_sha3_224_signature_functions},
    {PROV_NAMES_DSA_SHA3_256, "provider=default",
     ossl_dsa_sha3_256_signature_functions},
    {PROV_NAMES_DSA_SHA3_384, "provider=default",
     ossl_dsa_sha3_384_signature_functions},
    {PROV_NAMES_DSA_SHA3_512, "provider=default",
    ...
    {PROV_NAMES_RSA_RIPEMD160, "provider=default",
     ossl_rsa_ripemd160_signature_functions},
#endif
    {PROV_NAMES_RSA_SHA1, "provider=default",
     ossl_rsa_sha1_signature_functions},
    {PROV_NAMES_RSA_SHA224, "provider=default",
     ossl_rsa_sha224_signature_functions},
    {PROV_NAMES_RSA_SHA256, "provider=default",
     ossl_rsa_sha256_signature_functions},
    {PROV_NAMES_RSA_SHA384, "provider=default",
     ossl_rsa_sha384_signature_functions},
    {PROV_NAMES_RSA_SHA512, "provider=default",
     ossl_rsa_sha512_signature_functions},
    {PROV_NAMES_RSA_SHA512_224, "provider=default",
     ossl_rsa_sha512_224_signature_functions},
    {PROV_NAMES_RSA_SHA512_256, "provider=default",
     ossl_rsa_sha512_256_signature_functions},
    {PROV_NAMES_RSA_SHA3_224, "provider=default",
     ossl_rsa_sha3_224_signature_functions},
    {PROV_NAMES_RSA_SHA3_256, "provider=default",
     ossl_rsa_sha3_256_signature_functions},
    {PROV_NAMES_RSA_SHA3_384, "provider=default",
     ossl_rsa_sha3_384_signature_functions},
    {PROV_NAMES_RSA_SHA3_512, "provider=default",
...
# ifndef OPENSSL_NO_ECX
    ...
    {PROV_NAMES_ED25519ph, "provider=default",
     ossl_ed25519ph_signature_functions},
    {PROV_NAMES_ED25519ctx, "provider=default",
...
# endif
    ...
    {PROV_NAMES_ECDSA_SHA1, "provider=default",
     ossl_ecdsa_sha1_signature_functions},
    {PROV_NAMES_ECDSA_SHA224, "provider=default",
     ossl_ecdsa_sha224_signature_functions},
    {PROV_NAMES_ECDSA_SHA256, "provider=default",
     ossl_ecdsa_sha256_signature_functions},
    {PROV_NAMES_ECDSA_SHA384, "provider=default",
     ossl_ecdsa_sha384_signature_functions},
    {PROV_NAMES_ECDSA_SHA512, "provider=default",
     ossl_ecdsa_sha512_signature_functions},
    {PROV_NAMES_ECDSA_SHA3_224, "provider=default",
     ossl_ecdsa_sha3_224_signature_functions},
    {PROV_NAMES_ECDSA_SHA3_256, "provider=default",
     ossl_ecdsa_sha3_256_signature_functions},
    {PROV_NAMES_ECDSA_SHA3_384, "provider=default",
     ossl_ecdsa_sha3_384_signature_functions},
    {PROV_NAMES_ECDSA_SHA3_512, "provider=default",
...
# endif
    ...
    {PROV_NAMES_ML_DSA_44, "provider=default",
     ossl_ml_dsa_44_signature_functions},
    {PROV_NAMES_ML_DSA_65, "provider=default",
     ossl_ml_dsa_65_signature_functions},
    {PROV_NAMES_ML_DSA_87, "provider=default",
...
# endif
    ...
    {PROV_NAMES_ML_KEM_1024, "provider=default",
...
#endif
#ifndef OPENSSL_NO_ML_KEM
    {PROV_NAMES_ML_KEM_512, "provider=default",
     ossl_ml_kem_512_keymgmt_functions, PROV_DESCS_ML_KEM_512},
    {PROV_NAMES_ML_KEM_768, "provider=default",
...
# if !defined(OPENSSL_NO_ECX)
    ...
    {PROV_NAMES_X448MLKEM1024, "provider=default",
     ossl_mlx_x448_kem_kmgmt_functions, PROV_DESCS_X448MLKEM1024},
# endif
# if !defined(OPENSSL_NO_EC)
    {PROV_NAMES_SecP256r1MLKEM768, "provider=default",
     ossl_mlx_p256_kem_kmgmt_functions, PROV_DESCS_SecP256r1MLKEM768},
    {PROV_NAMES_SecP384r1MLKEM1024, "provider=default",
