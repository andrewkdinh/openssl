...
static int pvk_set_membuf(unsigned char **buffer, size_t *buflen, const OSSL_PARAM *p)
{
...
static int kdf_pvk_derive(void *vctx, unsigned char *key, size_t keylen, const OSSL_PARAM params[])
{
    KDF_PVK      *ctx = (KDF_PVK *)vctx;
    const EVP_MD *md;
    EVP_MD_CTX   *mctx;
    ...
    mctx = EVP_MD_CTX_new();
    res  = mctx != NULL && EVP_DigestInit_ex(mctx, md, NULL) && EVP_DigestUpdate(mctx, ctx->salt, ctx->salt_len)
          && EVP_DigestUpdate(mctx, ctx->pass, ctx->pass_len) && EVP_DigestFinal_ex(mctx, key, NULL);
...
static const OSSL_PARAM *kdf_pvk_settable_ctx_params(ossl_unused void *ctx, ossl_unused void *p_ctx)
{
...
static const OSSL_PARAM *kdf_pvk_gettable_ctx_params(ossl_unused void *ctx, ossl_unused void *p_ctx)
{
...
const OSSL_DISPATCH ossl_kdf_pvk_functions[] = {
    ...
    {OSSL_FUNC_KDF_SETTABLE_CTX_PARAMS, (void (*)(void))kdf_pvk_settable_ctx_params},
    {OSSL_FUNC_KDF_SET_CTX_PARAMS,      (void (*)(void))kdf_pvk_set_ctx_params     },
    {OSSL_FUNC_KDF_GETTABLE_CTX_PARAMS, (void (*)(void))kdf_pvk_gettable_ctx_params},
