...
static int any2obj_decode_final(void          *vctx,
                                int            objtype,
...
static int                         der2obj_decode(void                     *vctx,
                                                  OSSL_CORE_BIO            *cin,
                                                  int                       selection,
                                                  OSSL_CALLBACK            *data_cb,
                                                  void                     *data_cbarg,
...
static int                         msblob2obj_decode(void                     *vctx,
                                                     OSSL_CORE_BIO            *cin,
                                                     int                       selection,
                                                     OSSL_CALLBACK            *data_cb,
                                                     void                     *data_cbarg,
...
static int                         pvk2obj_decode(void                     *vctx,
                                                  OSSL_CORE_BIO            *cin,
                                                  int                       selection,
                                                  OSSL_CALLBACK            *data_cb,
                                                  void                     *data_cbarg,
...
next:
    ...
    /* any2obj_decode_final() frees |mem| for us */
    return any2obj_decode_final(ctx,
                                OSSL_OBJECT_PKEY,
                                "pvk",
                                ok ? (isdss ? "DSA" : "RSA") : NULL,
                                mem,
                                data_cb,
                                data_cbarg);
