...
slh_dsa_settable_ctx_params(void *vctx, ossl_unused void *provctx) {
...
static const OSSL_PARAM *
slh_dsa_gettable_ctx_params(ossl_unused void *vctx, ossl_unused void *provctx) {
...
#define MAKE_SIGNATURE_FUNCTIONS(alg, fn)                                      \
  ...
  {OSSL_FUNC_SIGNATURE_DIGEST_SIGN, (void (*)(void))slh_dsa_digest_sign},      \
  {OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_INIT,                                     \
   (void (*)(void))slh_dsa_digest_signverify_init},                            \
  {OSSL_FUNC_SIGNATURE_DIGEST_VERIFY, (void (*)(void))slh_dsa_digest_verify},  \
  {OSSL_FUNC_SIGNATURE_FREECTX, (void (*)(void))slh_dsa_freectx},              \
  {OSSL_FUNC_SIGNATURE_DUPCTX, (void (*)(void))slh_dsa_dupctx},                \
  {OSSL_FUNC_SIGNATURE_SET_CTX_PARAMS,                                         \
   (void (*)(void))slh_dsa_set_ctx_params},                                    \
