...
static int dsa_sign_check_approved(PROV_DSA_CTX *ctx, int signing, const char *desc)
{
    ...
    if (signing
        && !OSSL_FIPS_IND_ON_UNAPPROVED(ctx,
...
static int dsa_signverify_init(void                                  *vpdsactx,
                               void                                  *vdsa,
 ...
 */
static int
dsa_sign(void *vpdsactx, unsigned char *sig, size_t *siglen, size_t sigsize, const unsigned char *tbs, size_t tbslen)
{
    PROV_DSA_CTX *pdsactx = (PROV_DSA_CTX *)vpdsactx;
...
static int
dsa_verify_directly(void *vpdsactx, const unsigned char *sig, size_t siglen, const unsigned char *tbs, size_t tbslen)
{
    PROV_DSA_CTX *pdsactx = (PROV_DSA_CTX *)vpdsactx;
    size_t        mdsize  = dsa_get_md_size(pdsactx);
...
static int dsa_digest_signverify_init(void            *vpdsactx,
                                      const char      *mdname,
                                      void            *vdsa,
                                      const OSSL_PARAM params[],
                                      int              operation,
 ...
 */
static int                                        dsa_sigalg_signverify_init(void                                  *vpdsactx,
                                                                             void                                  *vdsa,
                                                                             OSSL_FUNC_signature_set_ctx_params_fn *set_ctx_params,
                                                                             const OSSL_PARAM                       params[],
                                                                             const char                            *mdname,
