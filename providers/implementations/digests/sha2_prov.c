...
static int sha1_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (p != NULL && p->data_type == OSSL_PARAM_OCTET_STRING)
        return ossl_sha1_ctrl(ctx, EVP_CTRL_SSL3_MASTER_SECRET, (int)p->data_size, p->data);
    return 1;
}

/* ossl_sha1_functions */
IMPLEMENT_digest_functions_with_settable_ctx(sha1,
                                             SHA_CTX,
                                             SHA_CBLOCK,
                                             SHA_DIGEST_LENGTH,
                                             SHA2_FLAGS,
    ...
    IMPLEMENT_digest_functions(sha224,
                               SHA256_CTX,
                               SHA256_CBLOCK,
    ...
    IMPLEMENT_digest_functions(sha256,
                               SHA256_CTX,
                               SHA256_CBLOCK,
    ...
    IMPLEMENT_digest_functions(sha256_192,
                               SHA256_CTX,
                               SHA256_CBLOCK,
    ...
    IMPLEMENT_digest_functions(sha384,
                               SHA512_CTX,
                               SHA512_CBLOCK,
    ...
    IMPLEMENT_digest_functions(sha512_224,
                               SHA512_CTX,
                               SHA512_CBLOCK,
                               SHA224_DIGEST_LENGTH,
                               SHA2_FLAGS,
    ...
    IMPLEMENT_digest_functions(sha512_256,
                               SHA512_CTX,
                               SHA512_CBLOCK,
                               SHA256_DIGEST_LENGTH,
                               SHA2_FLAGS,
