...
#define PROV_NAMES_AES_256_WRAP_PAD                                            \
  "AES-256-WRAP-PAD:id-aes256-wrap-pad:AES256-WRAP-PAD:2.16.840.1.101.3.4.1."  \
  "48"
#define PROV_NAMES_AES_192_WRAP_PAD                                            \
  "AES-192-WRAP-PAD:id-aes192-wrap-pad:AES192-WRAP-PAD:2.16.840.1.101.3.4.1."  \
  "28"
...
#define PROV_NAMES_ECDSA_SHA3_384                                              \
  "ECDSA-SHA3-384:ecdsa_with_SHA3-384:id-ecdsa-with-sha3-384:2.16.840.1.101."  \
  "3.4.3.11"
#define PROV_NAMES_ECDSA_SHA3_512                                              \
  "ECDSA-SHA3-512:ecdsa_with_SHA3-512:id-ecdsa-with-sha3-512:2.16.840.1.101."  \
  "3.4.3.12"
...
#define PROV_NAMES_DSA_SHA384                                                  \
  "DSA-SHA2-384:DSA-SHA384:dsa_with_SHA384:id-dsa-with-sha384:1.2.840.1.101."  \
  "3.4.3.3"
