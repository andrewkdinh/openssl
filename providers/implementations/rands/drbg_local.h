...
#define DRBG_DEFAULT_PERS_STRING                                               \
  "\x4f\x70\x65\x6e\x53\x53\x4c\x20\x4e\x49\x53\x54\x20\x53\x50\x20\x38\x30"   \
  "\x30\x2d\x39\x30\x41\x20\x44\x52\x42\x47"
...
size_t ossl_crngt_get_entropy(PROV_DRBG *drbg, unsigned char **pout,
                              int entropy, size_t min_len, size_t max_len,
                              int prediction_resistance);
void ossl_crngt_cleanup_entropy(PROV_DRBG *drbg, unsigned char *out,
                                size_t outlen);
