...
static int test_rng_instantiate(void *vtest, unsigned int strength, int prediction_resistance,
...
static int test_rng_generate(void *vtest, unsigned char *out, size_t outlen, unsigned int strength,
...
static int test_rng_reseed(ossl_unused void *vtest, ossl_unused int prediction_resistance,
...
static size_t test_rng_nonce(void *vtest, unsigned char *out, unsigned int strength, size_t min_noncelen,
                             size_t max_noncelen)
{
    PROV_TEST_RNG *t = (PROV_TEST_RNG *)vtest;
    size_t i;
...
static const OSSL_PARAM *test_rng_gettable_ctx_params(ossl_unused void *vtest, ossl_unused void *provctx)
{
    static const OSSL_PARAM known_gettable_ctx_params[] = {
        ...
        OSSL_PARAM_size_t(OSSL_RAND_PARAM_MAX_REQUEST, NULL), OSSL_PARAM_uint(OSSL_RAND_PARAM_GENERATE, NULL),
...
static size_t test_rng_get_seed(void *vtest, unsigned char **pout, int entropy, size_t min_len, size_t max_len,
...
const OSSL_DISPATCH ossl_test_rng_functions[] = {
    ...
    {OSSL_FUNC_RAND_INSTANTIATE, (void (*)(void))test_rng_instantiate},
    ...
    {OSSL_FUNC_RAND_SETTABLE_CTX_PARAMS, (void (*)(void))test_rng_settable_ctx_params},
    ...
    {OSSL_FUNC_RAND_VERIFY_ZEROIZATION, (void (*)(void))test_rng_verify_zeroization},
