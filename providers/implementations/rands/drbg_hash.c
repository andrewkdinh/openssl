 ...
 */
static int hash_df(PROV_DRBG           *drbg,
                   unsigned char       *out,
...
static int
hash_df1(PROV_DRBG *drbg, unsigned char *out, const unsigned char in_byte, const unsigned char *in1, size_t in1len)
{
...
static int drbg_hash_instantiate_wrapper(void                *vdrbg,
 ...
 */
static int
drbg_hash_reseed(PROV_DRBG *drbg, const unsigned char *ent, size_t ent_len, const unsigned char *adin, size_t adin_len)
{
    PROV_DRBG_HASH *hash = (PROV_DRBG_HASH *)drbg->data;
...
static int drbg_hash_reseed_wrapper(void                *vdrbg,
                                    int                  prediction_resistance,
                                    const unsigned char *ent,
                                    size_t               ent_len,
 ...
 */
static int
drbg_hash_generate(PROV_DRBG *drbg, unsigned char *out, size_t outlen, const unsigned char *adin, size_t adin_len)
{
    PROV_DRBG_HASH *hash = (PROV_DRBG_HASH *)drbg->data;
...
static int drbg_hash_generate_wrapper(void                *vdrbg,
                                      unsigned char       *out,
                                      size_t               outlen,
                                      unsigned int         strength,
                                      int                  prediction_resistance,
...
{
    return ossl_rand_drbg_new(provctx,
                              parent,
                              parent_dispatch,
                              &drbg_hash_new,
                              &drbg_hash_free,
