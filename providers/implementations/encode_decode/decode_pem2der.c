...
static int
read_pem(PROV_CTX *provctx, OSSL_CORE_BIO *cin, char **pem_name, char **pem_header, unsigned char **data, long *len)
{
...
#define SPKI_LAST_IDX 2
    ...
    if (i < OSSL_NELEM(pem_name_map)) {
        ...
        if (i <= PKCS8_LAST_IDX
            ...
            ok = ossl_epki2pki_der_decode(der,
                                          der_len,
                                          selection,
                                          data_cb,
                                          data_cbarg,
        ...
        if (i <= SPKI_LAST_IDX
            ...
            ok = ossl_spki2typespki_der_decode(der,
                                               der_len,
                                               selection,
                                               data_cb,
                                               data_cbarg,
