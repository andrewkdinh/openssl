...
next:
    ...
    if (key != NULL) {
        ...
        if (strcmp(ctx->desc->keytype_name, "EC") == 0 &&
            ...
            OSSL_OBJECT_PARAM_DATA_TYPE, "SM2", 0);
        else
#endif
            params[1] = OSSL_PARAM_construct_utf8_string(
...
#define DO_type_specific_pub(keytype)                                          \
    "type-specific", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_PUBLIC_KEY),     \
    NULL, keytype##_d2i_public_key, NULL, NULL, NULL, keytype##_check,         \
...
#define DO_DH(keytype)                                                         \
    "DH", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_ALL_PARAMETERS), NULL,      \
    NULL, keytype##_d2i_key_params, NULL, NULL, keytype##_check,               \
    keytype##_adjust, keytype##_free

#define DO_DHX(keytype)                                                        \
    "DHX", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_ALL_PARAMETERS), NULL,     \
    NULL, keytype##_d2i_key_params, NULL, NULL, keytype##_check,               \
    keytype##_adjust, keytype##_free
