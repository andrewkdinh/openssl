...
#define PROV_CIPHER_HW_declare_xts()                                           \
    static const PROV_CIPHER_HW aesni_xts = {cipher_hw_aesni_xts_initkey,      \
...
#define PROV_CIPHER_HW_declare_xts()                                           \
    ...
    cipher_hw_aes_xts_t4_initkey, NULL, cipher_hw_aes_xts_copyctx};
#define PROV_CIPHER_HW_select_xts()                                            \
...
#define PROV_CIPHER_HW_declare_xts()                                           \
    ...
    cipher_hw_aes_xts_rv64i_zknd_zkne_initkey, NULL,                           \
...
#define PROV_CIPHER_HW_declare_xts()                                           \
    ...
    cipher_hw_aes_xts_rv32i_zknd_zkne_initkey, NULL,                           \
    cipher_hw_aes_xts_copyctx};                                                \
