...
#define PROV_CIPHER_HW_aria_mode(mode)                                         \
    static const PROV_CIPHER_HW aria_##mode = {cipher_hw_aria_initkey,         \
...
PROV_CIPHER_HW_aria_mode(cbc) PROV_CIPHER_HW_aria_mode(ecb)
PROV_CIPHER_HW_aria_mode(ofb128) PROV_CIPHER_HW_aria_mode(cfb128)
PROV_CIPHER_HW_aria_mode(cfb1) PROV_CIPHER_HW_aria_mode(cfb8)
