...
static const PROV_GCM_HW sm4_gcm = {sm4_gcm_initkey,       ossl_gcm_setiv,
                                    ossl_gcm_aad_update,   hw_gcm_cipher_update,
...
#else
const PROV_GCM_HW *ossl_prov_sm4_hw_gcm(size_t keybits) { return &sm4_gcm; }
#endif
