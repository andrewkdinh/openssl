...
static int ccm_sm4_initkey(PROV_CCM_CTX *ctx, const unsigned char *key, size_t keylen)
{
    ...
    if (HWSM4_CAPABLE) {
        ...
        if (VPSM4_EX_CAPABLE) {
        SM4_HW_CCM_SET_KEY_FN(vpsm4_ex_set_encrypt_key, vpsm4_ex_encrypt, NULL, NULL);
    } else
