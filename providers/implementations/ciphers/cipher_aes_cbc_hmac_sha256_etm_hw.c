...
int asm_aescbc_sha256_hmac(const uint8_t *csrc, uint8_t *cdst, uint64_t clen, uint8_t *dsrc, uint8_t *ddst,
                           uint64_t dlen, CIPH_DIGEST *arg);
void asm_sha256_hmac_aescbc_dec(const uint8_t *csrc, uint8_t *cdst, uint64_t clen, const unsigned char *dsrc,
...
static const PROV_CIPHER_HW_AES_HMAC_SHA_ETM cipher_hw_aes_hmac_sha256_etm = {
    {aes_cbc_hmac_sha256_init_key, aes_cbc_hmac_sha256_cipher}, aes_cbc_hmac_sha256_set_mac_key};
