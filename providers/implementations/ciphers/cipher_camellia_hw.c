...
#define PROV_CIPHER_HW_camellia_mode(mode)                                     \
    ...
    cipher_hw_camellia_initkey, ossl_cipher_hw_generic_##mode,                 \
...
PROV_CIPHER_HW_camellia_mode(cbc) PROV_CIPHER_HW_camellia_mode(ecb)
PROV_CIPHER_HW_camellia_mode(ofb128) PROV_CIPHER_HW_camellia_mode(cfb128)
PROV_CIPHER_HW_camellia_mode(cfb1) PROV_CIPHER_HW_camellia_mode(cfb8)
