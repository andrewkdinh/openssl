...
static int ossl_aes_gcm_siv_init(void *vctx, const unsigned char *key, size_t keylen, const unsigned char *iv,
...
static int ossl_aes_gcm_siv_einit(void *vctx, const unsigned char *key, size_t keylen, const unsigned char *iv,
                                  size_t ivlen, const OSSL_PARAM params[])
{
    return ossl_aes_gcm_siv_init(vctx, key, keylen, iv, ivlen, params, 1);
}

static int ossl_aes_gcm_siv_dinit(void *vctx, const unsigned char *key, size_t keylen, const unsigned char *iv,
                                  size_t ivlen, const OSSL_PARAM params[])
{
...
static int ossl_aes_gcm_siv_cipher(void *vctx, unsigned char *out, size_t *outl, size_t outsize,
...
static int ossl_aes_gcm_siv_stream_final(void *vctx, unsigned char *out, size_t *outl, size_t outsize)
{
    PROV_AES_GCM_SIV_CTX *ctx = (PROV_AES_GCM_SIV_CTX *)vctx;
    int error = 0;
...
static const OSSL_PARAM *ossl_aes_gcm_siv_gettable_ctx_params(ossl_unused void *cctx, ossl_unused void *provctx)
{
...
static int ossl_aes_gcm_siv_set_ctx_params(void *vctx, const OSSL_PARAM params[])
{
    ...
    if (p != NULL) {
        if (p->data_type != OSSL_PARAM_OCTET_STRING || p->data_size != sizeof(ctx->user_tag)) {
...
static const OSSL_PARAM aes_gcm_siv_known_settable_ctx_params[] = {
    ...
    OSSL_PARAM_octet_string(OSSL_CIPHER_PARAM_AEAD_TAG, NULL, 0), OSSL_PARAM_END};
static const OSSL_PARAM *ossl_aes_gcm_siv_settable_ctx_params(ossl_unused void *cctx, ossl_unused void *provctx)
{
