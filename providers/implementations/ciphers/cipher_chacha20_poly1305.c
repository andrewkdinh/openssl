...
#define CHACHA20_POLY1305_FLAGS                                                \
  (PROV_CIPHER_FLAG_AEAD | PROV_CIPHER_FLAG_CUSTOM_IV)
...
static void *chacha20_poly1305_newctx(void *provctx) {
  ...
  if (ctx != NULL) {
    ...
    &ctx->base, CHACHA20_POLY1305_KEYLEN * 8, CHACHA20_POLY1305_BLKLEN * 8,
    CHACHA20_POLY1305_IVLEN * 8, CHACHA20_POLY1305_MODE,
    CHACHA20_POLY1305_FLAGS,
    ossl_prov_cipher_hw_chacha20_poly1305(CHACHA20_POLY1305_KEYLEN * 8), NULL);
...
static int chacha20_poly1305_get_params(OSSL_PARAM params[]) {
  ...
  params, 0, CHACHA20_POLY1305_FLAGS, CHACHA20_POLY1305_KEYLEN * 8,
  CHACHA20_POLY1305_BLKLEN * 8, CHACHA20_POLY1305_IVLEN * 8);
}
