...
#define XTS_SET_KEY_FN(fn_set_enc_key, fn_set_dec_key, fn_block_enc, fn_block_dec, fn_stream, fn_stream_gb) {                              \
...
static int cipher_hw_sm4_xts_generic_initkey(PROV_CIPHER_CTX *ctx, const unsigned char *key, size_t keylen)
{
...
#ifdef HWSM4_CAPABLE
    if (HWSM4_CAPABLE) {
        XTS_SET_KEY_FN(HWSM4_set_encrypt_key, HWSM4_set_decrypt_key, HWSM4_encrypt, HWSM4_decrypt, stream, stream_gb);
        return 1;
    } else
#endif /* HWSM4_CAPABLE */
        ...
        XTS_SET_KEY_FN(vpsm4_ex_set_encrypt_key, vpsm4_ex_set_decrypt_key, vpsm4_ex_encrypt, vpsm4_ex_decrypt, stream,
                       stream_gb);
        return 1;
    } else
        ...
        XTS_SET_KEY_FN(vpsm4_set_encrypt_key, vpsm4_set_decrypt_key, vpsm4_encrypt, vpsm4_decrypt, stream, stream_gb);
        return 1;
    } else
#endif /* VPSM4_CAPABLE */
    {
    ...
    {
        XTS_SET_KEY_FN(ossl_sm4_set_key, ossl_sm4_set_key, ossl_sm4_encrypt, ossl_sm4_decrypt, stream, stream_gb);
    }
    return 1;
}

static void cipher_hw_sm4_xts_copyctx(PROV_CIPHER_CTX *dst, const PROV_CIPHER_CTX *src)
{
...
static const PROV_CIPHER_HW sm4_generic_xts = {cipher_hw_sm4_xts_generic_initkey, NULL, cipher_hw_sm4_xts_copyctx};
