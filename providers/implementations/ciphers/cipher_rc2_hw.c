...
static int cipher_hw_rc2_initkey(PROV_CIPHER_CTX *ctx, const unsigned char *key,
                                 size_t keylen) {
...
PROV_CIPHER_HW_rc2_mode(cbc, CBC) PROV_CIPHER_HW_rc2_mode(ecb, ECB)
PROV_CIPHER_HW_rc2_mode(ofb64, OFB) PROV_CIPHER_HW_rc2_mode(cfb64, CFB)
