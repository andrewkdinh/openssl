...
static void *rc4_hmac_md5_newctx(void *provctx)
{
    ...
    if (ctx != NULL)
        ossl_cipher_generic_initkey(ctx, RC4_HMAC_MD5_KEY_BITS, RC4_HMAC_MD5_BLOCK_BITS, RC4_HMAC_MD5_IV_BITS,
...
static int rc4_hmac_md5_einit(void *ctx, const unsigned char *key, size_t keylen, const unsigned char *iv, size_t ivlen,
...
static int rc4_hmac_md5_dinit(void *ctx, const unsigned char *key, size_t keylen, const unsigned char *iv, size_t ivlen,
                              const OSSL_PARAM params[])
{
...
static const OSSL_PARAM rc4_hmac_md5_known_gettable_ctx_params[] = {
    ...
    OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_AEAD_TLS1_AAD_PAD, NULL), OSSL_PARAM_END};
...
static const OSSL_PARAM rc4_hmac_md5_known_settable_ctx_params[] = {
    OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_KEYLEN, NULL), OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_IVLEN, NULL),
    OSSL_PARAM_octet_string(OSSL_CIPHER_PARAM_AEAD_TLS1_AAD, NULL, 0), OSSL_PARAM_END};
...
{
    return ossl_cipher_generic_get_params(params, RC4_HMAC_MD5_MODE, RC4_HMAC_MD5_FLAGS, RC4_HMAC_MD5_KEY_BITS,
...
const OSSL_DISPATCH ossl_rc4_hmac_ossl_md5_functions[] = {
    ...
    {OSSL_FUNC_CIPHER_SETTABLE_CTX_PARAMS, (void (*)(void))rc4_hmac_md5_settable_ctx_params},
    OSSL_DISPATCH_END};
