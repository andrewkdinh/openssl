...
static const OSSL_ALGORITHM base_rands[] = {{PROV_NAMES_SEED_SRC, "provider=base", ossl_seed_src_functions},
...
int ossl_base_provider_init(const OSSL_CORE_HANDLE *handle, const OSSL_DISPATCH *in, const OSSL_DISPATCH **out,
                            void **provctx)
{
