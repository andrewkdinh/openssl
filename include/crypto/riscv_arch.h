...
#define RISCV_DEFINE_CAP(NAME, INDEX, BIT_INDEX, HWPROBE_KEY, HWPROBE_VALUE) +1
...
#define RISCV_DEFINE_CAP(NAME, INDEX, BIT_INDEX, OSSL_RISCV_HWPROBE_KEY, OSSL_RISCV_HWPROBE_VALUE) +1
