...
#define OSSL_SAFE_MATH_ADDS(type_name, type, min, max)                         \
  static ossl_inline ossl_unused type safe_add_##type_name(type a, type b,     \
                                                           int *err) {         \
    type r;                                                                    \
                                                                               \
...
#define OSSL_SAFE_MATH_SUBS(type_name, type, min, max)                         \
  static ossl_inline ossl_unused type safe_sub_##type_name(type a, type b,     \
                                                           int *err) {         \
    type r;                                                                    \
                                                                               \
...
#define OSSL_SAFE_MATH_MULS(type_name, type, min, max)                         \
  static ossl_inline ossl_unused type safe_mul_##type_name(type a, type b,     \
                                                           int *err) {         \
    type r;                                                                    \
                                                                               \
...
#define OSSL_SAFE_MATH_DIVS(type_name, type, min, max)                         \
  static ossl_inline ossl_unused type safe_div_##type_name(type a, type b,     \
                                                           int *err) {         \
    if (b == 0) {                                                              \
      *err |= 1;                                                               \
      return a < 0 ? min : max;                                                \
...
#define OSSL_SAFE_MATH_MODS(type_name, type, min, max)                         \
  static ossl_inline ossl_unused type safe_mod_##type_name(type a, type b,     \
                                                           int *err) {         \
    if (b == 0) {                                                              \
      *err |= 1;                                                               \
      return 0;                                                                \
...
#define OSSL_SAFE_MATH_NEGS(type_name, type, min)                              \
  static ossl_inline ossl_unused type safe_neg_##type_name(type a, int *err) { \
    if (a != min)                                                              \
      return -a;                                                               \
    *err |= 1;                                                                 \
    return min;                                                                \
...
#define OSSL_SAFE_MATH_ABSS(type_name, type, min)                              \
  static ossl_inline ossl_unused type safe_abs_##type_name(type a, int *err) { \
    if (a != min)                                                              \
      return a < 0 ? -a : a;                                                   \
    *err |= 1;                                                                 \
    return min;                                                                \
...
#define OSSL_SAFE_MATH_MULDIVS(type_name, type, max)                           \
  static ossl_inline ossl_unused type safe_muldiv_##type_name(                 \
  type a, type b, type c, int *err) {                                          \
    int e2 = 0;                                                                \
    type q, r, x, y;                                                           \
                                                                               \
    if (c == 0) {                                                              \
...
#define OSSL_SAFE_MATH_SIGNED(type_name, type)                                 \
  ...
  OSSL_SAFE_MATH_MODS(type_name, type, OSSL_SAFE_MATH_MINS(type),              \
                      OSSL_SAFE_MATH_MAXS(type))                               \
  OSSL_SAFE_MATH_DIV_ROUND_UP(type_name, type, OSSL_SAFE_MATH_MAXS(type))      \
...
#define OSSL_SAFE_MATH_UNSIGNED(type_name, type)                               \
  ...
  OSSL_SAFE_MATH_DIV_ROUND_UP(type_name, type, OSSL_SAFE_MATH_MAXU(type))      \
