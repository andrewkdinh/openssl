...
struct ossl_record_method_st {
     ...
     */
    int (*new_record_layer)(OSSL_LIB_CTX *libctx, const char *propq, int vers, int role, int direction, int level,
                            uint16_t epoch, unsigned char *secret, size_t secretlen, unsigned char *key, size_t keylen,
                            ...
                            const OSSL_DISPATCH *fns, void *cbarg, void *rlarg, OSSL_RECORD_LAYER **ret);
     ...
     */
    int (*read_record)(OSSL_RECORD_LAYER *rl, void **rechandle, int *rversion, uint8_t *type,
     ...
     */
    void (*get_state)(OSSL_RECORD_LAYER *rl, const char **shortstr, const char **longstr);
