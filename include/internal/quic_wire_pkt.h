 ...
 */
static ossl_inline ossl_unused int ossl_quic_pkt_type_has_version(uint32_t pkt_type)
{
 ...
 */
static ossl_inline ossl_unused int ossl_quic_pkt_type_has_scid(uint32_t pkt_type)
{
