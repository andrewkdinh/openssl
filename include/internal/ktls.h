 ...
 * setting keys.
 */
static ossl_inline int ktls_enable(int fd) { return 1; }
 ...
 */
static ossl_inline int ktls_start(int fd, ktls_crypto_info_t *tls_en,
                                  int is_tx) {
  if (is_tx)
...
static ossl_inline int ktls_enable_tx_zerocopy_sendfile(int fd) { return 0; }
