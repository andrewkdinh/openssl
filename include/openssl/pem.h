...
#define PEM_read_cb_fnsig(name, type, INTYPE, readname)                        \
    type *PEM_##readname##_##name(INTYPE *out, type **x, pem_password_cb *cb,  \
                                  void *u)
#define PEM_read_cb_ex_fnsig(name, type, INTYPE, readname)                     \
    type *PEM_##readname##_##name##_ex(                                        \
    INTYPE *out, type **x, pem_password_cb *cb, void *u, OSSL_LIB_CTX *libctx, \
    const char *propq)
...
#define PEM_write_cb_fnsig(name, type, OUTTYPE, writename)                     \
    int PEM_##writename##_##name(                                              \
    OUTTYPE *out, const type *x, const EVP_CIPHER *enc,                        \
...
#define IMPLEMENT_PEM_write_fp(name, type, str, asn1)                          \
    PEM_write_fnsig(name, type, FILE, write) {                                 \
        return PEM_ASN1_write((i2d_of_void *)i2d_##asn1, str, out, x, NULL,    \
                              NULL, 0, NULL, NULL);                            \
    }
...
#define IMPLEMENT_PEM_write_cb_fp(name, type, str, asn1)                       \
    PEM_write_cb_fnsig(name, type, FILE, write) {                              \
        return PEM_ASN1_write((i2d_of_void *)i2d_##asn1, str, out, x, enc,     \
                              kstr, klen, cb, u);                              \
    }
...
#define IMPLEMENT_PEM_write_bio(name, type, str, asn1)                         \
    PEM_write_fnsig(name, type, BIO, write_bio) {                              \
        return PEM_ASN1_write_bio((i2d_of_void *)i2d_##asn1, str, out, x,      \
...
#define IMPLEMENT_PEM_write_cb_bio(name, type, str, asn1)                      \
    PEM_write_cb_fnsig(name, type, BIO, write_bio) {                           \
        return PEM_ASN1_write_bio((i2d_of_void *)i2d_##asn1, str, out, x, enc, \
                                  kstr, klen, cb, u);                          \
    }
...
DECLARE_PEM_rw(X509_CRL, X509_CRL) DECLARE_PEM_rw(X509_PUBKEY, X509_PUBKEY)
