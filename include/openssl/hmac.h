...
OSSL_DEPRECATEDIN_1_1_0 __owur int HMAC_Init(HMAC_CTX *ctx, const void *key,
                                             int len, const EVP_MD *md);
#endif
#ifndef OPENSSL_NO_DEPRECATED_3_0
...
OSSL_DEPRECATEDIN_3_0 void HMAC_CTX_set_flags(HMAC_CTX *ctx,
                                              unsigned long flags);
