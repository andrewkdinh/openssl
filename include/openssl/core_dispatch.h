...
OSSL_CORE_MAKE_FUNC(size_t, get_nonce,
                    (const OSSL_CORE_HANDLE *handle, unsigned char **pout, size_t min_len, size_t max_len,
...
OSSL_CORE_MAKE_FUNC(int, SSL_QUIC_TLS_crypto_send,
                    (SSL * s, const unsigned char *buf, size_t buf_len, size_t *consumed, void *arg))
#define OSSL_FUNC_SSL_QUIC_TLS_CRYPTO_RECV_RCD      2002
OSSL_CORE_MAKE_FUNC(int, SSL_QUIC_TLS_crypto_recv_rcd,
                    (SSL * s, const unsigned char **buf, size_t *bytes_read, void *arg))
#define OSSL_FUNC_SSL_QUIC_TLS_CRYPTO_RELEASE_RCD   2003
OSSL_CORE_MAKE_FUNC(int, SSL_QUIC_TLS_crypto_release_rcd, (SSL * s, size_t bytes_read, void *arg))
#define OSSL_FUNC_SSL_QUIC_TLS_YIELD_SECRET         2004
OSSL_CORE_MAKE_FUNC(int, SSL_QUIC_TLS_yield_secret,
                    (SSL * s, uint32_t prot_level, int direction, const unsigned char *secret, size_t secret_len,
                     void *arg))
#define OSSL_FUNC_SSL_QUIC_TLS_GOT_TRANSPORT_PARAMS 2005
OSSL_CORE_MAKE_FUNC(int, SSL_QUIC_TLS_got_transport_params,
                    (SSL * s, const unsigned char *params, size_t params_len, void *arg))
#define OSSL_FUNC_SSL_QUIC_TLS_ALERT                2006
OSSL_CORE_MAKE_FUNC(int, SSL_QUIC_TLS_alert, (SSL * s, unsigned char alert_code, void *arg))
...
OSSL_CORE_MAKE_FUNC(int, digest_squeeze, (void *dctx, unsigned char *out, size_t *outl, size_t outsz))
OSSL_CORE_MAKE_FUNC(int, digest_digest,
                    (void *provctx, const unsigned char *in, size_t inl, unsigned char *out, size_t *outl,
                     size_t outsz))
...
OSSL_CORE_MAKE_FUNC(int, cipher_encrypt_init,
                    (void *cctx, const unsigned char *key, size_t keylen, const unsigned char *iv, size_t ivlen,
                     const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, cipher_decrypt_init,
                    (void *cctx, const unsigned char *key, size_t keylen, const unsigned char *iv, size_t ivlen,
                     const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, cipher_update,
                    (void *cctx, unsigned char *out, size_t *outl, size_t outsize, const unsigned char *in, size_t inl))
...
OSSL_CORE_MAKE_FUNC(int, cipher_pipeline_encrypt_init,
                    (void *cctx, const unsigned char *key, size_t keylen, size_t numpipes, const unsigned char **iv,
                     size_t ivlen, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, cipher_pipeline_decrypt_init,
                    (void *cctx, const unsigned char *key, size_t keylen, size_t numpipes, const unsigned char **iv,
                     size_t ivlen, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, cipher_pipeline_update,
                    (void *cctx, size_t numpipes, unsigned char **out, size_t *outl, const size_t *outsize,
...
OSSL_CORE_MAKE_FUNC(int, cipher_encrypt_skey_init,
                    (void *cctx, void *skeydata, const unsigned char *iv, size_t ivlen, const OSSL_PARAM params[]))
...
OSSL_CORE_MAKE_FUNC(int, rand_instantiate,
                    (void *vdrbg, unsigned int strength, int prediction_resistance, const unsigned char *pstr,
...
OSSL_CORE_MAKE_FUNC(int, rand_generate,
                    (void *vctx, unsigned char *out, size_t outlen, unsigned int strength, int prediction_resistance,
                     const unsigned char *addin, size_t addin_len))
OSSL_CORE_MAKE_FUNC(int, rand_reseed,
                    (void *vctx, int prediction_resistance, const unsigned char *ent, size_t ent_len,
                     const unsigned char *addin, size_t addin_len))
...
OSSL_CORE_MAKE_FUNC(int, keymgmt_gen_get_params, (void *genctx, OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(const OSSL_PARAM *, keymgmt_gen_gettable_params, (void *genctx, void *provctx))
...
OSSL_CORE_MAKE_FUNC(int, signature_sign,
                    (void *ctx, unsigned char *sig, size_t *siglen, size_t sigsize, const unsigned char *tbs,
                     size_t tbslen))
OSSL_CORE_MAKE_FUNC(int, signature_sign_message_init, (void *ctx, void *provkey, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, signature_sign_message_update, (void *ctx, const unsigned char *in, size_t inlen))
OSSL_CORE_MAKE_FUNC(int, signature_sign_message_final, (void *ctx, unsigned char *sig, size_t *siglen, size_t sigsize))
...
OSSL_CORE_MAKE_FUNC(int, signature_verify_message_init, (void *ctx, void *provkey, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, signature_verify_message_update, (void *ctx, const unsigned char *in, size_t inlen))
/*
...
OSSL_CORE_MAKE_FUNC(int, signature_verify_recover,
                    (void *ctx, unsigned char *rout, size_t *routlen, size_t routsize, const unsigned char *sig,
                     size_t siglen))
...
OSSL_CORE_MAKE_FUNC(int, signature_digest_sign,
                    (void *ctx, unsigned char *sigret, size_t *siglen, size_t sigsize, const unsigned char *tbs,
                     size_t tbslen))
...
OSSL_CORE_MAKE_FUNC(const OSSL_PARAM *, skeymgmt_imp_settable_params, (void *provctx))
OSSL_CORE_MAKE_FUNC(void *, skeymgmt_import, (void *provctx, int selection, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, skeymgmt_export, (void *keydata, int selection, OSSL_CALLBACK *param_cb, void *cbarg))
OSSL_CORE_MAKE_FUNC(const OSSL_PARAM *, skeymgmt_gen_settable_params, (void *provctx))
...
OSSL_CORE_MAKE_FUNC(int, asym_cipher_encrypt,
                    (void *ctx, unsigned char *out, size_t *outlen, size_t outsize, const unsigned char *in,
                     size_t inlen))
...
OSSL_CORE_MAKE_FUNC(int, kem_auth_encapsulate_init,
                    (void *ctx, void *provkey, void *authprivkey, const OSSL_PARAM params[]))
...
OSSL_CORE_MAKE_FUNC(int, kem_auth_decapsulate_init,
                    (void *ctx, void *provkey, void *authpubkey, const OSSL_PARAM params[]))
...
OSSL_CORE_MAKE_FUNC(int, encoder_encode,
                    (void *ctx, OSSL_CORE_BIO *out, const void *obj_raw, const OSSL_PARAM obj_abstract[], int selection,
...
OSSL_CORE_MAKE_FUNC(int, decoder_decode,
                    (void *ctx, OSSL_CORE_BIO *in, int selection, OSSL_CALLBACK *data_cb, void *data_cbarg,
...
OSSL_CORE_MAKE_FUNC(int, store_load,
                    (void *loaderctx, OSSL_CALLBACK *object_cb, void *object_cbarg, OSSL_PASSPHRASE_CALLBACK *pw_cb,
                     void *pw_cbarg))
...
OSSL_CORE_MAKE_FUNC(int, store_export_object,
                    (void *loaderctx, const void *objref, size_t objref_sz, OSSL_CALLBACK *export_cb,
                     void *export_cbarg))
OSSL_CORE_MAKE_FUNC(int, store_delete,
                    (void *provctx, const char *uri, const OSSL_PARAM params[], OSSL_PASSPHRASE_CALLBACK *pw_cb,
                     void *pw_cbarg))
