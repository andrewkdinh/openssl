...
OSSL_CORE_MAKE_FUNC(const OSSL_PARAM *, core_gettable_params,
                    (const OSSL_CORE_HANDLE *prov))
#define OSSL_FUNC_CORE_GET_PARAMS             2
OSSL_CORE_MAKE_FUNC(int, core_get_params,
                    (const OSSL_CORE_HANDLE *prov, OSSL_PARAM params[]))
...
OSSL_CORE_MAKE_FUNC(void, core_set_error_debug,
                    (const OSSL_CORE_HANDLE *prov, const char *file, int line,
                     const char *func))
#define OSSL_FUNC_CORE_VSET_ERROR             7
OSSL_CORE_MAKE_FUNC(void, core_vset_error,
                    (const OSSL_CORE_HANDLE *prov, uint32_t reason,
...
OSSL_CORE_MAKE_FUNC(void *, CRYPTO_malloc,
                    (size_t num, const char *file, int line))
#define OSSL_FUNC_CRYPTO_ZALLOC               21
OSSL_CORE_MAKE_FUNC(void *, CRYPTO_zalloc,
                    (size_t num, const char *file, int line))
...
OSSL_CORE_MAKE_FUNC(void, CRYPTO_clear_free,
                    (void *ptr, size_t num, const char *file, int line))
#define OSSL_FUNC_CRYPTO_REALLOC              24
OSSL_CORE_MAKE_FUNC(void *, CRYPTO_realloc,
                    (void *addr, size_t num, const char *file, int line))
#define OSSL_FUNC_CRYPTO_CLEAR_REALLOC        25
OSSL_CORE_MAKE_FUNC(void *, CRYPTO_clear_realloc,
                    (void *addr, size_t old_num, size_t num, const char *file,
                     int line))
#define OSSL_FUNC_CRYPTO_SECURE_MALLOC        26
OSSL_CORE_MAKE_FUNC(void *, CRYPTO_secure_malloc,
                    (size_t num, const char *file, int line))
#define OSSL_FUNC_CRYPTO_SECURE_ZALLOC        27
OSSL_CORE_MAKE_FUNC(void *, CRYPTO_secure_zalloc,
                    (size_t num, const char *file, int line))
#define OSSL_FUNC_CRYPTO_SECURE_FREE          28
OSSL_CORE_MAKE_FUNC(void, CRYPTO_secure_free,
                    (void *ptr, const char *file, int line))
#define OSSL_FUNC_CRYPTO_SECURE_CLEAR_FREE    29
OSSL_CORE_MAKE_FUNC(void, CRYPTO_secure_clear_free,
                    (void *ptr, size_t num, const char *file, int line))
...
OSSL_CORE_MAKE_FUNC(OSSL_CORE_BIO *, BIO_new_file,
                    (const char *filename, const char *mode))
OSSL_CORE_MAKE_FUNC(OSSL_CORE_BIO *, BIO_new_membuf, (const void *buf, int len))
OSSL_CORE_MAKE_FUNC(int, BIO_read_ex,
                    (OSSL_CORE_BIO * bio, void *data, size_t data_len,
                     size_t *bytes_read))
OSSL_CORE_MAKE_FUNC(int, BIO_write_ex,
                    (OSSL_CORE_BIO * bio, const void *data, size_t data_len,
                     size_t *written))
...
OSSL_CORE_MAKE_FUNC(int, BIO_vprintf,
                    (OSSL_CORE_BIO * bio, const char *format, va_list args))
OSSL_CORE_MAKE_FUNC(int, BIO_vsnprintf,
                    (char *buf, size_t n, const char *fmt, va_list args))
OSSL_CORE_MAKE_FUNC(int, BIO_ctrl,
                    (OSSL_CORE_BIO * bio, int cmd, long num, void *ptr))
...
OSSL_CORE_MAKE_FUNC(void, indicator_cb,
                    (OPENSSL_CORE_CTX * ctx, OSSL_INDICATOR_CALLBACK **cb))
#define OSSL_FUNC_SELF_TEST_CB               100
OSSL_CORE_MAKE_FUNC(void, self_test_cb,
                    (OPENSSL_CORE_CTX * ctx, OSSL_CALLBACK **cb, void **cbarg))
...
OSSL_CORE_MAKE_FUNC(size_t, get_entropy,
                    (const OSSL_CORE_HANDLE *handle, unsigned char **pout,
                     int entropy, size_t min_len, size_t max_len))
OSSL_CORE_MAKE_FUNC(size_t, get_user_entropy,
                    (const OSSL_CORE_HANDLE *handle, unsigned char **pout,
                     int entropy, size_t min_len, size_t max_len))
OSSL_CORE_MAKE_FUNC(void, cleanup_entropy,
                    (const OSSL_CORE_HANDLE *handle, unsigned char *buf,
                     size_t len))
OSSL_CORE_MAKE_FUNC(void, cleanup_user_entropy,
                    (const OSSL_CORE_HANDLE *handle, unsigned char *buf,
                     size_t len))
OSSL_CORE_MAKE_FUNC(size_t, get_nonce,
                    (const OSSL_CORE_HANDLE *handle, unsigned char **pout,
                     ...
                     size_t salt_len))
OSSL_CORE_MAKE_FUNC(size_t, get_user_nonce,
                    (const OSSL_CORE_HANDLE *handle, unsigned char **pout,
                     size_t min_len, size_t max_len, const void *salt,
                     size_t salt_len))
OSSL_CORE_MAKE_FUNC(void, cleanup_nonce,
                    (const OSSL_CORE_HANDLE *handle, unsigned char *buf,
                     size_t len))
OSSL_CORE_MAKE_FUNC(void, cleanup_user_nonce,
                    (const OSSL_CORE_HANDLE *handle, unsigned char *buf,
                     size_t len))
...
OSSL_CORE_MAKE_FUNC(
    int, provider_register_child_cb,
...
OSSL_CORE_MAKE_FUNC(const OSSL_PARAM *, provider_gettable_params,
                    (void *provctx))
#define OSSL_FUNC_PROVIDER_GET_PARAMS         1026
OSSL_CORE_MAKE_FUNC(int, provider_get_params,
...
OSSL_CORE_MAKE_FUNC(int, provider_get_capabilities,
                    (void *provctx, const char *capability, OSSL_CALLBACK *cb,
                     void *arg))
...
OSSL_CORE_MAKE_FUNC(int, provider_random_bytes,
                    (void *provctx, int which, void *buf, size_t n,
...
OSSL_CORE_MAKE_FUNC(int, cipher_encrypt_init,
                    (void *cctx, const unsigned char *key, size_t keylen,
...
OSSL_CORE_MAKE_FUNC(int, cipher_update,
                    (void *cctx, unsigned char *out, size_t *outl,
...
OSSL_CORE_MAKE_FUNC(int, cipher_pipeline_update,
                    (void *cctx, size_t numpipes, unsigned char **out,
...
OSSL_CORE_MAKE_FUNC(int, cipher_get_ctx_params,
                    (void *cctx, OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, cipher_set_ctx_params,
...
OSSL_CORE_MAKE_FUNC(const OSSL_PARAM *, cipher_gettable_ctx_params,
                    (void *cctx, void *provctx))
OSSL_CORE_MAKE_FUNC(int, cipher_encrypt_skey_init,
                    (void *cctx, void *skeydata, const unsigned char *iv,
                     size_t ivlen, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, cipher_decrypt_skey_init,
                    (void *cctx, void *skeydata, const unsigned char *iv,
                     size_t ivlen, const OSSL_PARAM params[]))
...
OSSL_CORE_MAKE_FUNC(int, mac_final,
                    (void *mctx, unsigned char *out, size_t *outl,
                     size_t outsize))
...
OSSL_CORE_MAKE_FUNC(int, mac_init_skey,
                    (void *mctx, void *key, const OSSL_PARAM params[]))
...
OSSL_CORE_MAKE_FUNC(size_t, rand_get_seed,
                    (void *vctx, unsigned char **buffer, int entropy,
...
OSSL_CORE_MAKE_FUNC(const OSSL_PARAM *, keymgmt_gen_settable_params,
...
OSSL_CORE_MAKE_FUNC(int, keymgmt_validate,
                    (const void *keydata, int selection, int checktype))

/* Key checks - matching */
#define OSSL_FUNC_KEYMGMT_MATCH                      23
OSSL_CORE_MAKE_FUNC(int, keymgmt_match,
                    (const void *keydata1, const void *keydata2, int selection))
...
OSSL_CORE_MAKE_FUNC(int, keymgmt_export,
                    (void *keydata, int selection, OSSL_CALLBACK *param_cb,
                     void *cbarg))
...
OSSL_CORE_MAKE_FUNC(int, keyexch_init,
                    (void *ctx, void *provkey, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, keyexch_derive,
                    (void *ctx, unsigned char *secret, size_t *secretlen,
                     size_t outlen))
...
OSSL_CORE_MAKE_FUNC(int, keyexch_set_ctx_params,
                    (void *ctx, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(const OSSL_PARAM *, keyexch_settable_ctx_params,
                    (void *ctx, void *provctx))
OSSL_CORE_MAKE_FUNC(int, keyexch_get_ctx_params,
...
OSSL_CORE_MAKE_FUNC(void *, signature_newctx,
                    (void *provctx, const char *propq))
OSSL_CORE_MAKE_FUNC(int, signature_sign_init,
                    (void *ctx, void *provkey, const OSSL_PARAM params[]))
...
OSSL_CORE_MAKE_FUNC(int, signature_sign_message_final,
                    (void *ctx, unsigned char *sig, size_t *siglen,
                     size_t sigsize))
OSSL_CORE_MAKE_FUNC(int, signature_verify_init,
                    (void *ctx, void *provkey, const OSSL_PARAM params[]))
...
OSSL_CORE_MAKE_FUNC(const OSSL_PARAM *, skeymgmt_imp_settable_params,
                    (void *provctx))
OSSL_CORE_MAKE_FUNC(void *, skeymgmt_import,
                    (void *provctx, int selection, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, skeymgmt_export,
                    (void *keydata, int selection, OSSL_CALLBACK *param_cb,
                     void *cbarg))
OSSL_CORE_MAKE_FUNC(const OSSL_PARAM *, skeymgmt_gen_settable_params,
                    (void *provctx))
OSSL_CORE_MAKE_FUNC(void *, skeymgmt_generate,
...
OSSL_CORE_MAKE_FUNC(int, asym_cipher_encrypt_init,
                    (void *ctx, void *provkey, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, asym_cipher_encrypt,
                    (void *ctx, unsigned char *out, size_t *outlen,
                     size_t outsize, const unsigned char *in, size_t inlen))
OSSL_CORE_MAKE_FUNC(int, asym_cipher_decrypt_init,
                    (void *ctx, void *provkey, const OSSL_PARAM params[]))
...
OSSL_CORE_MAKE_FUNC(int, kem_encapsulate_init,
                    (void *ctx, void *provkey, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, kem_auth_encapsulate_init,
                    (void *ctx, void *provkey, void *authprivkey,
                     const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, kem_encapsulate,
                    (void *ctx, unsigned char *out, size_t *outlen,
                     unsigned char *secret, size_t *secretlen))
OSSL_CORE_MAKE_FUNC(int, kem_decapsulate_init,
                    (void *ctx, void *provkey, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(int, kem_auth_decapsulate_init,
...
OSSL_CORE_MAKE_FUNC(int, encoder_encode,
                    (void *ctx, OSSL_CORE_BIO *out, const void *obj_raw,
...
OSSL_CORE_MAKE_FUNC(int, store_load,
                    (void *loaderctx, OSSL_CALLBACK *object_cb,
