 ...
 *  \return 1 on success and 0 if an error occurred
 */
OSSL_DEPRECATEDIN_3_0 int EC_POINTs_mul(const EC_GROUP *group,
                                        EC_POINT       *r,
                                        const BIGNUM   *n,
                                        size_t          num,
                                        const EC_POINT *p[],
 ...
 *  This identifier is retained for backwards compatibility
 */
OSSL_DEPRECATEDIN_3_0 int                  ECDH_KDF_X9_62(unsigned char       *out,
                                                          size_t               outlen,
...
OSSL_DEPRECATEDIN_3_0 int                  ECDH_compute_key(void           *out,
                                                            size_t          outlen,
 ...
 *  \return 1 on success and 0 otherwise
 */
OSSL_DEPRECATEDIN_3_0 int ECDSA_sign_ex(int                  type,
...
OSSL_DEPRECATEDIN_3_0 void EC_KEY_METHOD_set_sign(
    ...
    ECDSA_SIG *(
        *sign_sig)(const unsigned char *dgst, int dgst_len, const BIGNUM *in_kinv, const BIGNUM *in_r, EC_KEY *eckey));
