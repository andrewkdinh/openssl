...
OSSL_DEPRECATEDIN_3_0 int (*EVP_CIPHER_meth_get_get_asn1_params(const EVP_CIPHER *cipher))(EVP_CIPHER_CTX *,
                                                                                           ASN1_TYPE *);
OSSL_DEPRECATEDIN_3_0 int (*EVP_CIPHER_meth_get_ctrl(const EVP_CIPHER *cipher))(EVP_CIPHER_CTX *,
                                                                                int   type,
                                                                                int   arg,
                                                                                void *ptr);
#endif
...
typedef int(EVP_PBE_KEYGEN_EX)(EVP_CIPHER_CTX   *ctx,
                               const char       *pass,
                               int               passlen,
                               ASN1_TYPE        *param,
                               const EVP_CIPHER *cipher,
...
__owur int     EVP_Q_digest(OSSL_LIB_CTX  *libctx,
                            const char    *name,
                            const char    *propq,
                            const void    *data,
                            size_t         datalen,
...
__owur int EVP_DecryptInit_ex(EVP_CIPHER_CTX      *ctx,
                              ...
                              const unsigned char *key,
                              const unsigned char *iv);
__owur int EVP_DecryptInit_ex2(EVP_CIPHER_CTX      *ctx,
                               const EVP_CIPHER    *cipher,
                               const unsigned char *key,
                               const unsigned char *iv,
                               const OSSL_PARAM     params[]);
...
__owur int EVP_CipherInit_ex(EVP_CIPHER_CTX      *ctx,
                             ...
                             const unsigned char *iv,
                             int                  enc);
__owur int EVP_CipherInit_SKEY(EVP_CIPHER_CTX      *ctx,
                               const EVP_CIPHER    *cipher,
                               EVP_SKEY            *skey,
                               const unsigned char *iv,
                               size_t               iv_len,
                               int                  enc,
                               const OSSL_PARAM     params[]);
__owur int EVP_CipherInit_ex2(EVP_CIPHER_CTX      *ctx,
                              const EVP_CIPHER    *cipher,
                              const unsigned char *key,
                              const unsigned char *iv,
                              int                  enc,
...
__owur int EVP_SignFinal_ex(EVP_MD_CTX    *ctx,
                            unsigned char *md,
                            unsigned int  *s,
                            EVP_PKEY      *pkey,
                            OSSL_LIB_CTX  *libctx,
...
__owur int EVP_VerifyFinal_ex(EVP_MD_CTX          *ctx,
...
__owur int EVP_DigestSignInit_ex(EVP_MD_CTX      *ctx,
                                 EVP_PKEY_CTX   **pctx,
                                 const char      *mdname,
                                 OSSL_LIB_CTX    *libctx,
                                 const char      *props,
...
__owur int EVP_DigestVerifyInit_ex(EVP_MD_CTX      *ctx,
                                   EVP_PKEY_CTX   **pctx,
                                   const char      *mdname,
                                   OSSL_LIB_CTX    *libctx,
                                   const char      *props,
...
__owur int           EVP_RAND_instantiate(EVP_RAND_CTX        *ctx,
...
__owur int           EVP_RAND_generate(EVP_RAND_CTX        *ctx,
                                       unsigned char       *out,
                                       size_t               outlen,
                                       unsigned int         strength,
                                       int                  prediction_resistance,
                                       ...
                                       size_t               addin_len);
int                  EVP_RAND_reseed(EVP_RAND_CTX        *ctx,
                                     int                  prediction_resistance,
...
EVP_PKEY_decrypt_old(unsigned char *dec_key, const unsigned char *enc_key, int enc_key_len, EVP_PKEY *private_key);
OSSL_DEPRECATEDIN_3_0 int
EVP_PKEY_encrypt_old(unsigned char *enc_key, const unsigned char *key, int key_len, EVP_PKEY *pub_key);
#endif
...
EVP_PKEY            *d2i_PrivateKey_ex(int                   type,
                                       EVP_PKEY            **a,
...
EVP_PKEY *
d2i_AutoPrivateKey_ex(EVP_PKEY **a, const unsigned char **pp, long length, OSSL_LIB_CTX *libctx, const char *propq);
...
int    PKCS5_PBE_keyivgen(EVP_CIPHER_CTX   *ctx,
                          ...
                          const EVP_MD     *md,
                          int               en_de);
int    PKCS5_PBE_keyivgen_ex(EVP_CIPHER_CTX   *cctx,
                             const char       *pass,
                             int               passlen,
                             ASN1_TYPE        *param,
                             const EVP_CIPHER *cipher,
...
OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_set_verify_recover(EVP_PKEY_METHOD *pmeth,
...
OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_get_verify(const EVP_PKEY_METHOD *pmeth,
...
OSSL_DEPRECATEDIN_3_0 void EVP_PKEY_meth_get_verify_recover(const EVP_PKEY_METHOD *pmeth,
                                                            ...
                                                            int (**pverify_recover)(EVP_PKEY_CTX        *ctx,
                                                                                    ...
                                                                                    size_t               tbslen));
OSSL_DEPRECATEDIN_3_0 void
                           EVP_PKEY_meth_get_signctx(const EVP_PKEY_METHOD *pmeth,
...
OSSL_DEPRECATEDIN_3_0 void
EVP_PKEY_meth_get_derive(const EVP_PKEY_METHOD *pmeth,
...
EVP_SKEY            *EVP_SKEY_import(OSSL_LIB_CTX     *libctx,
                                     const char       *skeymgmtname,
                                     const char       *propquery,
                                     int               selection,
                                     const OSSL_PARAM *params);
EVP_SKEY *
EVP_SKEY_generate(OSSL_LIB_CTX *libctx, const char *skeymgmtname, const char *propquery, const OSSL_PARAM *params);
