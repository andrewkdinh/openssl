...
static ossl_inline ossl_unused unsigned char *OPENSSL_store_u16_le(unsigned char *out, uint16_t val)
{
#ifdef OSSL_HTOLE16
...
static ossl_inline ossl_unused unsigned char *OPENSSL_store_u16_be(unsigned char *out, uint16_t val)
{
#ifdef OSSL_HTOBE16
...
static ossl_inline ossl_unused unsigned char *OPENSSL_store_u32_le(unsigned char *out, uint32_t val)
{
#ifdef OSSL_HTOLE32
...
static ossl_inline ossl_unused unsigned char *OPENSSL_store_u32_be(unsigned char *out, uint32_t val)
{
#ifdef OSSL_HTOBE32
...
static ossl_inline ossl_unused unsigned char *OPENSSL_store_u64_le(unsigned char *out, uint64_t val)
{
#ifdef OSSL_HTOLE64
...
static ossl_inline ossl_unused unsigned char *OPENSSL_store_u64_be(unsigned char *out, uint64_t val)
{
#ifdef OSSL_HTOLE64
...
static ossl_inline ossl_unused const unsigned char *OPENSSL_load_u16_le(uint16_t *val, const unsigned char *in)
{
#ifdef OSSL_LE16TOH
    uint16_t t;
...
static ossl_inline ossl_unused const unsigned char *OPENSSL_load_u16_be(uint16_t *val, const unsigned char *in)
{
#ifdef OSSL_LE16TOH
    uint16_t t;
...
static ossl_inline ossl_unused const unsigned char *OPENSSL_load_u32_le(uint32_t *val, const unsigned char *in)
{
#ifdef OSSL_LE32TOH
    uint32_t t;
...
static ossl_inline ossl_unused const unsigned char *OPENSSL_load_u32_be(uint32_t *val, const unsigned char *in)
{
#ifdef OSSL_LE32TOH
    uint32_t t;
...
static ossl_inline ossl_unused const unsigned char *OPENSSL_load_u64_le(uint64_t *val, const unsigned char *in)
{
#ifdef OSSL_LE64TOH
    uint64_t t;
...
static ossl_inline ossl_unused const unsigned char *OPENSSL_load_u64_be(uint64_t *val, const unsigned char *in)
{
#ifdef OSSL_LE64TOH
    uint64_t t;
