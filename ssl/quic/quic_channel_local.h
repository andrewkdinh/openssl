...
struct quic_channel_st {
    ...
    /* Internal state. */
    /*
     * Client: The DCID used in the first Initial packet we transmit as a
     * client. Server: The DCID used in the first Initial packet the client
     * transmitted. Randomly generated and required by RFC to be at least 8
     * bytes.
     */
     ...
     * state if the state is QUIC_CHANNEL_STATE_ACTIVE and handshake_confirmed
     * is set.
     */
