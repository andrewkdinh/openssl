...
static int      qrx_decrypt_pkt_body(OSSL_QRX            *qrx,
                                     unsigned char       *dst,
 ...
 */
static size_t qrx_get_cipher_ctx_idx(OSSL_QRX           *qrx,
...
static int qrx_process_pkt(OSSL_QRX     *qrx,
                           QUIC_URXE    *urxe,
                           PACKET       *pkt,
                           size_t        pkt_idx,
