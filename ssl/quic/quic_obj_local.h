 ...
 */
int ossl_quic_obj_init(QUIC_OBJ *obj, SSL_CTX *ctx, int type, SSL *parent_obj, QUIC_ENGINE *engine, QUIC_PORT *port);
 ...
 */
static ossl_inline ossl_unused SSL *ossl_quic_obj_get0_ssl(QUIC_OBJ *obj)
{
    /*
 ...
 * NULL.
 */
static ossl_inline ossl_unused QUIC_ENGINE *ossl_quic_obj_get0_engine(const QUIC_OBJ *obj)
{
...
static ossl_inline ossl_unused QUIC_PORT *ossl_quic_obj_get0_port(const QUIC_OBJ *obj)
{
    assert(obj->init_done);
    return obj->port;
}
...
static ossl_inline ossl_unused int ossl_quic_obj_is_event_leader(const QUIC_OBJ *obj)
{
 ...
 */
static ossl_inline ossl_unused QUIC_ENGINE *ossl_quic_obj_get0_engine_local(const QUIC_OBJ *obj)
{
    return ossl_quic_obj_is_event_leader(obj) ? ossl_quic_obj_get0_engine(obj) : NULL;
}

/* Returns 1 iff this leader structure represents a port leader. */
static ossl_inline ossl_unused int ossl_quic_obj_is_port_leader(const QUIC_OBJ *obj)
{
 ...
 */
static ossl_inline ossl_unused QUIC_PORT *ossl_quic_obj_get0_port_local(const QUIC_OBJ *obj)
{
    return ossl_quic_obj_is_port_leader(obj) ? ossl_quic_obj_get0_port(obj) : NULL;
}
...
static ossl_inline ossl_unused CRYPTO_MUTEX *ossl_quic_obj_get0_mutex(const QUIC_OBJ *obj)
{
 ...
 * non-NULL.
 */
static ossl_inline ossl_unused QUIC_REACTOR *ossl_quic_obj_get0_reactor(const QUIC_OBJ *obj)
{
...
static ossl_inline ossl_unused OSSL_LIB_CTX *ossl_quic_obj_get0_libctx(const QUIC_OBJ *obj)
{
...
static ossl_inline ossl_unused const char *ossl_quic_obj_get0_propq(const QUIC_OBJ *obj)
{
 ...
 * returns non-NULL.
 */
static ossl_inline ossl_unused SSL *ossl_quic_obj_get0_event_leader(const QUIC_OBJ *obj)
{
    assert(obj->init_done);
    return obj->cached_event_leader != NULL ? &obj->cached_event_leader->ssl : NULL;
}
 ...
 */
static ossl_inline ossl_unused SSL *ossl_quic_obj_get0_port_leader(const QUIC_OBJ *obj)
{
    assert(obj->init_done);
    return obj->cached_port_leader != NULL ? &obj->cached_port_leader->ssl : NULL;
}
 ...
 * ossl_quic_obj_init().
 */
static ossl_inline ossl_unused void ossl_quic_obj_set_domain_flags(QUIC_OBJ *obj, uint64_t domain_flags)
{
