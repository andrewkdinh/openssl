...
{
    return ossl_quic_obj_is_event_leader(obj) ? ossl_quic_obj_get0_engine(obj)
                                              : NULL;
}
...
{
    return ossl_quic_obj_is_port_leader(obj) ? ossl_quic_obj_get0_port(obj)
                                             : NULL;
}
...
{
    assert(obj->init_done);
    return obj->cached_event_leader != NULL ? &obj->cached_event_leader->ssl
                                            : NULL;
}
...
{
    assert(obj->init_done);
    return obj->cached_port_leader != NULL ? &obj->cached_port_leader->ssl
                                           : NULL;
}
