...
int ossl_quic_reactor_wait_ctx_enter(QUIC_REACTOR_WAIT_CTX *ctx, QUIC_REACTOR *rtor)
{
...
void ossl_quic_reactor_wait_ctx_leave(QUIC_REACTOR_WAIT_CTX *ctx, QUIC_REACTOR *rtor)
{
    QUIC_REACTOR_WAIT_SLOT *slot;
