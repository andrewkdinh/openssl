...
ASN1_SEQUENCE(SSL_SESSION_ASN1)
    = {ASN1_EMBED(SSL_SESSION_ASN1, version, UINT32),
       ...
       ASN1_EXP_OPT(SSL_SESSION_ASN1, peer_rpk, ASN1_OCTET_STRING, 20)} static_ASN1_SEQUENCE_END(SSL_SESSION_ASN1)
...
/* Initialise OCTET STRING from buffer and length */
        ...
        static void
        ssl_session_oinit(ASN1_OCTET_STRING * *dest, ASN1_OCTET_STRING * os, const unsigned char *data, size_t len)
    {
...
/* Copy an OCTET STRING, return error if it exceeds maximum length */
    ...
    SSL_SESSION *d2i_SSL_SESSION_ex(SSL_SESSION * *a, const unsigned char **pp, long length, OSSL_LIB_CTX *libctx,
                                    const char *propq)
    {
        long id;
        size_t tmpl;
    ...
    /* ASN.1 code returns suitable error */
        ...
        if ((as->ssl_version >> 8) != SSL3_VERSION_MAJOR && (as->ssl_version >> 8) != DTLS1_VERSION_MAJOR
        ...
        if (!ssl_session_memcpy(ret->session_id, &ret->session_id_length, as->session_id,
