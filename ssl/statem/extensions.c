...
{/*
 ...
 SSL_EXT_CLIENT_HELLO | SSL_EXT_TLS1_2_SERVER_HELLO |
 SSL_EXT_TLS1_3_ENCRYPTED_EXTENSIONS,
 init_alpn, tls_parse_ctos_alpn, tls_parse_stoc_alpn, tls_construct_stoc_alpn,
...
{TLSEXT_TYPE_signature_algorithms_cert,
 SSL_EXT_CLIENT_HELLO | SSL_EXT_TLS1_3_CERTIFICATE_REQUEST, init_sig_algs_cert,
...
{TLSEXT_TYPE_signature_algorithms,
 ...
 tls_parse_ctos_sig_algs, tls_parse_ctos_sig_algs, tls_construct_ctos_sig_algs,
...
{/*
 ...
 tls_construct_stoc_key_share, tls_construct_ctos_key_share, final_key_share},
{/* Must be after key_share */
 TLSEXT_TYPE_cookie,
 SSL_EXT_CLIENT_HELLO | SSL_EXT_TLS1_3_HELLO_RETRY_REQUEST |
 SSL_EXT_TLS_IMPLEMENTATION_ONLY | SSL_EXT_TLS1_3_ONLY,
 NULL, tls_parse_ctos_cookie, tls_parse_stoc_cookie, tls_construct_stoc_cookie,
...
int tls_validate_all_contexts(SSL_CONNECTION *s, unsigned int thisctx,
    ...
    for (thisext = exts, i = 0; i < num_exts; i++, thisext++) {
        ...
        if (i < builtin_num) {
            ...
            meth =
            custom_ext_find(&s->cert->custext, role, thisext->type, &offset);
...
static int final_renegotiate(SSL_CONNECTION *s, unsigned int context,
                             int sent) {
    if (!s->server) {
        /*
...
static int final_server_name(SSL_CONNECTION *s, unsigned int context,
                             int sent) {
    ...
    if (s->server) {
        if (s->s3.peer_tmp != NULL) {
            ...
            if (!s->hit ||
                ...
                SSLfatal(
                s, sent ? SSL_AD_HANDSHAKE_FAILURE : SSL_AD_MISSING_EXTENSION,
...
int tls_psk_do_binder(SSL_CONNECTION *s, const EVP_MD *md,
    ...
    mackey = EVP_PKEY_new_raw_private_key_ex(sctx->libctx, "HMAC", sctx->propq,
...
/* The order these are put into the packet imply a preference order: [brotli,
 * zlib, zstd] */
static EXT_RETURN tls_construct_compress_certificate(SSL_CONNECTION *sc,
                                                     WPACKET *pkt,
                                                     unsigned int context,
    ...
    /* Client: If we sent a client cert-type extension, don't indicate
     * compression
     */
