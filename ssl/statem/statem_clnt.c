                                                             ...
                                                             PACKET *extpkt)
{
    ...
    if (s->early_data_state == SSL_EARLY_DATA_FINISHED_WRITING
        && !ssl_set_new_record_layer(
            s, TLS_ANY_VERSION, OSSL_RECORD_DIRECTION_WRITE,
            OSSL_RECORD_PROTECTION_LEVEL_NONE, NULL, 0, NULL, 0, NULL, 0, NULL,
            0, NULL, 0, NID_undef, NULL, NULL, NULL)) {
        /* SSLfatal already called */
        goto err;
    }
                                               ...
                                               WORK_STATE wst)
{
    ...
    if ((clu =
             ssl_cert_lookup_by_pkey(pkey, &certidx, SSL_CONNECTION_GET_CTX(s)))
        == NULL) {
                                                 ...
                                                 WPACKET *pkt)
{
     ...
     */
    if (SSL_CONNECTION_IS_TLS13(s) && !SSL_IS_QUIC_HANDSHAKE(s)
