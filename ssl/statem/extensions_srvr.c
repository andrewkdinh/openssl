    ...
    *selected_group = 0;
    ...
    for (current_group = 0; current_group < candidate_num_groups;
        ...
        if (!check_in_list(s, candidate_groups[current_group], prio_groups,
            ...
            || !tls_valid_group(s, candidate_groups[current_group],
                                TLS1_3_VERSION, TLS1_3_VERSION, 0, NULL))
                                        ...
                                        size_t chainidx)
{
    ...
    if ((ginf = tls1_group_id_lookup(SSL_CONNECTION_GET_CTX(s), s->s3.group_id))
        == NULL) {
        SSLfatal(s, SSL_AD_INTERNAL_ERROR, ERR_R_INTERNAL_ERROR);
        return EXT_RETURN_FAIL;
    }
                                    ...
                                    size_t chainidx)
{
    ...
    sc->ext.client_cert_type_ctos = reconcile_cert_type(
        data, len, sc->client_cert_type, sc->client_cert_type_len,
                                    ...
                                    size_t chainidx)
{
    ...
    sc->ext.server_cert_type_ctos =
        reconcile_cert_type(sc->server_cert_type, sc->server_cert_type_len,
