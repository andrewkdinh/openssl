 ...
 */
int                        tls13_hkdf_expand_ex(OSSL_LIB_CTX        *libctx,
                                                const char          *propq,
                                                const EVP_MD        *md,
...
int tls13_hkdf_expand(SSL_CONNECTION      *s,
                      const EVP_MD        *md,
                      const unsigned char *secret,
                      const unsigned char *label,
                      size_t               labellen,
                      ...
                      int                  fatal)
{
    ...
    ret           = tls13_hkdf_expand_ex(sctx->libctx,
                               sctx->propq,
                               md,
                               secret,
                               label,
 ...
 */
int tls13_derive_key(SSL_CONNECTION      *s,
                     const EVP_MD        *md,
                     const unsigned char *secret,
                     unsigned char       *key,
                     size_t               keylen)
...
int tls13_derive_finishedkey(SSL_CONNECTION      *s,
                             const EVP_MD        *md,
                             const unsigned char *secret,
                             unsigned char       *fin,
                             size_t               finlen)
...
int tls13_generate_handshake_secret(SSL_CONNECTION *s, const unsigned char *insecret, size_t insecretlen)
{
    ...
    return tls13_generate_secret(s,
                                 ssl_handshake_md(s),
                                 s->early_secret,
                                 insecret,
                                 insecretlen,
 ...
 * failure.
 */
int tls13_generate_master_secret(SSL_CONNECTION *s,
                                 unsigned char  *out,
                                 unsigned char  *prev,
                                 size_t          prevlen,
                                 size_t         *secret_size)
...
static int derive_secret_key_and_iv(SSL_CONNECTION      *s,
                                    const EVP_MD        *md,
