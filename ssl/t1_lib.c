...
static int           add_provider_groups(const OSSL_PARAM params[], void *data)
{
    ...
    if (ctx->group_list_max_len == ctx->group_list_len) {
        ...
        if (ctx->group_list_max_len == 0)
            ...
            tmp =
                OPENSSL_realloc(ctx->group_list,
                                (ctx->group_list_max_len + TLS_GROUP_LIST_MALLOC_BLOCK_SIZE) * sizeof(TLS_GROUP_INFO));
        if (tmp == NULL)
            return 0;
        ctx->group_list = tmp;
...
int tls1_get0_implemented_groups(int                        min_proto_version,
...
int tls1_set_groups(uint16_t **grpext,
                    size_t    *grpextlen,
                    uint16_t **ksext,
                    size_t    *ksextlen,
                    size_t   **tplext,
...
static const SIGALG_LOOKUP sigalg_lookup_tbl[] = {
    {TLSEXT_SIGALG_ecdsa_secp256r1_sha256_name,
     ...
     NID_sha256,                SSL_MD_SHA256_IDX,
     EVP_PKEY_EC,               SSL_PKEY_ECC,
    ...
    {TLSEXT_SIGALG_ed25519_name,
     ...
     NID_undef,                 -1,
     EVP_PKEY_ED25519,          SSL_PKEY_ED25519,
     NID_undef,                   NID_undef,
     1, 0,
     TLS1_2_VERSION, 0,
     DTLS1_2_VERSION, 0              },
    ...
    {TLSEXT_SIGALG_ecdsa_brainpoolP384r1_sha384_name,
     TLSEXT_SIGALG_ecdsa_brainpoolP384r1_sha384_alias,                                                    TLSEXT_SIGALG_ecdsa_brainpoolP384r1_sha384,
     NID_sha384,                SSL_MD_SHA384_IDX,
     EVP_PKEY_EC,               SSL_PKEY_ECC,
    ...
    {TLSEXT_SIGALG_ecdsa_brainpoolP512r1_sha512_name,
     TLSEXT_SIGALG_ecdsa_brainpoolP512r1_sha512_alias,                                                    TLSEXT_SIGALG_ecdsa_brainpoolP512r1_sha512,
     NID_sha512,                SSL_MD_SHA512_IDX,
     EVP_PKEY_EC,               SSL_PKEY_ECC,
    ...
    {TLSEXT_SIGALG_rsa_pss_pss_sha256_name,
     ...
     NID_sha256,                SSL_MD_SHA256_IDX,
     EVP_PKEY_RSA_PSS,          SSL_PKEY_RSA_PSS_SIGN,
     NID_undef,                   NID_undef,
     1, 0,
     TLS1_2_VERSION, 0,
     DTLS1_2_VERSION, 0              },
    ...
    {TLSEXT_SIGALG_dsa_sha256_name,
     ...
     NID_sha256,                SSL_MD_SHA256_IDX,
     EVP_PKEY_DSA,              SSL_PKEY_DSA_SIGN,
...
int tls12_check_peer_sigalg(SSL_CONNECTION *s, uint16_t sig, EVP_PKEY *pkey)
{
    ...
    if (!ssl_cert_lookup_by_nid((pkeyid == EVP_PKEY_RSA_PSS) ? EVP_PKEY_get_id(pkey) : pkeyid,
                                &cidx,
                                     ...
                                     SSL_SESSION        **psess)
{
...
#endif
    {
        ...
        if (tctx->ext.ticket_key_evp_cb != NULL)
            ...
            rv = tctx->ext.ticket_key_cb(SSL_CONNECTION_GET_USER_SSL(s),
                                         nctick,
                                         nctick + TLSEXT_KEYNAME_LENGTH,
                                         ctx,
