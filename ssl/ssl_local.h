...
typedef struct ssl3_enc_method {
    ...
    int (*alert_value)(int);
    int (*export_keying_material)(SSL_CONNECTION *,
                                  unsigned char *,
                                  size_t,
                                  const char *,
                                  size_t,
...
__owur int                    ossl_bytes_to_cipher_list(SSL_CONNECTION        *s,
...
__owur int                    ssl_cipher_get_evp_md_mac(SSL_CTX          *ctx,
                                                        const SSL_CIPHER *sslc,
                                                        const EVP_MD    **md,
                                                        int              *mac_pkey_type,
                                                        size_t           *mac_secret_size);
__owur int                    ssl_cipher_get_evp(SSL_CTX           *ctxc,
                                                 const SSL_SESSION *s,
                                                 ...
                                                 SSL_COMP         **comp,
                                                 int                use_etm);
__owur int                    ssl_cipher_get_overhead(const SSL_CIPHER *c,
                                                      size_t           *mac_overhead,
                                                      size_t           *int_overhead,
                                                      size_t           *blocksize,
                                                      size_t           *ext_overhead);
...
__owur int
     ssl_get_server_cert_serverinfo(SSL_CONNECTION *s, const unsigned char **serverinfo, size_t *serverinfo_length);
...
__owur int               ssl_set_tmp_ecdh_groups(uint16_t **pext,
                                                 size_t    *pextlen,
                                                 uint16_t **ksext,
                                                 size_t    *ksextlen,
                                                 size_t   **tplext,
...
__owur int
ssl3_generate_master_secret(SSL_CONNECTION *s, unsigned char *out, unsigned char *p, size_t len, size_t *secret_size);
...
__owur int
tls1_generate_master_secret(SSL_CONNECTION *s, unsigned char *out, unsigned char *p, size_t len, size_t *secret_size);
...
__owur int    tls13_hkdf_expand(SSL_CONNECTION      *s,
                                ...
                                size_t               outlen,
                                int                  fatal);
__owur int    tls13_hkdf_expand_ex(OSSL_LIB_CTX        *libctx,
                                   const char          *propq,
                                   const EVP_MD        *md,
                                   const unsigned char *secret,
                                   const unsigned char *label,
                                   ...
                                   int                  raise_error);
__owur int
tls13_derive_key(SSL_CONNECTION *s, const EVP_MD *md, const unsigned char *secret, unsigned char *key, size_t keylen);
__owur int
tls13_derive_iv(SSL_CONNECTION *s, const EVP_MD *md, const unsigned char *secret, unsigned char *iv, size_t ivlen);
__owur int tls13_derive_finishedkey(SSL_CONNECTION      *s,
                                    const EVP_MD        *md,
                                    const unsigned char *secret,
                                    unsigned char       *fin,
                                    size_t               finlen);
int        tls13_generate_secret(SSL_CONNECTION      *s,
                                 const EVP_MD        *md,
...
__owur int tls13_generate_master_secret(SSL_CONNECTION *s,
                                        unsigned char  *out,
                                        unsigned char  *prev,
                                        size_t          prevlen,
                                        size_t         *secret_size);
...
__owur int                   tls1_set_groups(uint16_t **grpext,
                                             size_t    *grpextlen,
                                             uint16_t **ksext,
                                             size_t    *ksextlen,
                                             size_t   **tplext,
...
__owur int
tls_valid_group(SSL_CONNECTION *s, uint16_t group_id, int minversion, int maxversion, int isec, int *okfortls13);
...
int                ossl_tls_add_custom_ext_intern(SSL_CTX                   *ctx,
                                                  custom_ext_methods        *exts,
                                                  ENDPOINT                   role,
                                                  ...
                                                  SSL_custom_ext_parse_cb_ex parse_cb,
                                                  void                      *parse_arg);
__owur int         custom_ext_parse(SSL_CONNECTION      *s,
                                    unsigned int         context,
                                    unsigned int         ext_type,
