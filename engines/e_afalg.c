            ...
            if (r > 0) {
                ...
                if (events[0].res < 0) {
                    ...
                    if (events[0].res == -EBUSY && retry++ < 3) {
                         ...
                         * but on some archs ( like mips64 or powerpc64 ) it's
                         * just long int
                         *
                         * to be able to use BIO_snprintf() with %lld without
                         * warnings copy events[0].res to an long long int
                         * variable
                         *
                         * because long long int should always be at least 64
                         * bit this should work
                         */
