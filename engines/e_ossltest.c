...
/* Set up digests */
static int ossltest_digests(ENGINE *e, const EVP_MD **digest, const int **nids,
                            int nid);
...
static const EVP_MD *digest_sha256(void) {
    if (_hidden_sha256_md == NULL) {
        ...
        if ((md = EVP_MD_meth_new(NID_sha256, NID_sha256WithRSAEncryption)) ==
            NULL ||
...
static const EVP_MD *digest_sha384(void) {
    if (_hidden_sha384_md == NULL) {
        ...
        if ((md = EVP_MD_meth_new(NID_sha384, NID_sha384WithRSAEncryption)) ==
            NULL ||
...
static const EVP_MD *digest_sha512(void) {
    if (_hidden_sha512_md == NULL) {
        ...
        if ((md = EVP_MD_meth_new(NID_sha512, NID_sha512WithRSAEncryption)) ==
            NULL ||
...
static int ossltest_cipher_nids[] = {NID_aes_128_cbc, NID_aes_128_gcm,
...
static const EVP_CIPHER *ossltest_aes_128_cbc(void) {
    if (_hidden_aes_128_cbc == NULL &&
        ((_hidden_aes_128_cbc = EVP_CIPHER_meth_new(
          NID_aes_128_cbc, 16 /* block size */, 16 /* key len */)) == NULL ||
         ...
         _hidden_aes_128_cbc, EVP_CIPHER_impl_ctx_size(EVP_aes_128_cbc())))) {
...
static const EVP_CIPHER *ossltest_aes_128_gcm(void) {
    if (_hidden_aes_128_gcm == NULL &&
        ((_hidden_aes_128_gcm = EVP_CIPHER_meth_new(
          NID_aes_128_gcm, 1 /* block size */, 16 /* key len */)) == NULL ||
         ...
         !EVP_CIPHER_meth_set_impl_ctx_size(
         _hidden_aes_128_gcm, EVP_CIPHER_impl_ctx_size(EVP_aes_128_gcm())))) {
...
static const EVP_CIPHER *ossltest_aes_128_cbc_hmac_sha1(void) {
    if (_hidden_aes_128_cbc_hmac_sha1 == NULL &&
        ((_hidden_aes_128_cbc_hmac_sha1 =
          EVP_CIPHER_meth_new(NID_aes_128_cbc_hmac_sha1, 16 /* block size */,
                              16 /* key len */)) == NULL ||
...
static int ossltest_init(ENGINE *e) { return 1; }

static int ossltest_finish(ENGINE *e) { return 1; }
...
static int ossltest_rand_status(void) { return 1; }

static const RAND_METHOD *ossltest_rand_method(void) {

    static RAND_METHOD osslt_rand_meth = {
    NULL, ossltest_rand_bytes, NULL,
