...
static void fuzz_rand_freectx(ossl_unused void *vrng) { OPENSSL_free(vrng); }
...
static int fuzz_rand_enable_locking(ossl_unused void *vrng) { return 1; }
...
fuzz_rand_gettable_ctx_params(ossl_unused void *vrng,
...
{"fuzz", "provider=fuzz-rand", fuzz_rand_functions}, {NULL, NULL, NULL}};
...
void FuzzerClearRand(void) { OSSL_PROVIDER_unload(r_prov); }
