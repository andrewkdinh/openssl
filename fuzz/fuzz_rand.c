...
static int fuzz_rand_instantiate(ossl_unused void *vrng, ossl_unused unsigned int strength,
...
static int fuzz_rand_generate(ossl_unused void *vdrbg, unsigned char *out, size_t outlen,
...
static int fuzz_rand_provider_init(const OSSL_CORE_HANDLE *handle, const OSSL_DISPATCH *in, const OSSL_DISPATCH **out,
                                   void **provctx)
{
