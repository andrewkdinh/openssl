...
/*@0
 *@ above multi-line comment start indent off by 1, reported unless sloppy-cmt;
 *this comment line is too long
...
/*@ comment line is 4 columns tooooooooooooooooo wide, reported unless
 * sloppy-len */
/*@ comment line is 5 columns toooooooooooooooooooooooooooooooooooooooooooooo
 * wide */
...
#define MAC(A)                                                             \
        (A)         /*@ nesting indent of preprocessor directive off by 1      \
                     */
