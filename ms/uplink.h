...
#define UP_fprintf                                                             \
    (*(int (*)(void *, const char *, ...))OPENSSL_UplinkTable[APPLINK_FPRINTF])
#define UP_fgets                                                               \
...
#define UP_fopen                                                               \
    (*(void *(*)(const char *, const char *))OPENSSL_UplinkTable[APPLINK_FOPEN])
#define UP_fseek                                                               \
...
#define UP_read                                                                \
    (*(ossl_ssize_t (*)(int, void *, size_t))OPENSSL_UplinkTable[APPLINK_READ])
#define UP_write                                                               \
