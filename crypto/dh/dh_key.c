...
static int dh_bn_mod_exp(const DH *dh, BIGNUM *r, const BIGNUM *a, const BIGNUM *p, const BIGNUM *m, BN_CTX *ctx,
                         BN_MONT_CTX *m_ctx);
...
static DH_METHOD dh_ossl = {"OpenSSL DH Method", generate_key, ossl_dh_compute_key,
