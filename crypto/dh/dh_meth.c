...
const char *DH_meth_get0_name(const DH_METHOD *dhm) { return dhm->name; }
...
int DH_meth_get_flags(const DH_METHOD *dhm) { return dhm->flags; }
...
void *DH_meth_get0_app_data(const DH_METHOD *dhm) { return dhm->app_data; }
...
int (*DH_meth_get_init(const DH_METHOD *dhm))(DH *) { return dhm->init; }
...
int (*DH_meth_get_finish(const DH_METHOD *dhm))(DH *) { return dhm->finish; }
