...
ASN1_SEQUENCE_cb(DSAPrivateKey,
                 dsa_cb) = {ASN1_EMBED(DSA, version, INT32),
                            ...
                            ASN1_SIMPLE(DSA, priv_key, CBIGNUM)} static_ASN1_SEQUENCE_END_cb(DSA, DSAPrivateKey)
        ...
        ASN1_SEQUENCE_cb(DSAparams, dsa_cb) =
            {
                ...
                IMPLEMENT_ASN1_ENCODE_FUNCTIONS_fname(DSA, DSAparams, DSAparams)
                    ...
                    ASN1_SEQUENCE_cb(DSAPublicKey, dsa_cb) =
                        {ASN1_SIMPLE(DSA, pub_key, BIGNUM), ASN1_SIMPLE(DSA, params.p, BIGNUM),
                         ASN1_SIMPLE(DSA, params.q, BIGNUM),
                         ASN1_SIMPLE(DSA, params.g, BIGNUM)} static_ASN1_SEQUENCE_END_cb(DSA, DSAPublicKey)
