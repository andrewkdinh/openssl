...
const char *DSA_meth_get0_name(const DSA_METHOD *dsam) { return dsam->name; }
...
int DSA_meth_get_flags(const DSA_METHOD *dsam) { return dsam->flags; }
...
void *DSA_meth_get0_app_data(const DSA_METHOD *dsam) { return dsam->app_data; }
...
int DSA_meth_set_verify(DSA_METHOD *dsam,
                        int (*verify)(const unsigned char *, int, DSA_SIG *,
                                      DSA *)) {
...
int (*DSA_meth_get_init(const DSA_METHOD *dsam))(DSA *) { return dsam->init; }
