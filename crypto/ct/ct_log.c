...
CTLOG_STORE *CTLOG_STORE_new(void) { return CTLOG_STORE_new_ex(NULL, NULL); }
...
const char *CTLOG_get0_name(const CTLOG *log) { return log->name; }
...
EVP_PKEY *CTLOG_get0_public_key(const CTLOG *log) { return log->public_key; }
