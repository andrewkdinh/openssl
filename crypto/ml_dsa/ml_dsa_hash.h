...
static ossl_inline ossl_unused int shake_xof(EVP_MD_CTX *ctx, const EVP_MD *md,
...
shake_xof_2(EVP_MD_CTX *ctx, const EVP_MD *md, const uint8_t *in1,
...
static ossl_inline ossl_unused int
shake_xof_3(EVP_MD_CTX *ctx, const EVP_MD *md, const uint8_t *in1,
