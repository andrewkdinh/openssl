...
static unsigned long get_error_values(ERR_GET_ACTION g, const char **file,
...
void err_free_strings_int(void) { /* obsolete */ }
...
unsigned long ERR_get_error_all(const char **file, int *line, const char **func,
                                const char **data, int *flags) {
...
void ossl_err_string_int(unsigned long e, const char *func, char *buf,
                         size_t len) {
...
#ifndef OPENSSL_NO_DEPRECATED_3_0
const char *ERR_func_error_string(unsigned long e) { return NULL; }
#endif
...
#ifndef OPENSSL_NO_DEPRECATED_3_0
ERR_STATE *ERR_get_state(void) { return ossl_err_get_state_int(); }
#endif
...
void err_clear_last_constant_time(int clear) {
   ...
   */
  clear =
  constant_time_select_int(constant_time_eq_int(clear, 0), 0, ERR_FLAG_CLEAR);
