...
static const ASN1_OBJECT nid_objs[NUM_NID] = {
    ...
    {"dhSinglePass-stdDH-sha1kdf-scheme", "dhSinglePass-stdDH-sha1kdf-scheme", NID_dhSinglePass_stdDH_sha1kdf_scheme, 9,
     &so[6135]},
    ...
    {"id-tc26-hmac-gost-3411-2012-256", "HMAC GOST 34.11-2012 256 bit", NID_id_tc26_hmac_gost_3411_2012_256, 8,
     &so[6466]},
    {"id-tc26-hmac-gost-3411-2012-512", "HMAC GOST 34.11-2012 512 bit", NID_id_tc26_hmac_gost_3411_2012_512, 8,
     &so[6474]},
    ...
    {"id-smime-ct-contentCollection", "id-smime-ct-contentCollection", NID_id_smime_ct_contentCollection, 11,
     &so[6747]},
    {"id-smime-ct-authEnvelopedData", "id-smime-ct-authEnvelopedData", NID_id_smime_ct_authEnvelopedData, 11,
     &so[6758]},
    ...
    {"id-smime-aa-signingCertificateV2", "id-smime-aa-signingCertificateV2", NID_id_smime_aa_signingCertificateV2, 11,
     &so[6915]},
    ...
    {"id-tc26-wrap-gostr3412-2015-magma", "id-tc26-wrap-gostr3412-2015-magma", NID_id_tc26_wrap_gostr3412_2015_magma, 8,
     &so[7684]},
    ...
    {"id-aa-ets-attrCertificateRefs", "id-aa-ets-attrCertificateRefs", NID_id_aa_ets_attrCertificateRefs, 11,
     &so[8185]},
    ...
    {"id-aa-ets-SignaturePolicyDocument", "id-aa-ets-SignaturePolicyDocument", NID_id_aa_ets_SignaturePolicyDocument, 6,
     &so[8240]},
    ...
    {"authorityAttributeIdentifier", "X509v3 Authority Attribute Identifier", NID_authority_attribute_identifier, 3,
     &so[8400]},
    {"roleSpecCertIdentifier", "X509v3 Role Specification Certificate Identifier", NID_role_spec_cert_identifier, 3,
     &so[8403]},
    ...
    {"allowedAttributeAssignments", "X509v3 Allowed Attribute Assignments", NID_allowed_attribute_assignments, 3,
     &so[8448]},
    ...
    {"subjectAltPublicKeyInfo", "X509v3 Subject Alternative Public Key Info", NID_subject_alt_public_key_info, 3,
     &so[8463]},
    ...
    {"tcg-at-platformManufacturerStr", "TCG Platform Manufacturer String", NID_tcg_at_platformManufacturerStr, 6,
     &so[8555]},
    ...
    {"tcg-at-tcgPlatformSpecification", "TPM Platform Specification", NID_tcg_at_tcgPlatformSpecification, 5,
     &so[8653]},
    ...
    {"tcg-at-tcgCredentialSpecification", "TCG Credential Specification", NID_tcg_at_tcgCredentialSpecification, 5,
     &so[8668]},
    ...
    {"tcg-at-tbbSecurityAssertions-v3", "TCG TBB Security Assertions V3", NID_tcg_at_tbbSecurityAssertions_v3, 5,
     &so[8683]},
    {"tcg-at-cryptographicAnchors", "TCG Cryptographic Anchors", NID_tcg_at_cryptographicAnchors, 5, &so[8688]},
    {"tcg-at-platformConfiguration-v1", "Platform Configuration Version 1", NID_tcg_at_platformConfiguration_v1, 7,
     &so[8693]},
    {"tcg-at-platformConfiguration-v2", "Platform Configuration Version 2", NID_tcg_at_platformConfiguration_v2, 7,
     &so[8700]},
    {"tcg-at-platformConfiguration-v3", "Platform Configuration Version 3", NID_tcg_at_platformConfiguration_v3, 7,
     &so[8707]},
    {"tcg-at-platformConfigUri-v3", "Platform Configuration URI Version 3", NID_tcg_at_platformConfigUri_v3, 7,
     &so[8714]},
    ...
    {"tcg-kp-PlatformAttributeCertificate", "Platform Attribute Certificate", NID_tcg_kp_PlatformAttributeCertificate,
     5, &so[8731]},
    ...
    {"tcg-kp-DeltaPlatformAttributeCertificate", "Delta Platform Attribute Certificate",
     NID_tcg_kp_DeltaPlatformAttributeCertificate, 5, &so[8746]},
    {"tcg-kp-DeltaPlatformKeyCertificate", "Delta Platform Key Certificate", NID_tcg_kp_DeltaPlatformKeyCertificate, 5,
     &so[8751]},
    {"tcg-kp-AdditionalPlatformAttributeCertificate", "Additional Platform Attribute Certificate",
     NID_tcg_kp_AdditionalPlatformAttributeCertificate, 5, &so[8756]},
    {"tcg-kp-AdditionalPlatformKeyCertificate", "Additional Platform Key Certificate",
    ...
    {"tcg-ce-virtualPlatformAttestationService", "Virtual Platform Attestation Service",
     NID_tcg_ce_virtualPlatformAttestationService, 5, &so[8776]},
    {"tcg-ce-migrationControllerAttestationService", "Migration Controller Attestation Service",
     NID_tcg_ce_migrationControllerAttestationService, 5, &so[8781]},
    {"tcg-ce-migrationControllerRegistrationService", "Migration Controller Registration Service",
     NID_tcg_ce_migrationControllerRegistrationService, 5, &so[8786]},
    {"tcg-ce-virtualPlatformBackupService", "Virtual Platform Backup Service", NID_tcg_ce_virtualPlatformBackupService,
     5, &so[8791]},
    ...
    {"tcg-registry-componentClass-tcg", "Trusted Computed Group Registry", NID_tcg_registry_componentClass_tcg, 6,
     &so[8821]},
    {"tcg-registry-componentClass-ietf", "Internet Engineering Task Force Registry",
     NID_tcg_registry_componentClass_ietf, 6, &so[8827]},
    {"tcg-registry-componentClass-dmtf", "Distributed Management Task Force Registry",
    ...
    {"tcg-cap-verifiedPlatformCertificate", "TCG Verified Platform Certificate CA Policy",
    ...
    {"tcg-tr-ID-CertificateIdentifier", "Certificate Identifier Trait", NID_tcg_tr_ID_CertificateIdentifier, 6,
     &so[8877]},
    ...
    {"tcg-tr-ID-componentIdentifierV11", "Component Identifier V1.1 Trait", NID_tcg_tr_ID_componentIdentifierV11, 6,
     &so[8895]},
    ...
    {"tcg-tr-ID-platformFirmwareCapabilities", "Platform Firmware Capabilities Trait",
     NID_tcg_tr_ID_platformFirmwareCapabilities, 6, &so[8931]},
    {"tcg-tr-ID-platformFirmwareSignatureVerification", "Platform Firmware Signature Verification Trait",
     NID_tcg_tr_ID_platformFirmwareSignatureVerification, 6, &so[8937]},
    {"tcg-tr-ID-platformFirmwareUpdateCompliance", "Platform Firmware Update Compliance Trait",
     NID_tcg_tr_ID_platformFirmwareUpdateCompliance, 6, &so[8943]},
    {"tcg-tr-ID-platformHardwareCapabilities", "Platform Hardware Capabilities Trait",
    ...
    {"tcg-tr-cat-platformManufacturer", "Platform Manufacturer Trait Category", NID_tcg_tr_cat_platformManufacturer, 6,
     &so[8997]},
    ...
    {"tcg-tr-cat-platformManufacturerIdentifier", "Platform Manufacturer Identifier Trait Category",
     NID_tcg_tr_cat_platformManufacturerIdentifier, 6, &so[9021]},
    {"tcg-tr-cat-platformOwnership", "Platform Ownership Trait Category", NID_tcg_tr_cat_platformOwnership, 6,
     &so[9027]},
    {"tcg-tr-cat-componentClass", "Component Class Trait Category", NID_tcg_tr_cat_componentClass, 6, &so[9033]},
    {"tcg-tr-cat-componentManufacturer", "Component Manufacturer Trait Category", NID_tcg_tr_cat_componentManufacturer,
     6, &so[9039]},
    ...
    {"tcg-tr-cat-componentLocation", "Component Location Trait Category", NID_tcg_tr_cat_componentLocation, 6,
     &so[9063]},
    {"tcg-tr-cat-componentRevision", "Component Revision Trait Category", NID_tcg_tr_cat_componentRevision, 6,
     &so[9069]},
    {"tcg-tr-cat-componentFieldReplaceable", "Component Field Replaceable Trait Category",
    ...
    {"tcg-tr-cat-IDevIDCertificate", "IDevID Certificate Trait Category", NID_tcg_tr_cat_IDevIDCertificate, 6,
     &so[9093]},
    ...
    {"tcg-tr-cat-PlatformCertificate", "Platform Certificate Trait Category", NID_tcg_tr_cat_PlatformCertificate, 6,
     &so[9117]},
    {"tcg-tr-cat-DeltaPlatformCertificate", "Delta Platform Certificate Trait Category",
     NID_tcg_tr_cat_DeltaPlatformCertificate, 6, &so[9123]},
    {"tcg-tr-cat-RebasePlatformCertificate", "Rebase Platform Certificate Trait Category",
     NID_tcg_tr_cat_RebasePlatformCertificate, 6, &so[9129]},
    {"tcg-tr-cat-genericCertificate", "Generic Certificate Trait Category", NID_tcg_tr_cat_genericCertificate, 6,
     &so[9135]},
    {"tcg-tr-cat-CommonCriteria", "Common Criteria Trait Category", NID_tcg_tr_cat_CommonCriteria, 6, &so[9141]},
    {"tcg-tr-cat-componentIdentifierV11", "Component Identifier V1.1 Trait Category",
    ...
    {"tcg-tr-cat-attestationProtocol", "Attestation Protocol Trait Category", NID_tcg_tr_cat_attestationProtocol, 6,
     &so[9171]},
    {"tcg-tr-cat-PEN", "Private Enterprise Number Trait Category", NID_tcg_tr_cat_PEN, 6, &so[9177]},
    {"tcg-tr-cat-platformFirmwareCapabilities", "Platform Firmware Capabilities Trait Category",
     NID_tcg_tr_cat_platformFirmwareCapabilities, 6, &so[9183]},
    {"tcg-tr-cat-platformHardwareCapabilities", "Platform Hardware Capabilities Trait Category",
     NID_tcg_tr_cat_platformHardwareCapabilities, 6, &so[9189]},
    {"tcg-tr-cat-platformFirmwareSignatureVerification", "Platform Firmware Signature Verification Trait Category",
     NID_tcg_tr_cat_platformFirmwareSignatureVerification, 6, &so[9195]},
    {"tcg-tr-cat-platformFirmwareUpdateCompliance", "Platform Firmware Update Compliance Trait Category",
    ...
    {"id-hash-slh-dsa-sha2-128s-with-sha256", "SLH-DSA-SHA2-128s-WITH-SHA256", NID_SLH_DSA_SHA2_128s_WITH_SHA256, 9,
     &so[9408]},
    {"id-hash-slh-dsa-sha2-128f-with-sha256", "SLH-DSA-SHA2-128f-WITH-SHA256", NID_SLH_DSA_SHA2_128f_WITH_SHA256, 9,
     &so[9417]},
    {"id-hash-slh-dsa-sha2-192s-with-sha512", "SLH-DSA-SHA2-192s-WITH-SHA512", NID_SLH_DSA_SHA2_192s_WITH_SHA512, 9,
     &so[9426]},
    {"id-hash-slh-dsa-sha2-192f-with-sha512", "SLH-DSA-SHA2-192f-WITH-SHA512", NID_SLH_DSA_SHA2_192f_WITH_SHA512, 9,
     &so[9435]},
    {"id-hash-slh-dsa-sha2-256s-with-sha512", "SLH-DSA-SHA2-256s-WITH-SHA512", NID_SLH_DSA_SHA2_256s_WITH_SHA512, 9,
     &so[9444]},
    {"id-hash-slh-dsa-sha2-256f-with-sha512", "SLH-DSA-SHA2-256f-WITH-SHA512", NID_SLH_DSA_SHA2_256f_WITH_SHA512, 9,
     &so[9453]},
