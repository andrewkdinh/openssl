...
const BIO_METHOD *BIO_f_readbuffer(void) { return &methods_readbuffer; }
...
static int readbuffer_write(BIO *b, const char *in, int inl) { return 0; }
static int readbuffer_puts(BIO *b, const char *str) { return 0; }
