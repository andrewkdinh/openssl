...
static int addr_strings(const BIO_ADDR *ap, int numeric, char **hostname,
  ...
  if (1) {
    ...
    if ((ret = getnameinfo(BIO_ADDR_sockaddr(ap), BIO_ADDR_sockaddr_size(ap),
...
#pragma pointer_size 32
    ...
    static const char *he_fallback_addresses[] = {(char *)&he_fallback_address,
                                                  NULL};
#else
    ...
    static const char *he_fallback_addresses[] = {(char *)&he_fallback_address,
                                                  NULL};
#endif
    static const struct hostent he_fallback = {NULL, NULL, AF_INET,
...
#pragma pointer_size restore
      ...
      for (addresses = addrlistp - he->h_addr_list;
        ...
        if (!addrinfo_wrap(he->h_addrtype, socktype, *addrlistp, he->h_length,
                           se->s_port, &tmp_bai))
