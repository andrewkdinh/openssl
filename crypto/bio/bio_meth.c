...
int BIO_meth_set_sendmmsg(BIO_METHOD *biom, int (*bsendmmsg)(BIO *, BIO_MSG *, size_t, size_t, uint64_t, size_t *))
{
...
int BIO_meth_set_recvmmsg(BIO_METHOD *biom, int (*brecvmmsg)(BIO *, BIO_MSG *, size_t, size_t, uint64_t, size_t *))
{
