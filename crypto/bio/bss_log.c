...
NULL,                                                 /* slg_read,         */
slg_puts,     NULL,     slg_ctrl,    slg_new,   slg_free,
NULL, /* slg_callback_ctrl */
};

const BIO_METHOD *BIO_s_log(void) { return &methods_slg; }
...
static void xopenlog(BIO *bp, char *name, int level) { VMS_OPC_target = level; }
...
static void xcloselog(BIO *bp) { closelog(); }
