...
_ossl_get_avail_threads(OSSL_LIB_CTX_THREADS *tdata) {
...
ossl_inline uint64_t ossl_get_avail_threads(OSSL_LIB_CTX *ctx) { return 0; }
...
int ossl_crypto_thread_clean(void *vhandle) { return 0; }
