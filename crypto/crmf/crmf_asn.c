...
{ASN1_SIMPLE(OSSL_CRMF_PRIVATEKEYINFO, version, ASN1_INTEGER),
 ...
 ASN1_IMP_SET_OF_OPT(OSSL_CRMF_PRIVATEKEYINFO, attributes, X509_ATTRIBUTE,
                     0)} ASN1_SEQUENCE_END(OSSL_CRMF_PRIVATEKEYINFO)
...
{ASN1_SIMPLE(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER, value.string, ASN1_UTF8STRING),
 ASN1_SIMPLE(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER, value.generalName,
             GENERAL_NAME)} ASN1_CHOICE_END(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER)
...
{ASN1_SIMPLE(OSSL_CRMF_ENCKEYWITHID, privateKey, OSSL_CRMF_PRIVATEKEYINFO),
 ASN1_OPT(
 OSSL_CRMF_ENCKEYWITHID, identifier,
 OSSL_CRMF_ENCKEYWITHID_IDENTIFIER)} ASN1_SEQUENCE_END(OSSL_CRMF_ENCKEYWITHID)
...
{ASN1_SIMPLE(OSSL_CRMF_CERTID, issuer, GENERAL_NAME),
 ASN1_SIMPLE(OSSL_CRMF_CERTID, serialNumber,
             ASN1_INTEGER)} ASN1_SEQUENCE_END(OSSL_CRMF_CERTID)
...
{ASN1_IMP_OPT(OSSL_CRMF_ENCRYPTEDVALUE, intendedAlg, X509_ALGOR, 0),
 ...
 ASN1_SIMPLE(OSSL_CRMF_ENCRYPTEDVALUE, encValue,
             ASN1_BIT_STRING)} ASN1_SEQUENCE_END(OSSL_CRMF_ENCRYPTEDVALUE)
...
{
ASN1_SIMPLE(OSSL_CRMF_ENCRYPTEDKEY, value.encryptedValue,
...
{ASN1_SIMPLE(OSSL_CRMF_SINGLEPUBINFO, pubMethod, ASN1_INTEGER),
 ASN1_SIMPLE(OSSL_CRMF_SINGLEPUBINFO, pubLocation,
             GENERAL_NAME)} ASN1_SEQUENCE_END(OSSL_CRMF_SINGLEPUBINFO)
...
{ASN1_SIMPLE(OSSL_CRMF_PKIPUBLICATIONINFO, action, ASN1_INTEGER),
 ...
 OSSL_CRMF_PKIPUBLICATIONINFO, pubInfos,
 OSSL_CRMF_SINGLEPUBINFO)} ASN1_SEQUENCE_END(OSSL_CRMF_PKIPUBLICATIONINFO)
...
{ASN1_SIMPLE(OSSL_CRMF_PKMACVALUE, algId, X509_ALGOR),
 ASN1_SIMPLE(OSSL_CRMF_PKMACVALUE, value,
             ASN1_BIT_STRING)} ASN1_SEQUENCE_END(OSSL_CRMF_PKMACVALUE)
...
{ASN1_SIMPLE(OSSL_CRMF_PBMPARAMETER, salt, ASN1_OCTET_STRING),
 ...
 ASN1_SIMPLE(OSSL_CRMF_PBMPARAMETER, mac,
             X509_ALGOR)} ASN1_SEQUENCE_END(OSSL_CRMF_PBMPARAMETER)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CRMF_PBMPARAMETER)

ASN1_CHOICE(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO) =
{
ASN1_EXP(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO, value.sender, GENERAL_NAME, 0),
ASN1_SIMPLE(
OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO, value.publicKeyMAC,
OSSL_CRMF_PKMACVALUE)} ASN1_CHOICE_END(OSSL_CRMF_POPOSIGNINGKEYINPUT_AUTHINFO)
...
{ASN1_SIMPLE(OSSL_CRMF_POPOSIGNINGKEYINPUT, authInfo,
 ...
 ASN1_SIMPLE(OSSL_CRMF_POPOSIGNINGKEYINPUT, publicKey,
             X509_PUBKEY)} ASN1_SEQUENCE_END(OSSL_CRMF_POPOSIGNINGKEYINPUT)
...
{ASN1_IMP_OPT(OSSL_CRMF_POPOSIGNINGKEY, poposkInput,
 ...
 ASN1_SIMPLE(OSSL_CRMF_POPOSIGNINGKEY, signature,
             ASN1_BIT_STRING)} ASN1_SEQUENCE_END(OSSL_CRMF_POPOSIGNINGKEY)
...
{ASN1_IMP(OSSL_CRMF_POPO, value.raVerified, ASN1_NULL, 0),
 ...
 ASN1_EXP(OSSL_CRMF_POPO, value.keyAgreement, OSSL_CRMF_POPOPRIVKEY,
...
ADB_ENTRY(NID_id_regCtrl_authenticator,
          ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE, value.authenticator,
                      ASN1_UTF8STRING)),
...
ADB_ENTRY(NID_id_regCtrl_oldCertID,
          ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE, value.oldCertID,
                      OSSL_CRMF_CERTID)),
ADB_ENTRY(NID_id_regCtrl_protocolEncrKey,
          ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE, value.protocolEncrKey,
                      X509_PUBKEY)),
ADB_ENTRY(NID_id_regCtrl_algId, ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE,
                                            value.algId, X509_ALGOR)),
ADB_ENTRY(NID_id_regCtrl_rsaKeyLen, ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE,
...
ADB_ENTRY(NID_id_regInfo_certReq,
          ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE, value.certReq,
...
{ASN1_EXP_OPT(OSSL_CRMF_OPTIONALVALIDITY, notBefore, ASN1_TIME, 0),
 ASN1_EXP_OPT(OSSL_CRMF_OPTIONALVALIDITY, notAfter, ASN1_TIME,
...
ASN1_IMP_OPT(OSSL_CRMF_CERTTEMPLATE, validity, OSSL_CRMF_OPTIONALVALIDITY, 4),
...
ASN1_IMP_SEQUENCE_OF_OPT(OSSL_CRMF_CERTTEMPLATE, extensions, X509_EXTENSION, 9),
...
ASN1_ITEM_TEMPLATE_END(OSSL_CRMF_MSGS) IMPLEMENT_ASN1_FUNCTIONS(OSSL_CRMF_MSGS)
