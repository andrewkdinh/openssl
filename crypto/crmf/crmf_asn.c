...
ASN1_CHOICE(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER)
    = {ASN1_SIMPLE(OSSL_CRMF_ENCKEYWITHID_IDENTIFIER, value.string,
                   ASN1_UTF8STRING),
...
ASN1_SEQUENCE(OSSL_CRMF_ENCKEYWITHID)
    = {ASN1_SIMPLE(OSSL_CRMF_ENCKEYWITHID, privateKey,
...
ASN1_CHOICE(OSSL_CRMF_ENCRYPTEDKEY)
    = {
        ...
        ASN1_IMP(OSSL_CRMF_ENCRYPTEDKEY, value.envelopedData, CMS_EnvelopedData,
                 0),
#endif
    }
...
ASN1_CHOICE(OSSL_CRMF_POPOPRIVKEY)
    = {
        ...
        ASN1_IMP(OSSL_CRMF_POPOPRIVKEY, value.subsequentMessage, ASN1_INTEGER,
                 1),
        ASN1_IMP(OSSL_CRMF_POPOPRIVKEY, value.dhMAC, ASN1_BIT_STRING, 2),
        ASN1_IMP(OSSL_CRMF_POPOPRIVKEY, value.agreeMAC, OSSL_CRMF_PKMACVALUE,
                 3),
...
ASN1_CHOICE(OSSL_CRMF_POPO)
    = {ASN1_IMP(OSSL_CRMF_POPO, value.raVerified, ASN1_NULL, 0),
       ...
       ASN1_EXP(OSSL_CRMF_POPO, value.keyEncipherment, OSSL_CRMF_POPOPRIVKEY,
                2),
...
ASN1_ADB(OSSL_CRMF_ATTRIBUTETYPEANDVALUE) = {
    ...
    ADB_ENTRY(NID_id_regCtrl_algId,
              ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE, value.algId,
                          X509_ALGOR)),
    ADB_ENTRY(NID_id_regCtrl_rsaKeyLen,
              ASN1_SIMPLE(OSSL_CRMF_ATTRIBUTETYPEANDVALUE, value.rsaKeyLen,
                          ASN1_INTEGER)),
