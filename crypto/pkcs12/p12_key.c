...
int PKCS12_key_gen_asc_ex(const char *pass, int passlen, unsigned char *salt,
  ...
  ret = PKCS12_key_gen_uni_ex(unipass, uniplen, salt, saltlen, id, iter, n, out,
                              md_type, ctx, propq);
...
int PKCS12_key_gen_asc(const char *pass, int passlen, unsigned char *salt,
  ...
  return PKCS12_key_gen_asc_ex(pass, passlen, salt, saltlen, id, iter, n, out,
                               md_type, NULL, NULL);
}
...
int PKCS12_key_gen_utf8(const char *pass, int passlen, unsigned char *salt,
                        int saltlen, int id, int iter, int n,
                        unsigned char *out, const EVP_MD *md_type) {
  return PKCS12_key_gen_utf8_ex(pass, passlen, salt, saltlen, id, iter, n, out,
                                md_type, NULL, NULL);
}
...
int PKCS12_key_gen_uni_ex(unsigned char *pass, int passlen, unsigned char *salt,
  ...
  *p++ = OSSL_PARAM_construct_utf8_string(OSSL_KDF_PARAM_DIGEST,
                                          (char *)EVP_MD_get0_name(md_type), 0);
  *p++ =
  OSSL_PARAM_construct_octet_string(OSSL_KDF_PARAM_PASSWORD, pass, passlen);
