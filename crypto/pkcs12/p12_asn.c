...
ASN1_SEQUENCE(PKCS12) = {ASN1_SIMPLE(PKCS12, version, ASN1_INTEGER),
                        ...
                        IMPLEMENT_ASN1_ENCODE_FUNCTIONS_fname(PKCS12, PKCS12,
                                                              PKCS12)
...
ASN1_SEQUENCE(
PKCS12_MAC_DATA) = {ASN1_SIMPLE(PKCS12_MAC_DATA, dinfo, X509_SIG),
...
ADB_ENTRY(NID_safeContentsBag,
          ASN1_EXP_SEQUENCE_OF(PKCS12_SAFEBAG, value.safes, PKCS12_SAFEBAG, 0)),
ADB_ENTRY(NID_certBag, ASN1_EXP(PKCS12_SAFEBAG, value.bag, PKCS12_BAGS, 0)),
ADB_ENTRY(NID_crlBag, ASN1_EXP(PKCS12_SAFEBAG, value.bag, PKCS12_BAGS, 0)),
ADB_ENTRY(NID_secretBag, ASN1_EXP(PKCS12_SAFEBAG, value.bag, PKCS12_BAGS,
