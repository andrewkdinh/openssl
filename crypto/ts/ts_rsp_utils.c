...
TS_STATUS_INFO *TS_RESP_get_status_info(TS_RESP *a) { return a->status_info; }
...
PKCS7 *TS_RESP_get_token(TS_RESP *a) { return a->token; }

TS_TST_INFO *TS_RESP_get_tst_info(TS_RESP *a) { return a->tst_info; }
...
ASN1_OBJECT *TS_TST_INFO_get_policy_id(TS_TST_INFO *a) { return a->policy_id; }
...
TS_ACCURACY *TS_TST_INFO_get_accuracy(TS_TST_INFO *a) { return a->accuracy; }
