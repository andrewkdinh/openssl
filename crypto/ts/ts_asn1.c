    ...
    ASN1_SEQUENCE(TS_REQ)
        ...
        ASN1_SEQUENCE(TS_ACCURACY)
            ...
            ASN1_SEQUENCE(TS_TST_INFO)
                ...
                {
                    return ASN1_d2i_bio_of(TS_TST_INFO, TS_TST_INFO_new,
                                           d2i_TS_TST_INFO, bp, a);
                }
                ...
                {
                    return ASN1_d2i_fp_of(TS_TST_INFO, TS_TST_INFO_new,
                                          d2i_TS_TST_INFO, fp, a);
                }
                ...
                ASN1_SEQUENCE(TS_STATUS_INFO)
                    ...
                    static int ts_resp_cb(int op, ASN1_VALUE **pval,
                    ...
                    {
                        return ASN1_d2i_bio_of(TS_RESP, TS_RESP_new,
                                               d2i_TS_RESP, bp, a);
                    }
                    ...
                    {
                        return ASN1_d2i_fp_of(TS_RESP, TS_RESP_new, d2i_TS_RESP,
                                              fp, a);
                    }
