...
static int i2r_NO_REV_AVAIL(X509V3_EXT_METHOD *method, void *su, BIO *out,
                            int indent) {
  return 1;
}

static void *r2i_NO_REV_AVAIL(X509V3_EXT_METHOD *method, X509V3_CTX *ctx,
                              const char *value) {
...
static void *s2i_NO_REV_AVAIL(const X509V3_EXT_METHOD *method, X509V3_CTX *ctx,
                              const char *str) {
  return ASN1_NULL_new();
}
