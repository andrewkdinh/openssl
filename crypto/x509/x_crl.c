...
ASN1_SEQUENCE_enc(X509_CRL_INFO, enc, crl_inf_cb) =
    {ASN1_OPT(X509_CRL_INFO, version, ASN1_INTEGER),
     ...
     ASN1_EXP_SEQUENCE_OF_OPT(X509_CRL_INFO, extensions, X509_EXTENSION, 0)} ASN1_SEQUENCE_END_enc(X509_CRL_INFO,
                                                                                                   X509_CRL_INFO)
...
ASN1_SEQUENCE_ref(X509_CRL, crl_cb) = {ASN1_EMBED(X509_CRL, crl, X509_CRL_INFO),
                                       ASN1_EMBED(X509_CRL, sig_alg, X509_ALGOR),
                                       ASN1_EMBED(X509_CRL, signature, ASN1_BIT_STRING)} ASN1_SEQUENCE_END_ref(X509_CRL,
                                                                                                               X509_CRL)
