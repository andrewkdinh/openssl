...
ASN1_CHOICE(OSSL_ALLOWED_ATTRIBUTES_CHOICE)
    = {
        ...
        ASN1_IMP(OSSL_ALLOWED_ATTRIBUTES_CHOICE,
                 choice.attributeTypeandValues,
                 X509_ATTRIBUTE,
...
static int
i2r_ALLOWED_ATTRIBUTES_CHOICE(X509V3_EXT_METHOD *method, OSSL_ALLOWED_ATTRIBUTES_CHOICE *a, BIO *out, int indent)
{
...
static int
i2r_ALLOWED_ATTRIBUTES_ITEM(X509V3_EXT_METHOD *method, OSSL_ALLOWED_ATTRIBUTES_ITEM *aai, BIO *out, int indent)
{
    int                             i;
...
static int
i2r_ALLOWED_ATTRIBUTES_SYNTAX(X509V3_EXT_METHOD *method, OSSL_ALLOWED_ATTRIBUTES_SYNTAX *aaa, BIO *out, int indent)
{
    int                           i;
