...
ASN1_CHOICE(OSSL_ALLOWED_ATTRIBUTES_CHOICE)
    = {
        ASN1_IMP(OSSL_ALLOWED_ATTRIBUTES_CHOICE, choice.attributeType, ASN1_OBJECT, OSSL_AAA_ATTRIBUTE_TYPE),
        ASN1_IMP(OSSL_ALLOWED_ATTRIBUTES_CHOICE, choice.attributeTypeandValues, X509_ATTRIBUTE,
...
ASN1_SEQUENCE(OSSL_ALLOWED_ATTRIBUTES_ITEM)
    = {
        ASN1_IMP_SET_OF(OSSL_ALLOWED_ATTRIBUTES_ITEM, attributes, OSSL_ALLOWED_ATTRIBUTES_CHOICE, 0),
...
static int i2r_ALLOWED_ATTRIBUTES_CHOICE(X509V3_EXT_METHOD *method, OSSL_ALLOWED_ATTRIBUTES_CHOICE *a, BIO *out,
                                         int indent)
{
...
static int i2r_ALLOWED_ATTRIBUTES_ITEM(X509V3_EXT_METHOD *method, OSSL_ALLOWED_ATTRIBUTES_ITEM *aai, BIO *out,
                                       int indent)
{
    int i;
...
static int i2r_ALLOWED_ATTRIBUTES_SYNTAX(X509V3_EXT_METHOD *method, OSSL_ALLOWED_ATTRIBUTES_SYNTAX *aaa, BIO *out,
                                         int indent)
{
    int i;
...
const X509V3_EXT_METHOD ossl_v3_allowed_attribute_assignments = {NID_allowed_attribute_assignments,
                                                                 0,
