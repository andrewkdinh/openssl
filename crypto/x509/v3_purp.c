...
{X509_PURPOSE_SSL_CLIENT, X509_TRUST_SSL_CLIENT, 0, check_purpose_ssl_client,
 "SSL client", "sslclient", NULL},
{X509_PURPOSE_SSL_SERVER, X509_TRUST_SSL_SERVER, 0, check_purpose_ssl_server,
...
{X509_PURPOSE_SMIME_ENCRYPT, X509_TRUST_EMAIL, 0, check_purpose_smime_encrypt,
 "S/MIME encryption", "smimeencrypt", NULL},
{X509_PURPOSE_CRL_SIGN, X509_TRUST_COMPAT, 0, check_purpose_crl_sign,
 "CRL signing", "crlsign", NULL},
{X509_PURPOSE_ANY, X509_TRUST_DEFAULT, 0, no_check_purpose, "Any Purpose",
 "any", NULL},
{X509_PURPOSE_OCSP_HELPER, X509_TRUST_COMPAT, 0, check_purpose_ocsp_helper,
 "OCSP helper", "ocsphelper", NULL},
{X509_PURPOSE_TIMESTAMP_SIGN, X509_TRUST_TSA, 0, check_purpose_timestamp_sign,
 "Time Stamp signing", "timestampsign", NULL},
{X509_PURPOSE_CODE_SIGN, X509_TRUST_OBJECT_SIGN, 0, check_purpose_code_sign,
 "Code signing", "codesign", NULL},
};
...
int X509_PURPOSE_set(int *p, int purpose) {
  if (purpose != X509_PURPOSE_DEFAULT_ANY &&
      X509_PURPOSE_get_by_id(purpose) == -1) {
...
static int nid_cmp(const int *a, const int *b) { return *a - *b; }
...
static int check_sig_alg_match(const EVP_PKEY *issuer_key,
                               const X509 *subject) {
  int subj_sig_nid;
...
void X509_set_proxy_pathlen(X509 *x, long l) { x->ex_pcpathlen = l; }
