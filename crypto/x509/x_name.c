...
static int x509_name_ex_print(BIO *out, const ASN1_VALUE **pval, int indent,
...
err:
    ...
    /* Get internal representation of Name */
        ret = ASN1_item_ex_d2i(&intname.a, &p, len,
                               ASN1_ITEM_rptr(X509_NAME_INTERNAL), tag, aclass,
                               opt, ctx);
...
#define ASN1_MASK_CANON \
    ...
    static int i2d_name_canon(
        const STACK_OF(STACK_OF_X509_NAME_ENTRY) *_intname, unsigned char **in)
    {
        int i, len, ltmp;
        const ASN1_VALUE *v;
