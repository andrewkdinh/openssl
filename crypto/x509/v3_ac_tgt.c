...
static int i2r_OBJECT_DIGEST_INFO(X509V3_EXT_METHOD *method, OSSL_OBJECT_DIGEST_INFO *odi, BIO *out, int indent);
static int i2r_TARGET_CERT(X509V3_EXT_METHOD *method, OSSL_TARGET_CERT *tc, BIO *out, int indent);
static int i2r_TARGET(X509V3_EXT_METHOD *method, OSSL_TARGET *target, BIO *out, int indent);
static int
i2r_TARGETING_INFORMATION(X509V3_EXT_METHOD *method, OSSL_TARGETING_INFORMATION *tinfo, BIO *out, int indent);
...
static int i2r_TARGETING_INFORMATION(X509V3_EXT_METHOD *method, OSSL_TARGETING_INFORMATION *tinfo, BIO *out, int indent)
{
    int           i;
...
const X509V3_EXT_METHOD ossl_v3_targeting_information = {NID_target_information,
                                                         0,
