...
static int t_fromb64(unsigned char *a, size_t alen, const char *src)
{
    ...
    if (padsize != 0 && EVP_DecodeUpdate(ctx, a, &outl, pad, (int)padsize) < 0) {
        outl = -1;
        goto err;
    }
 ...
 */
char *SRP_create_verifier_ex(const char   *user,
                             const char   *pass,
                             char        **salt,
                             char        **verifier,
                             const char   *N,
...
char *
SRP_create_verifier(const char *user, const char *pass, char **salt, char **verifier, const char *N, const char *g)
{
 ...
 * BIGNUMS.
 */
int SRP_create_verifier_BN_ex(const char   *user,
                              const char   *pass,
                              BIGNUM      **salt,
                              BIGNUM      **verifier,
                              const BIGNUM *N,
