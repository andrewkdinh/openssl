...
{ASN1_SIMPLE(PBE2PARAM, keyfunc, X509_ALGOR),
 ASN1_SIMPLE(PBE2PARAM, encryption, X509_ALGOR)} ASN1_SEQUENCE_END(PBE2PARAM)
...
{ASN1_SIMPLE(PBMAC1PARAM, keyDerivationFunc, X509_ALGOR),
 ASN1_SIMPLE(PBMAC1PARAM, messageAuthScheme,
             X509_ALGOR)} ASN1_SEQUENCE_END(PBMAC1PARAM)
...
X509_ALGOR
* PKCS5_pbe2_set_iv_ex(const EVP_CIPHER *cipher, int iter, unsigned char *salt,
  ...
  pbe2->keyfunc =
  PKCS5_pbkdf2_set_ex(iter, salt, saltlen, prf_nid, keylen, libctx);
...
X509_ALGOR *PKCS5_pbkdf2_set_ex(int iter, unsigned char *salt, int saltlen,
                                int prf_nid, int keylen, OSSL_LIB_CTX *libctx) {
