                               ...
                               OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    case ASN1_ITYPE_MSTRING:
        ...
        ret = asn1_check_tlen(NULL, &otag, &oclass, NULL, NULL, &p, len, -1, 0,
                              1, ctx);
        if (!ret) {
                                   ...
                                   OSSL_LIB_CTX *libctx, const char *propq)
{
    ...
    if (flags & ASN1_TFLG_SK_MASK) {
        ...
        /* IMPLICIT tagging */
        ret =
            asn1_item_embed_d2i(val, &p, len, ASN1_ITEM_ptr(tt->item), tt->tag,
