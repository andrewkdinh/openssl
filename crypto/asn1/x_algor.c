...
ASN1_SEQUENCE(X509_ALGOR)
    = {ASN1_SIMPLE(X509_ALGOR, algorithm, ASN1_OBJECT), ASN1_OPT(X509_ALGOR, parameter, ASN1_ANY)}
...
IMPLEMENT_ASN1_ENCODE_FUNCTIONS_fname(X509_ALGORS, X509_ALGORS, X509_ALGORS) IMPLEMENT_ASN1_DUP_FUNCTION(X509_ALGOR)
    ...
    int X509_ALGOR_set0(X509_ALGOR *alg, ASN1_OBJECT *aobj, int ptype, void *pval)
{
    ...
    if (ptype != V_ASN1_UNDEF && alg->parameter == NULL && (alg->parameter = ASN1_TYPE_new()) == NULL)
        return 0;
...
{
    int type = md->flags & EVP_MD_FLAG_DIGALGID_ABSENT ? V_ASN1_UNDEF : V_ASN1_NULL;
