...
int PKCS5_v2_scrypt_keyivgen_ex(EVP_CIPHER_CTX *ctx, const char *pass,
  ...
  if (ASN1_INTEGER_get_uint64(&N, sparam->costParameter) == 0 ||
      ...
      EVP_PBE_scrypt_ex(NULL, 0, NULL, 0, N, r, p, 0, NULL, 0, libctx, propq) ==
      0) {
  ...
  if (EVP_PBE_scrypt_ex(pass, passlen, salt, saltlen, N, r, p, 0, key, keylen,
                        libctx, propq) == 0)
    goto err;
...
int PKCS5_v2_scrypt_keyivgen(EVP_CIPHER_CTX *ctx, const char *pass, int passlen,
  ...
  return PKCS5_v2_scrypt_keyivgen_ex(ctx, pass, passlen, param, c, md, en_de,
                                     NULL, NULL);
}
