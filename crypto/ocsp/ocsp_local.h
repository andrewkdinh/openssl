...
#define OCSP_REQUEST_sign(o, pkey, md, libctx, propq)                          \
  ASN1_item_sign_ex(ASN1_ITEM_rptr(OCSP_REQINFO),                              \
                    ...
                    (o)->optionalSignature->signature, &(o)->tbsRequest, NULL, \
                    pkey, md, libctx, propq)

#define OCSP_BASICRESP_sign(o, pkey, md, d, libctx, propq)                     \
  ASN1_item_sign_ex(ASN1_ITEM_rptr(OCSP_RESPDATA), &(o)->signatureAlgorithm,   \
                    NULL, (o)->signature, &(o)->tbsResponseData, NULL, pkey,   \
                    md, libctx, propq)
...
#define OCSP_REQUEST_verify(a, r, libctx, propq)                               \
  ASN1_item_verify_ex(                                                         \
  ASN1_ITEM_rptr(OCSP_REQINFO), &(a)->optionalSignature->signatureAlgorithm,   \
  (a)->optionalSignature->signature, &(a)->tbsRequest, NULL, r, libctx, propq)

#define OCSP_BASICRESP_verify(a, r, libctx, propq)                             \
  ASN1_item_verify_ex(ASN1_ITEM_rptr(OCSP_RESPDATA), &(a)->signatureAlgorithm, \
                      (a)->signature, &(a)->tbsResponseData, NULL, r, libctx,  \
                      propq)
