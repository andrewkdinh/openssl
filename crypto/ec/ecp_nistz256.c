...
static const BN_ULONG ONE[P256_LIMBS] = {TOBN(0x00000000, 0x00000001), TOBN(0xffffffff, 0x00000000),
...
__owur static int ecp_nistz256_windowed_mul(const EC_GROUP *group, P256_POINT *r, const BIGNUM **scalar,
                                            const EC_POINT **point, size_t num, BN_CTX *ctx)
{
    size_t i;
    int j, ret = 0;
    unsigned int idx;
...
static const BN_ULONG def_xG[P256_LIMBS] = {TOBN(0x79e730d4, 0x18a9143c), TOBN(0x75ba95fc, 0x5fedb601),
                                            TOBN(0x79fb732b, 0x77622510), TOBN(0x18905f76, 0xa53755c6)};

static const BN_ULONG def_yG[P256_LIMBS] = {TOBN(0xddf25357, 0xce95560a), TOBN(0x8b4ab8e4, 0xba19e45c),
...
__owur static int ecp_nistz256_set_from_affine(EC_POINT *out, const EC_GROUP *group, const P256_POINT_AFFINE *in,
                                               BN_CTX *ctx)
{
    int ret = 0;

    if ((ret = bn_set_words(out->X, in->X, P256_LIMBS)) && (ret = bn_set_words(out->Y, in->Y, P256_LIMBS))
...
__owur static int ecp_nistz256_points_mul(const EC_GROUP *group, EC_POINT *r, const BIGNUM *scalar, size_t num,
...
__owur static int ecp_nistz256_get_affine(const EC_GROUP *group, const EC_POINT *point, BIGNUM *x, BIGNUM *y,
                                          BN_CTX *ctx)
{
...
#if defined(__x86_64) || defined(__x86_64__) || defined(_M_AMD64) || defined(_M_X64) || defined(__powerpc64__) \
    || defined(_ARCH_PP64) || defined(__aarch64__)
/*
...
static int ecp_nistz256_inv_mod_ord(const EC_GROUP *group, BIGNUM *r, const BIGNUM *x, BN_CTX *ctx)
{
    ...
    static const BN_ULONG RR[P256_LIMBS] = {TOBN(0x83244c95, 0xbe79eea2), TOBN(0x4699799c, 0x49bd6fa6),
...
# else
    ...
    for (i = 0; i < 27; i++) {
        static const struct {
            unsigned char p, i;
        } chain[27] = {{32, i_x32}, {6, i_101111}, {5, i_111},     {4, i_11},  {5, i_1111},   {5, i_10101},
                       {4, i_101},  {3, i_101},    {3, i_101},     {5, i_111}, {9, i_101111}, {6, i_1111},
                       {2, i_1},    {5, i_1},      {6, i_1111},    {5, i_111}, {4, i_111},    {5, i_111},
                       {5, i_101},  {3, i_11},     {10, i_101111}, {2, i_11},  {5, i_11},     {5, i_11},
...
static int ecp_nistz256group_full_init(EC_GROUP *group, const unsigned char *params)
{
    BN_CTX *ctx = NULL;
    ...
    BIGNUM *p = NULL, *a = NULL, *b = NULL, *x = NULL, *y = NULL, *one = NULL, *order = NULL;
    EC_POINT *P = NULL;
    ...
    if (!ossl_bn_mont_ctx_set(mont, p, 256, params + 6 * param_len, param_len, 1, 0))
        goto err;
    ...
    if (ordmont == NULL)
        goto err;
    if (!ossl_bn_mont_ctx_set(ordmont, order, 256, params + 7 * param_len, param_len, lo_order_n, hi_order_n))
        goto err;
