            ...
            if (wNAF_len[i] > (size_t)k) {
                ...
                if (digit) {
                    ...
                    if (r_is_at_infinity) {
                         ...
                         *
                         * The underlying EC_METHOD can optionally implement
                         * this function: ossl_ec_point_blind_coordinates()
                         * returns 0 in case of errors or 1 on success or if
                         * coordinate blinding is not implemented for this
                         * group.
                         */
