...
static int ecdsa_sign_setup(EC_KEY              *eckey,
                            BN_CTX              *ctx_in,
                            BIGNUM             **kinvp,
                            BIGNUM             **rp,
...
ECDSA_SIG *
ossl_ecdsa_sign_sig(const unsigned char *dgst, int dgst_len, const BIGNUM *in_kinv, const BIGNUM *in_r, EC_KEY *eckey)
{
...
int ossl_ecdsa_deterministic_sign(const unsigned char *dgst,
                                  int                  dlen,
                                  unsigned char       *sig,
                                  unsigned int        *siglen,
                                  EC_KEY              *eckey,
...
ECDSA_SIG *ossl_ecdsa_simple_sign_sig(const unsigned char *dgst,
                                      int                  dgst_len,
 ...
 *     -1: error
 */
int ossl_ecdsa_verify(int                  type,
                      const unsigned char *dgst,
                      int                  dgst_len,
