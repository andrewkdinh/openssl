 ...
 * small subgroup.
 */
__owur c448_error_t ossl_x448_int(uint8_t out[X448_PUBLIC_BYTES], const uint8_t base[X448_PUBLIC_BYTES],
 ...
 * scalar (in): The scalar to multiply by.
 */
void ossl_curve448_precomputed_scalarmul(curve448_point_t scaled, const curve448_precomputed_s *base,
