...
static const curve448_scalar_t sc_p = {{{SC_LIMB(0x2378c292ab5844f3ULL), SC_LIMB(0x216cc2728dc58f55ULL),
 ...
 * Must have extra <= 1
 */
static void sc_subx(curve448_scalar_t out, const c448_word_t accum[C448_SCALAR_LIMBS], const curve448_scalar_t sub,
