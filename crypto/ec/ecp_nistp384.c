 ...
 * on constant-time.
 */
static void point_add(felem       x3,
                      felem       y3,
                      felem       z3,
                      const felem x1,
                      const felem y1,
 ...
 */
static void batch_mul(felem                 x_out,
                      felem                 y_out,
                      felem                 z_out,
...
int ossl_ec_GFp_nistp384_group_set_curve(EC_GROUP     *group,
                                         const BIGNUM *p,
                                         const BIGNUM *a,
                                         const BIGNUM *b,
                                         BN_CTX       *ctx)
 ...
 */
int ossl_ec_GFp_nistp384_points_mul(const EC_GROUP *group,
                                    EC_POINT       *r,
                                    const BIGNUM   *scalar,
                                    size_t          num,
