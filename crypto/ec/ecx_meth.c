...
static int pkey_ecd_digestverify25519(EVP_MD_CTX *ctx, const unsigned char *sig,
    ...
    return ossl_ed25519_verify(tbs, tbslen, sig, edkey->pubkey, 0, 0, 0, NULL,
                               0, edkey->libctx, edkey->propq);
}
...
static int s390x_pkey_ecd_digestverify25519(EVP_MD_CTX *ctx,
    ...
    return s390x_kdsa(S390X_EDDSA_VERIFY_ED25519, &param.ed25519, tbs,
                      tbslen) == 0
           ? 1
           : 0;
}
