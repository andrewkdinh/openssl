...
static const felem kPrime = {0x03ffffffffffffff,
                             0x03ffffffffffffff,
                             0x03ffffffffffffff,
                             0x03ffffffffffffff,
                             0x03ffffffffffffff,
...
int ossl_ec_GFp_nistp521_group_set_curve(EC_GROUP     *group,
                                         const BIGNUM *p,
                                         const BIGNUM *a,
                                         const BIGNUM *b,
                                         BN_CTX       *ctx)
 ...
 */
int ossl_ec_GFp_nistp521_points_mul(const EC_GROUP *group,
                                    EC_POINT       *r,
                                    const BIGNUM   *scalar,
                                    size_t          num,
