...
static void (*felem_square_p)(largefelem out,
                              const felem in) = felem_square_wrapper;
static void (*felem_mul_p)(largefelem out, const felem in1,
...
static void felem_mul_wrapper(largefelem out, const felem in1,
                              const felem in2) {
    felem_select();
...
static void point_add(felem x3, felem y3, felem z3, const felem x1,
    ...
    if (points_equal) {
         ...
         * for the scalar, it's possible for the intermediate value to be a
         * small negative multiple of the base point, and for the final signed
         * digit to be the same value. We believe that this only occurs for the
         * scalar 1fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
