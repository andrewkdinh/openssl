 ...
 * smallfelems
 */
static void point_double_small(smallfelem       x_out,
                               smallfelem       y_out,
                               smallfelem       z_out,
                               const smallfelem x_in,
 ...
 * smallfelems
 */
static void point_add_small(smallfelem x3,
                            smallfelem y3,
                            smallfelem z3,
                            smallfelem x1,
                            smallfelem y1,
...
int ossl_ec_GFp_nistp256_group_set_curve(EC_GROUP     *group,
                                         const BIGNUM *p,
                                         const BIGNUM *a,
                                         const BIGNUM *b,
                                         BN_CTX       *ctx)
 ...
 */
int ossl_ec_GFp_nistp256_points_mul(const EC_GROUP *group,
                                    EC_POINT       *r,
                                    const BIGNUM   *scalar,
                                    size_t          num,
    ...
    if (num_points > 0) {
        ...
        for (i = 0; i < num_points; ++i) {
            ...
            if ((p_scalar != NULL) && (p != NULL)) {
                ...
                for (j = 2; j <= 16; ++j) {
                    if (j & 1) {
                        point_add_small(pre_comp[i][j][0],
                                        pre_comp[i][j][1],
                                        pre_comp[i][j][2],
                                        pre_comp[i][1][0],
                                        pre_comp[i][1][1],
...
int ossl_ec_GFp_nistp256_precompute_mult(EC_GROUP *group, BN_CTX *ctx)
{
    ...
    for (i = 0; i < 2; i++) {
        ...
        point_add_small(pre->g_pre_comp[i][6][0],
        ...
        point_add_small(pre->g_pre_comp[i][10][0],
        ...
        point_add_small(pre->g_pre_comp[i][12][0],
         ...
         */
        point_add_small(pre->g_pre_comp[i][14][0],
