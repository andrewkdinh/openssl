...
static int check_name(const OSSL_CMP_CTX *ctx,
                      int                 log_success,
                      const char         *actual_desc,
                      const X509_NAME    *actual_name,
                      const char         *expect_desc,
                      const X509_NAME    *expect_name)
{
    char *str;
 ...
 */
static int check_msg_with_certs(OSSL_CMP_CTX         *ctx,
...
static int check_msg_all_certs(OSSL_CMP_CTX *ctx, const OSSL_CMP_MSG *msg, int mode_3gpp)
{
    ...
    if (ctx->trusted == NULL) {
        ...
        ret                     = check_msg_with_certs(ctx,
                                   trusted,
                                   mode_3gpp ? "self-issued extraCerts" : "certs in trusted store",
                                   msg->extraCerts,
                                   ctx->untrusted,
                                   msg,
                                   mode_3gpp);
 ...
 */
int ossl_cmp_msg_check_update(OSSL_CMP_CTX                   *ctx,
                              const OSSL_CMP_MSG             *msg,
                              ossl_cmp_allow_unprotected_cb_t cb,
                              int                             cb_arg)
{
    ...
    res           = ossl_x509_add_certs_new(&ctx->untrusted,
                                  msg->extraCerts,
