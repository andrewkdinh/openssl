...
ASN1_SEQUENCE(OSSL_CMP_REVANNCONTENT)
    = {
        ...
        ASN1_SIMPLE(OSSL_CMP_REVANNCONTENT, willBeRevokedAt,
...
ASN1_ITEM_TEMPLATE(OSSL_CMP_ATAVS)
    = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_ATAVS,
...
ASN1_SEQUENCE(OSSL_CMP_CERTREQTEMPLATE)
    = {ASN1_SIMPLE(OSSL_CMP_CERTREQTEMPLATE, certTemplate,
...
OSSL_CMP_ITAV *OSSL_CMP_ITAV_new_caCerts(const STACK_OF(X509) *caCerts)
{
    ...
    if (sk_X509_num(caCerts) > 0
        && (itav->infoValue.caCerts =
                sk_X509_deep_copy(caCerts, X509_dup, X509_free))
            == NULL) {
...
int OSSL_CMP_ITAV_get0_caCerts(const OSSL_CMP_ITAV *itav, STACK_OF(X509) **out)
{
    ...
    *out = sk_X509_num(itav->infoValue.caCerts) > 0 ? itav->infoValue.caCerts
                                                    : NULL;
    return 1;
}
                                            ...
                                            const ASN1_TIME *thisUpdate)
{
    ...
    if (dpn != NULL) {
        ...
        if ((crlsource->value.issuer = sk_GENERAL_NAME_deep_copy(
                 issuer, GENERAL_NAME_dup, GENERAL_NAME_free))
            == NULL)
            goto err;
    }
                                              ...
                                              const X509 *cert, int only_DN)
{
    ...
    if (cert != NULL) {
        ...
        idp = X509_CRL_get_ext_d2i(crl, NID_issuing_distribution_point, NULL,
                                   NULL);
...
ASN1_SEQUENCE(OSSL_CMP_REVREPCONTENT)
    = {ASN1_SEQUENCE_OF(OSSL_CMP_REVREPCONTENT, status, OSSL_CMP_PKISI),
       ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_REVREPCONTENT, revCerts,
                                OSSL_CRMF_CERTID, 0),
...
ASN1_ITEM_TEMPLATE(OSSL_CMP_CERTCONFIRMCONTENT)
    = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0,
                            OSSL_CMP_CERTCONFIRMCONTENT, OSSL_CMP_CERTSTATUS)
...
ASN1_ITEM_TEMPLATE(OSSL_CMP_POLLREPCONTENT)
    = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_POLLREPCONTENT,
                            OSSL_CMP_POLLREP)
...
ASN1_SEQUENCE(OSSL_CMP_CERTREPMESSAGE)
    = {
        ...
        ASN1_SEQUENCE_OF(OSSL_CMP_CERTREPMESSAGE, response,
...
ASN1_ITEM_TEMPLATE(OSSL_CMP_CRLANNCONTENT)
    = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_CRLANNCONTENT,
                            X509_CRL)
...
ASN1_CHOICE(OSSL_CMP_PKIBODY)
    = {
        ...
        ASN1_EXP(OSSL_CMP_PKIBODY, value.ckuann, OSSL_CMP_CAKEYUPDANNCONTENT,
                 15),
        ...
        ASN1_EXP(OSSL_CMP_PKIBODY, value.certConf, OSSL_CMP_CERTCONFIRMCONTENT,
                 24),
...
ASN1_SEQUENCE(OSSL_CMP_PKIHEADER)
    = {ASN1_SIMPLE(OSSL_CMP_PKIHEADER, pvno, ASN1_INTEGER),
       ...
       /* OSSL_CMP_PKIFREETEXT is a ASN1_UTF8STRING sequence, so used directly */
       ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_PKIHEADER, freeText, ASN1_UTF8STRING,
                                7),
...
ASN1_SEQUENCE_cb(OSSL_CMP_MSG, ossl_cmp_msg_cb) =
    {ASN1_SIMPLE(OSSL_CMP_MSG, header, OSSL_CMP_PKIHEADER),
     ...
     ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_MSG, extraCerts, X509,
                              1)} ASN1_SEQUENCE_END_cb(OSSL_CMP_MSG,
                                                       OSSL_CMP_MSG)
        IMPLEMENT_ASN1_DUP_FUNCTION(OSSL_CMP_MSG)

            ASN1_ITEM_TEMPLATE(OSSL_CMP_MSGS) = ASN1_EX_TEMPLATE_TYPE(
                ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_MSGS, OSSL_CMP_MSG)
