...
ASN1_OPT(OSSL_CMP_REVANNCONTENT, crlDetails,
         X509_EXTENSIONS)} ASN1_SEQUENCE_END(OSSL_CMP_REVANNCONTENT)
...
{ASN1_OPT(OSSL_CMP_CHALLENGE, owf, X509_ALGOR),
 ...
 ASN1_SIMPLE(OSSL_CMP_CHALLENGE, challenge,
             ASN1_OCTET_STRING)} ASN1_SEQUENCE_END(OSSL_CMP_CHALLENGE)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_CHALLENGE)

ASN1_ITEM_TEMPLATE(OSSL_CMP_POPODECKEYCHALLCONTENT) = ASN1_EX_TEMPLATE_TYPE(
ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_POPODECKEYCHALLCONTENT, OSSL_CMP_CHALLENGE)
ASN1_ITEM_TEMPLATE_END(OSSL_CMP_POPODECKEYCHALLCONTENT)

ASN1_ITEM_TEMPLATE(OSSL_CMP_POPODECKEYRESPCONTENT) = ASN1_EX_TEMPLATE_TYPE(
ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_POPODECKEYRESPCONTENT, ASN1_INTEGER)
...
/* OSSL_CMP_CMPCERTIFICATE is effectively X509 so it is used directly */
ASN1_SIMPLE(OSSL_CMP_CAKEYUPDANNCONTENT, newWithNew,
            X509)} ASN1_SEQUENCE_END(OSSL_CMP_CAKEYUPDANNCONTENT)
...
{ASN1_SIMPLE(OSSL_CMP_ERRORMSGCONTENT, pKIStatusInfo, OSSL_CMP_PKISI),
 ...
 OSSL_CMP_ERRORMSGCONTENT, errorDetails,
 ASN1_UTF8STRING)} ASN1_SEQUENCE_END(OSSL_CMP_ERRORMSGCONTENT)
...
{
/* OSSL_CMP_CMPCERTIFICATE is effectively X509 so it is used directly */
ADB_ENTRY(NID_id_it_caProtEncCert,
          ASN1_OPT(OSSL_CMP_ITAV, infoValue.caProtEncCert, X509)),
ADB_ENTRY(NID_id_it_signKeyPairTypes,
          ASN1_SEQUENCE_OF_OPT(OSSL_CMP_ITAV, infoValue.signKeyPairTypes,
                               X509_ALGOR)),
ADB_ENTRY(NID_id_it_encKeyPairTypes,
          ASN1_SEQUENCE_OF_OPT(OSSL_CMP_ITAV, infoValue.encKeyPairTypes,
                               X509_ALGOR)),
ADB_ENTRY(NID_id_it_preferredSymmAlg,
          ASN1_OPT(OSSL_CMP_ITAV, infoValue.preferredSymmAlg, X509_ALGOR)),
...
ADB_ENTRY(NID_id_it_unsupportedOIDs,
          ASN1_SEQUENCE_OF_OPT(OSSL_CMP_ITAV, infoValue.unsupportedOIDs,
                               ASN1_OBJECT)),
ADB_ENTRY(NID_id_it_keyPairParamReq,
          ASN1_OPT(OSSL_CMP_ITAV, infoValue.keyPairParamReq, ASN1_OBJECT)),
ADB_ENTRY(NID_id_it_keyPairParamRep,
          ASN1_OPT(OSSL_CMP_ITAV, infoValue.keyPairParamRep, X509_ALGOR)),
ADB_ENTRY(NID_id_it_revPassphrase,
          ASN1_OPT(OSSL_CMP_ITAV, infoValue.revPassphrase,
                   OSSL_CRMF_ENCRYPTEDVALUE)),
ADB_ENTRY(NID_id_it_implicitConfirm,
          ASN1_OPT(OSSL_CMP_ITAV, infoValue.implicitConfirm, ASN1_NULL)),
...
ADB_ENTRY(NID_id_it_origPKIMessage,
          ASN1_OPT(OSSL_CMP_ITAV, infoValue.origPKIMessage, OSSL_CMP_MSGS)),
...
ADB_ENTRY(NID_id_it_crls,
          ASN1_SEQUENCE_OF_OPT(
          OSSL_CMP_ITAV, infoValue.crls,
          X509_CRL))} ASN1_ADB_END(OSSL_CMP_ITAV, 0, infoType, 0,
                                   &infotypeandvalue_default_tt, NULL);

ASN1_SEQUENCE(OSSL_CMP_ITAV) =
{ASN1_SIMPLE(OSSL_CMP_ITAV, infoType, ASN1_OBJECT),
 ASN1_ADB_OBJECT(OSSL_CMP_ITAV)} ASN1_SEQUENCE_END(OSSL_CMP_ITAV)
...
ASN1_EXP_OPT(OSSL_CMP_ROOTCAKEYUPDATE, oldWithNew, X509,
             1)} ASN1_SEQUENCE_END(OSSL_CMP_ROOTCAKEYUPDATE)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_ROOTCAKEYUPDATE)

ASN1_ITEM_TEMPLATE(OSSL_CMP_ATAVS) = ASN1_EX_TEMPLATE_TYPE(
ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_ATAVS, OSSL_CRMF_ATTRIBUTETYPEANDVALUE)
ASN1_ITEM_TEMPLATE_END(OSSL_CMP_ATAVS) IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_ATAVS)

ASN1_SEQUENCE(OSSL_CMP_CERTREQTEMPLATE) =
{ASN1_SIMPLE(OSSL_CMP_CERTREQTEMPLATE, certTemplate, OSSL_CRMF_CERTTEMPLATE),
 ASN1_SEQUENCE_OF_OPT(
 OSSL_CMP_CERTREQTEMPLATE, keySpec,
 OSSL_CRMF_ATTRIBUTETYPEANDVALUE)} ASN1_SEQUENCE_END(OSSL_CMP_CERTREQTEMPLATE)
...
{ASN1_SIMPLE(OSSL_CMP_CRLSTATUS, source, OSSL_CMP_CRLSOURCE),
 ASN1_OPT(OSSL_CMP_CRLSTATUS, thisUpdate,
          ASN1_TIME)} ASN1_SEQUENCE_END(OSSL_CMP_CRLSTATUS)
...
OSSL_CMP_ITAV *OSSL_CMP_ITAV_new_caCerts(const STACK_OF(X509) * caCerts) {
  ...
  if (itav == NULL)
    return NULL;
  if (sk_X509_num(caCerts) > 0 && (itav->infoValue.caCerts = sk_X509_deep_copy(
                                   caCerts, X509_dup, X509_free)) == NULL) {
...
int OSSL_CMP_ITAV_get0_caCerts(const OSSL_CMP_ITAV *itav,
                               STACK_OF(X509) * *out) {
  if (itav == NULL || out == NULL) {
    ERR_raise(ERR_LIB_CMP, ERR_R_PASSED_NULL_PARAMETER);
    return 0;
  ...
  *out =
  sk_X509_num(itav->infoValue.caCerts) > 0 ? itav->infoValue.caCerts : NULL;
  return 1;
}
  ...
  if (keySpec != NULL && tpl->keySpec != NULL) {
    ...
    *keySpec = sk_OSSL_CRMF_ATTRIBUTETYPEANDVALUE_new_reserve(NULL, n);
    ...
    for (i = 0; i < n; i++) {
      ...
      if (type == NULL) {
        ERR_raise_data(
        ERR_LIB_CMP, CMP_R_INVALID_KEYSPEC,
        "keySpec with index %d in certReqTemplate does not exist", i);
        goto err;
      }
      nid = OBJ_obj2nid(type);

      if (nid != NID_id_regCtrl_algId && nid != NID_id_regCtrl_rsaKeyLen) {
        name = OBJ_nid2ln(nid);
        if (name == NULL)
          name = OBJ_nid2sn(nid);
        if (name == NULL)
        ...
        ERR_raise_data(
        ERR_LIB_CMP, CMP_R_INVALID_KEYSPEC,
        "keySpec with index %d in certReqTemplate has invalid type %s", i,
        name);
        goto err;
      }
...
OSSL_CMP_ATAV *OSSL_CMP_ATAV_new_algId(const X509_ALGOR *alg) {
  ...
  if ((dup = X509_ALGOR_dup(alg)) == NULL)
    return NULL;
  res =
  OSSL_CMP_ATAV_create(OBJ_nid2obj(NID_id_regCtrl_algId), (ASN1_TYPE *)dup);
  if (res == NULL)
    X509_ALGOR_free(dup);
  return res;
}
...
int OSSL_CMP_ATAV_push1(OSSL_CMP_ATAVS **sk_p, const OSSL_CMP_ATAV *atav) {
  ...
  if ((dup = OSSL_CRMF_ATTRIBUTETYPEANDVALUE_dup(
...
OSSL_CMP_ITAV
*OSSL_CMP_ITAV_new0_crlStatusList(STACK_OF(OSSL_CMP_CRLSTATUS) *
                                  crlStatusList) {
  OSSL_CMP_ITAV *itav;
...
OSSL_CMP_CRLSTATUS *OSSL_CMP_CRLSTATUS_new1(const DIST_POINT_NAME *dpn,
  ...
  if (dpn != NULL) {
    ...
    if ((crlsource->value.issuer = sk_GENERAL_NAME_deep_copy(
         issuer, GENERAL_NAME_dup, GENERAL_NAME_free)) == NULL)
      goto err;
  }
...
OSSL_CMP_CRLSTATUS *OSSL_CMP_CRLSTATUS_create(const X509_CRL *crl,
  ...
  if (cert != NULL) {
    ...
    idp = X509_CRL_get_ext_d2i(crl, NID_issuing_distribution_point, NULL, NULL);
...
int OSSL_CMP_ITAV_get0_crls(const OSSL_CMP_ITAV *itav,
...
ASN1_EXP(OSSL_CMP_CERTORENCCERT, value.encryptedCert, OSSL_CRMF_ENCRYPTEDKEY,
         1),
...
{ASN1_SIMPLE(OSSL_CMP_CERTIFIEDKEYPAIR, certOrEncCert, OSSL_CMP_CERTORENCCERT),
 ASN1_EXP_OPT(OSSL_CMP_CERTIFIEDKEYPAIR, privateKey, OSSL_CRMF_ENCRYPTEDKEY, 0),
 ASN1_EXP_OPT(OSSL_CMP_CERTIFIEDKEYPAIR, publicationInfo,
              OSSL_CRMF_PKIPUBLICATIONINFO,
              1)} ASN1_SEQUENCE_END(OSSL_CMP_CERTIFIEDKEYPAIR)
...
{ASN1_SIMPLE(OSSL_CMP_REVDETAILS, certDetails, OSSL_CRMF_CERTTEMPLATE),
 ASN1_OPT(OSSL_CMP_REVDETAILS, crlEntryDetails,
          X509_EXTENSIONS)} ASN1_SEQUENCE_END(OSSL_CMP_REVDETAILS)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_REVDETAILS)

ASN1_ITEM_TEMPLATE(OSSL_CMP_REVREQCONTENT) = ASN1_EX_TEMPLATE_TYPE(
ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_REVREQCONTENT, OSSL_CMP_REVDETAILS)
...
ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_REVREPCONTENT, revCerts, OSSL_CRMF_CERTID, 0),
ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_REVREPCONTENT, crls, X509_CRL,
                         1)} ASN1_SEQUENCE_END(OSSL_CMP_REVREPCONTENT)
...
{ASN1_SIMPLE(OSSL_CMP_KEYRECREPCONTENT, status, OSSL_CMP_PKISI),
 ...
 ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_KEYRECREPCONTENT, keyPairHist,
                          ...
                          2)} ASN1_SEQUENCE_END(OSSL_CMP_KEYRECREPCONTENT)
...
{ASN1_SIMPLE(OSSL_CMP_PKISI, status, OSSL_CMP_PKISTATUS),
 ...
 ASN1_OPT(OSSL_CMP_PKISI, failInfo,
          ASN1_BIT_STRING)} ASN1_SEQUENCE_END(OSSL_CMP_PKISI)
...
{ASN1_SIMPLE(OSSL_CMP_CERTSTATUS, certHash, ASN1_OCTET_STRING),
 ...
 ASN1_EXP_OPT(OSSL_CMP_CERTSTATUS, hashAlg, X509_ALGOR,
              0)} ASN1_SEQUENCE_END(OSSL_CMP_CERTSTATUS)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_CERTSTATUS)

ASN1_ITEM_TEMPLATE(OSSL_CMP_CERTCONFIRMCONTENT) = ASN1_EX_TEMPLATE_TYPE(
ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_CERTCONFIRMCONTENT, OSSL_CMP_CERTSTATUS)
...
{ASN1_SIMPLE(OSSL_CMP_CERTRESPONSE, certReqId, ASN1_INTEGER),
 ...
 ASN1_OPT(OSSL_CMP_CERTRESPONSE, rspInfo,
          ASN1_OCTET_STRING)} ASN1_SEQUENCE_END(OSSL_CMP_CERTRESPONSE)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_CERTRESPONSE)

ASN1_SEQUENCE(OSSL_CMP_POLLREQ) = {ASN1_SIMPLE(
OSSL_CMP_POLLREQ, certReqId, ASN1_INTEGER)} ASN1_SEQUENCE_END(OSSL_CMP_POLLREQ)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_POLLREQ)

ASN1_ITEM_TEMPLATE(OSSL_CMP_POLLREQCONTENT) = ASN1_EX_TEMPLATE_TYPE(
ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_POLLREQCONTENT, OSSL_CMP_POLLREQ)
...
} ASN1_SEQUENCE_END(OSSL_CMP_POLLREP) IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_POLLREP)

ASN1_ITEM_TEMPLATE(OSSL_CMP_POLLREPCONTENT) = ASN1_EX_TEMPLATE_TYPE(
ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_POLLREPCONTENT, OSSL_CMP_POLLREP)
...
ASN1_SEQUENCE_OF(
OSSL_CMP_CERTREPMESSAGE, response,
OSSL_CMP_CERTRESPONSE)} ASN1_SEQUENCE_END(OSSL_CMP_CERTREPMESSAGE)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_CERTREPMESSAGE)

ASN1_ITEM_TEMPLATE(OSSL_CMP_GENMSGCONTENT) = ASN1_EX_TEMPLATE_TYPE(
ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_GENMSGCONTENT, OSSL_CMP_ITAV)
ASN1_ITEM_TEMPLATE_END(OSSL_CMP_GENMSGCONTENT)

ASN1_ITEM_TEMPLATE(OSSL_CMP_GENREPCONTENT) = ASN1_EX_TEMPLATE_TYPE(
ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_GENREPCONTENT, OSSL_CMP_ITAV)
ASN1_ITEM_TEMPLATE_END(OSSL_CMP_GENREPCONTENT)

ASN1_ITEM_TEMPLATE(OSSL_CMP_CRLANNCONTENT) = ASN1_EX_TEMPLATE_TYPE(
ASN1_TFLG_SEQUENCE_OF, 0, OSSL_CMP_CRLANNCONTENT, X509_CRL)
...
} ASN1_CHOICE_END(OSSL_CMP_PKIBODY) IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_PKIBODY)
...
{ASN1_SIMPLE(OSSL_CMP_PKIHEADER, pvno, ASN1_INTEGER),
 ...
 ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_PKIHEADER, generalInfo, OSSL_CMP_ITAV,
                          8)} ASN1_SEQUENCE_END(OSSL_CMP_PKIHEADER)
...
{ASN1_SIMPLE(OSSL_CMP_MSG, header, OSSL_CMP_PKIHEADER),
 ASN1_SIMPLE(OSSL_CMP_MSG, body,
             OSSL_CMP_PKIBODY)} ASN1_SEQUENCE_END(OSSL_CMP_PROTECTEDPART)
...
{ASN1_SIMPLE(OSSL_CMP_MSG, header, OSSL_CMP_PKIHEADER),
 ...
 /* OSSL_CMP_CMPCERTIFICATE is effectively X509 so it is used directly */
 ASN1_EXP_SEQUENCE_OF_OPT(OSSL_CMP_MSG, extraCerts, X509,
                          1)} ASN1_SEQUENCE_END_cb(OSSL_CMP_MSG, OSSL_CMP_MSG)
IMPLEMENT_ASN1_DUP_FUNCTION(OSSL_CMP_MSG)

ASN1_ITEM_TEMPLATE(OSSL_CMP_MSGS) = ASN1_EX_TEMPLATE_TYPE(ASN1_TFLG_SEQUENCE_OF,
                                                          0, OSSL_CMP_MSGS,
                                                          OSSL_CMP_MSG)
