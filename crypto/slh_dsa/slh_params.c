...
static const SLH_DSA_PARAMS slh_dsa_params[] = {
    ...
    {"SLH-DSA-SHA2-128f", NID_SLH_DSA_SHA2_128f, 0, OSSL_SLH_PARAMS(128F),
     OSSL_SLH_DSA_SHA2_NUM_ZEROS_H_AND_T_BOUND1},
    {"SLH-DSA-SHAKE-128f", NID_SLH_DSA_SHAKE_128f, 1, OSSL_SLH_PARAMS(128F)},
    {"SLH-DSA-SHA2-192s", NID_SLH_DSA_SHA2_192s, 0, OSSL_SLH_PARAMS(192S),
     OSSL_SLH_DSA_SHA2_NUM_ZEROS_H_AND_T_BOUND2},
    {"SLH-DSA-SHAKE-192s", NID_SLH_DSA_SHAKE_192s, 1, OSSL_SLH_PARAMS(192S)},
    {"SLH-DSA-SHA2-192f", NID_SLH_DSA_SHA2_192f, 0, OSSL_SLH_PARAMS(192F),
     OSSL_SLH_DSA_SHA2_NUM_ZEROS_H_AND_T_BOUND2},
    {"SLH-DSA-SHAKE-192f", NID_SLH_DSA_SHAKE_192f, 1, OSSL_SLH_PARAMS(192F)},
    {"SLH-DSA-SHA2-256s", NID_SLH_DSA_SHA2_256s, 0, OSSL_SLH_PARAMS(256S),
     OSSL_SLH_DSA_SHA2_NUM_ZEROS_H_AND_T_BOUND2},
    {"SLH-DSA-SHAKE-256s", NID_SLH_DSA_SHAKE_256s, 1, OSSL_SLH_PARAMS(256S)},
    {"SLH-DSA-SHA2-256f", NID_SLH_DSA_SHA2_256f, 0, OSSL_SLH_PARAMS(256F),
     OSSL_SLH_DSA_SHA2_NUM_ZEROS_H_AND_T_BOUND2},
