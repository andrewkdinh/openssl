...
static int slh_hmsg_shake(SLH_DSA_HASH_CTX *ctx,
                          const uint8_t    *r,
...
static int slh_prf_shake(SLH_DSA_HASH_CTX *ctx,
                         const uint8_t    *pk_seed,
...
static int slh_prf_msg_shake(SLH_DSA_HASH_CTX *ctx,
...
static int slh_f_shake(SLH_DSA_HASH_CTX *ctx,
                       const uint8_t    *pk_seed,
                       const uint8_t    *adrs,
                       const uint8_t    *m1,
                       size_t            m1_len,
...
static int slh_h_shake(SLH_DSA_HASH_CTX *ctx,
                       const uint8_t    *pk_seed,
                       const uint8_t    *adrs,
                       const uint8_t    *m1,
                       const uint8_t    *m2,
...
static int slh_t_shake(SLH_DSA_HASH_CTX *ctx,
                       const uint8_t    *pk_seed,
                       const uint8_t    *adrs,
                       const uint8_t    *ml,
                       size_t            ml_len,
...
static ossl_inline int digest_4(EVP_MD_CTX    *ctx,
                                const uint8_t *in1,
                                size_t         in1_len,
                                const uint8_t *in2,
                                size_t         in2_len,
...
static int slh_hmsg_sha2(SLH_DSA_HASH_CTX *hctx,
                         const uint8_t    *r,
                         const uint8_t    *pk_seed,
                         const uint8_t    *pk_root,
                         const uint8_t    *msg,
...
static int slh_prf_msg_sha2(SLH_DSA_HASH_CTX *hctx,
                            const uint8_t    *sk_prf,
                            const uint8_t    *opt_rand,
                            const uint8_t    *msg,
                            size_t            msg_len,
...
static ossl_inline int do_hash(EVP_MD_CTX    *ctx,
                               size_t         n,
                               const uint8_t *pk_seed,
                               const uint8_t *adrs,
                               const uint8_t *m,
...
static int slh_prf_sha2(SLH_DSA_HASH_CTX *hctx,
                        const uint8_t    *pk_seed,
                        const uint8_t    *sk_seed,
                        const uint8_t    *adrs,
                        uint8_t          *out,
...
static int slh_f_sha2(SLH_DSA_HASH_CTX *hctx,
                      const uint8_t    *pk_seed,
                      const uint8_t    *adrs,
                      const uint8_t    *m1,
                      size_t            m1_len,
...
static int slh_h_sha2(SLH_DSA_HASH_CTX *hctx,
                      const uint8_t    *pk_seed,
                      const uint8_t    *adrs,
                      const uint8_t    *m1,
                      const uint8_t    *m2,
...
static int slh_t_sha2(SLH_DSA_HASH_CTX *hctx,
                      const uint8_t    *pk_seed,
                      const uint8_t    *adrs,
                      const uint8_t    *ml,
                      size_t            ml_len,
