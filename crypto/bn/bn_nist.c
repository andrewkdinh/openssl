...
# endif
    ...
    res = ((*adjust)(c_d, r_d, _nist_p_224[0], BN_NIST_224_TOP) && carry) ? r_d
                                                                          : c_d;
                    ...
                    BN_CTX *ctx)
{
    ...
    res = ((*adjust)(c_d, r_d, _nist_p_256[0], BN_NIST_256_TOP) && carry) ? r_d
                                                                          : c_d;
                    ...
                    BN_CTX *ctx)
{
    ...
    res = ((*adjust)(c_d, r_d, _nist_p_384[0], BN_NIST_384_TOP) && carry) ? r_d
                                                                          : c_d;
