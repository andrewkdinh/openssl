...
void ossl_rsaz_amm52x20_x1_ifma256(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m, BN_ULONG k0);
void ossl_rsaz_amm52x20_x2_ifma256(BN_ULONG *out, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m,
                                   const BN_ULONG k0[2]);
void ossl_extract_multiplier_2x20_win5(BN_ULONG *red_Y, const BN_ULONG *red_table, int red_table_idx1,
                                       int red_table_idx2);

void ossl_rsaz_amm52x30_x1_ifma256(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m, BN_ULONG k0);
void ossl_rsaz_amm52x30_x2_ifma256(BN_ULONG *out, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m,
                                   const BN_ULONG k0[2]);
void ossl_extract_multiplier_2x30_win5(BN_ULONG *red_Y, const BN_ULONG *red_table, int red_table_idx1,
                                       int red_table_idx2);

void ossl_rsaz_amm52x40_x1_ifma256(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m, BN_ULONG k0);
void ossl_rsaz_amm52x40_x2_ifma256(BN_ULONG *out, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m,
                                   const BN_ULONG k0[2]);
void ossl_extract_multiplier_2x40_win5(BN_ULONG *red_Y, const BN_ULONG *red_table, int red_table_idx1,
                                       int red_table_idx2);

void ossl_rsaz_amm52x20_x1_avxifma256(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m,
                                      BN_ULONG k0);
void ossl_rsaz_amm52x20_x2_avxifma256(BN_ULONG *out, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m,
                                      const BN_ULONG k0[2]);
void ossl_extract_multiplier_2x20_win5_avx(BN_ULONG *red_Y, const BN_ULONG *red_table, int red_table_idx1,
                                           int red_table_idx2);

void ossl_rsaz_amm52x30_x1_avxifma256(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m,
                                      BN_ULONG k0);
void ossl_rsaz_amm52x30_x2_avxifma256(BN_ULONG *out, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m,
                                      const BN_ULONG k0[2]);
void ossl_extract_multiplier_2x30_win5_avx(BN_ULONG *red_Y, const BN_ULONG *red_table, int red_table_idx1,
                                           int red_table_idx2);

void ossl_rsaz_amm52x40_x1_avxifma256(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m,
                                      BN_ULONG k0);
void ossl_rsaz_amm52x40_x2_avxifma256(BN_ULONG *out, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m,
                                      const BN_ULONG k0[2]);
void ossl_extract_multiplier_2x40_win5_avx(BN_ULONG *red_Y, const BN_ULONG *red_table, int red_table_idx1,
                                           int red_table_idx2);

typedef void (*AMM)(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m, BN_ULONG k0);

static AMM ossl_rsaz_amm52_x1[] = {
    ossl_rsaz_amm52x20_x1_avxifma256, ossl_rsaz_amm52x20_x1_ifma256,    ossl_rsaz_amm52x30_x1_avxifma256,
    ossl_rsaz_amm52x30_x1_ifma256,    ossl_rsaz_amm52x40_x1_avxifma256, ossl_rsaz_amm52x40_x1_ifma256,
};

typedef void (*DAMM)(BN_ULONG *res, const BN_ULONG *a, const BN_ULONG *b, const BN_ULONG *m, const BN_ULONG k0[2]);

static DAMM ossl_rsaz_amm52_x2[] = {
    ossl_rsaz_amm52x20_x2_avxifma256, ossl_rsaz_amm52x20_x2_ifma256,    ossl_rsaz_amm52x30_x2_avxifma256,
    ossl_rsaz_amm52x30_x2_ifma256,    ossl_rsaz_amm52x40_x2_avxifma256, ossl_rsaz_amm52x40_x2_ifma256,
};

typedef void (*DEXTRACT)(BN_ULONG *res, const BN_ULONG *red_table, int red_table_idx, int tbl_idx);

static DEXTRACT ossl_extract_multiplier_win5[] = {
    ossl_extract_multiplier_2x20_win5_avx, ossl_extract_multiplier_2x20_win5,     ossl_extract_multiplier_2x30_win5_avx,
    ossl_extract_multiplier_2x30_win5,     ossl_extract_multiplier_2x40_win5_avx, ossl_extract_multiplier_2x40_win5,
};

static int RSAZ_mod_exp_x2_ifma256(BN_ULONG *res, const BN_ULONG *base, const BN_ULONG *exp[2], const BN_ULONG *m,
                                   const BN_ULONG *rr, const BN_ULONG k0[2], int modulus_bitsize);
 ...
 */
int ossl_rsaz_mod_exp_avx512_x2(BN_ULONG *res1, const BN_ULONG *base1, const BN_ULONG *exp1, const BN_ULONG *m1,
                                const BN_ULONG *rr1, BN_ULONG k0_1, BN_ULONG *res2, const BN_ULONG *base2,
                                const BN_ULONG *exp2, const BN_ULONG *m2, const BN_ULONG *rr2, BN_ULONG k0_2,
                                int factor_size)
{
    int ret = 0;
    ...
    int storage_len_bytes = 7 * regs_capacity * sizeof(BN_ULONG) + 64 /* alignment */;
    ...
    ret = RSAZ_mod_exp_x2_ifma256(rr1_red, base1_red, exp, m1_red, rr1_red, k0, factor_size);
    if (!ret)
        goto err;
 ...
 * \return (void).
 */
int RSAZ_mod_exp_x2_ifma256(BN_ULONG *out, const BN_ULONG *base, const BN_ULONG *exp[2], const BN_ULONG *m,
                            const BN_ULONG *rr, const BN_ULONG k0[2], int modulus_bitsize)
{
    int ret = 0;
    int idx;
...
# define DAMS(r, a, m, k0) damm((r),(a),(a),(m),(k0))
    ...
    for (idx = 1; idx < (int)((1U << exp_win_size) / 2); idx++) {
        DAMS(&red_table[(2 * idx + 0) * 2 * red_digits], &red_table[(1 * idx) * 2 * red_digits], m, k0);
        damm(&red_table[(2 * idx + 1) * 2 * red_digits], &red_table[(2 * idx) * 2 * red_digits],
    ...
    /* Exponentiation */
    {
        ...
        for (exp_bit_no -= exp_win_size; exp_bit_no >= 0; exp_bit_no -= exp_win_size) {
            /* Extract pre-computed multiplier from the table */
            {
                ...
                extract(&red_X[0 * red_digits], (const BN_ULONG *)red_table, (int)red_table_idx_0,
                        (int)red_table_idx_1);
            }
...
static void from_words52(BN_ULONG *out, int out_bitsize, const BN_ULONG *in)
{
...

    {
        ...
        if (out_bitsize > DIGIT_SIZE) {
            ...
            put_digit(out_str, BITS2WORD8_SIZE(out_bitsize), (in[1] << 4 | in[0] >> 48));
        } else if (out_bitsize) {
