...
int bn_mod_exp_mont_fixed_top(BIGNUM *rr, const BIGNUM *a, const BIGNUM *p,
  ...
  if (t4) {
    typedef int (*bn_pwr5_mont_f)(BN_ULONG *tp, const BN_ULONG *np,
                                  ...
                                  int power, int bits);
    int bn_pwr5_mont_t4_8(BN_ULONG * tp, const BN_ULONG *np, const BN_ULONG *n0,
                          const void *table, int power, int bits);
    ...
    bn_mul_mont_t4_8, bn_mul_mont_t4_16, bn_mul_mont_t4_24, bn_mul_mont_t4_32};
...
int BN_mod_exp_mont_consttime_x2(BIGNUM *rr1, const BIGNUM *a1,
  ...
  if ((ossl_rsaz_avx512ifma_eligible() || ossl_rsaz_avxifma_eligible()) &&
    ...
    ret = ossl_rsaz_mod_exp_avx512_x2(rr1->d, a1->d, p1->d, m1->d, mont1->RR.d,
                                      mont1->n0[0], rr2->d, a2->d, p2->d, m2->d,
                                      mont2->RR.d, mont2->n0[0], mod_bits);
