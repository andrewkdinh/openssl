...
static int
probable_prime_dh(BIGNUM *rnd, int bits, int safe, prime_t *mods, const BIGNUM *add, const BIGNUM *rem, BN_CTX *ctx);
...
static const BIGNUM _bignum_small_prime_factors = {(BN_ULONG *)small_prime_factors,
