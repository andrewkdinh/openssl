...
static void evp_keymgmt_free(void *data) { EVP_KEYMGMT_free(data); }

static int evp_keymgmt_up_ref(void *data) { return EVP_KEYMGMT_up_ref(data); }
...
EVP_KEYMGMT *evp_keymgmt_fetch_from_prov(OSSL_PROVIDER *prov, const char *name,
    ...
    return evp_generic_fetch_from_prov(prov, OSSL_OP_KEYMGMT, name, properties,
...
void EVP_KEYMGMT_do_all_provided(OSSL_LIB_CTX *libctx,
    ...
    evp_generic_do_all(libctx, OSSL_OP_KEYMGMT, (void (*)(void *, void *))fn,
                       arg, keymgmt_from_algorithm, evp_keymgmt_up_ref,
                       evp_keymgmt_free);
}
