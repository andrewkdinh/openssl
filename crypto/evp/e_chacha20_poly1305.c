...
static int chacha_init_key(EVP_CIPHER_CTX *ctx, const unsigned char user_key[CHACHA_KEY_SIZE],
...
static const EVP_CIPHER chacha20 = {NID_chacha20,
                                    1,                      /* block_size */
...
#   endif
    ...
    Poly1305_Final(POLY1305_ctx(actx), EVP_CIPHER_CTX_is_encrypting(ctx) ? actx->tag : tohash);
...
#  endif
    ...
    if (in == NULL                              /* explicit final */
        ...
        Poly1305_Final(POLY1305_ctx(actx), EVP_CIPHER_CTX_is_encrypting(ctx) ? actx->tag : temp);
        actx->mac_inited = 0;
...
static EVP_CIPHER chacha20_poly1305 = {
    ...
    EVP_CIPH_FLAG_AEAD_CIPHER | EVP_CIPH_CUSTOM_IV | EVP_CIPH_ALWAYS_CALL_INIT | EVP_CIPH_CTRL_INIT
