...
typedef __owur int (*CBD_FUNC)(scalar           *out,
...
static const ML_KEM_VINFO vinfo_map[3] = {
    {"ML-KEM-512",
     ...
     VECTOR_BYTES(512),
     U_VECTOR_BYTES(512),
     EVP_PKEY_ML_KEM_512,  ML_KEM_512_BITS,
     ML_KEM_512_RANK,  ML_KEM_512_DU,
     ML_KEM_512_DV,  ML_KEM_512_SECBITS,
    ...
    {"ML-KEM-768",
     ...
     VECTOR_BYTES(768),
     U_VECTOR_BYTES(768),
     EVP_PKEY_ML_KEM_768,  ML_KEM_768_BITS,
     ML_KEM_768_RANK,  ML_KEM_768_DU,
     ML_KEM_768_DV,  ML_KEM_768_SECBITS,
    ...
    {"ML-KEM-1024",
     ...
     VECTOR_BYTES(1024),
     U_VECTOR_BYTES(1024),
     EVP_PKEY_ML_KEM_1024, ML_KEM_1024_BITS,
     ML_KEM_1024_RANK, ML_KEM_1024_DU,
     ML_KEM_1024_DV, ML_KEM_1024_SECBITS,
 ...
 */
static __owur int
prf(uint8_t *out, size_t len, const uint8_t in[ML_KEM_RANDOM_BYTES + 1], EVP_MD_CTX *mdctx, const ML_KEM_KEY *key)
{
 ...
 */
static __owur int
hash_h(uint8_t out[ML_KEM_PKHASH_BYTES], const uint8_t *in, size_t len, EVP_MD_CTX *mdctx, const ML_KEM_KEY *key)
{
 ...
 */
static __owur int
hash_g(uint8_t out[ML_KEM_SEED_BYTES], const uint8_t *in, size_t len, EVP_MD_CTX *mdctx, const ML_KEM_KEY *key)
{
 ...
 */
static __owur int gencbd_vector(scalar           *out,
                                CBD_FUNC          cbd,
                                uint8_t          *counter,
 ...
 */
static __owur int gencbd_vector_ntt(scalar           *out,
                                    CBD_FUNC          cbd,
                                    uint8_t          *counter,
                                    const uint8_t     seed[ML_KEM_RANDOM_BYTES],
                                    int               rank,
...
static __owur int encrypt_cpa(uint8_t           out[ML_KEM_SHARED_SECRET_BYTES],
                              ...
                              const uint8_t     r[ML_KEM_RANDOM_BYTES],
                              scalar           *tmp,
                              EVP_MD_CTX       *mdctx,
                              const ML_KEM_KEY *key)
{
 ...
 * of the provided key.
 */
static int encap(uint8_t          *ctext,
                 uint8_t           secret[ML_KEM_SHARED_SECRET_BYTES],
 ...
 * This is the deterministic version with randomness supplied externally.
 */
int ossl_ml_kem_encap_seed(uint8_t          *ctext,
                           size_t            clen,
