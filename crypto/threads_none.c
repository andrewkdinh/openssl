...
void ossl_rcu_lock_free(CRYPTO_RCU_LOCK *lock) { OPENSSL_free(lock); }

void ossl_rcu_read_lock(CRYPTO_RCU_LOCK *lock) { return; }

void ossl_rcu_write_lock(CRYPTO_RCU_LOCK *lock) { return; }

void ossl_rcu_write_unlock(CRYPTO_RCU_LOCK *lock) { return; }

void ossl_rcu_read_unlock(CRYPTO_RCU_LOCK *lock) { return; }
...
void *ossl_rcu_uptr_deref(void **p) { return (void *)*p; }

void ossl_rcu_assign_uptr(void **p, void **v) { *(void **)p = *(void **)v; }
