...
static int pem_bytes_read_bio_flags(unsigned char  **pdata,
                                    long            *plen,
                                    char           **pnm,
                                    const char      *name,
                                    BIO             *bp,
...
static int PEM_ASN1_write_bio_internal(i2d_of_void          *i2d,
                                       OSSL_i2d_of_void_ctx *i2d_ctx,
                                       void                 *vctx,
                                       const char           *name,
                                       BIO                  *bp,
                                       const void           *x,
...
int PEM_ASN1_write_bio_ctx(OSSL_i2d_of_void_ctx *i2d,
                           void                 *vctx,
                           const char           *name,
                           BIO                  *bp,
                           const void           *x,
