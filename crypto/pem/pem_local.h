...
#define IMPLEMENT_PEM_provided_write_body_vars(type, asn1, pq)                 \
    int ret = 0;                                                               \
    OSSL_ENCODER_CTX *ctx = OSSL_ENCODER_CTX_new_for_##type(                   \
    x, PEM_SELECTION_##asn1, "PEM", PEM_STRUCTURE_##asn1, (pq));               \
                                                                               \
...
#define IMPLEMENT_PEM_provided_write_body_fallback(str, asn1, writename)       \
    legacy:                                                                    \
    return PEM_ASN1_##writename((i2d_of_void *)i2d_##asn1, str, out, x, NULL,  \
                                NULL, 0, NULL, NULL)
#define IMPLEMENT_PEM_provided_write_body_fallback_cb(str, asn1, writename)    \
    legacy:                                                                    \
    return PEM_ASN1_##writename##((i2d_of_void *)i2d_##asn1, str, out, x, enc, \
                                  kstr, klen, cb, u)

#define IMPLEMENT_PEM_provided_write_to(name, TYPE, type, str, asn1, OUTTYPE,  \
                                        outtype, writename)                    \
...
#define IMPLEMENT_PEM_provided_write_fp(name, TYPE, type, str, asn1)           \
    IMPLEMENT_PEM_provided_write_to(name, TYPE, type, str, asn1, FILE, fp,     \
                                    write)
#define IMPLEMENT_PEM_provided_write_cb_fp(name, TYPE, type, str, asn1)        \
    IMPLEMENT_PEM_provided_write_cb_to(name, TYPE, type, str, asn1, FILE, fp,  \
                                       write)

#endif

#define IMPLEMENT_PEM_provided_write_bio(name, TYPE, type, str, asn1)          \
    IMPLEMENT_PEM_provided_write_to(name, TYPE, type, str, asn1, BIO, bio,     \
                                    write_bio)
#define IMPLEMENT_PEM_provided_write_cb_bio(name, TYPE, type, str, asn1)       \
    IMPLEMENT_PEM_provided_write_cb_to(name, TYPE, type, str, asn1, BIO, bio,  \
                                       write_bio)
