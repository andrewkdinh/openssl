 ...
 */
static int
collect_decoder_keymgmt(EVP_KEYMGMT *keymgmt, OSSL_DECODER *decoder, void *provctx, struct collect_data_st *data)
{
 ...
 */
static int
ossl_decoder_ctx_setup_for_pkey(OSSL_DECODER_CTX *ctx, const char *keytype, OSSL_LIB_CTX *libctx, const char *propquery)
{
    int                          ok           = 0;
 ...
 */
static OSSL_DECODER_CTX *ossl_decoder_ctx_for_pkey_dup(OSSL_DECODER_CTX *src,
                                                       EVP_PKEY        **pkey,
                                                       ...
                                                       const char       *input_structure)
{
    ...
    if (src->decoder_insts != NULL) {
        dest->decoder_insts = sk_OSSL_DECODER_INSTANCE_deep_copy(src->decoder_insts,
